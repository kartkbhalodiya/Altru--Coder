...
Generates UPCOMING_CHANGELOG.md by running the altru-coder changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for altru-coder run (default: low)
      --quiet            Suppress altru-coder command output unless it fails
...
const cmd = ["altru-coder", "run"] // altrucoder_change - opencode -> altru-coder
