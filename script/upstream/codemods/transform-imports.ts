 ...
 *
 * Transforms imports from opencode packages to altru-coder packages:
 ...
 * Examples:
 *   "@opencode-ai/sdk" -> "@altru-coder/sdk"
 *   "@opencode-ai/sdk/v2" -> "@altru-coder/sdk/v2"
 *   "@opencode-ai/sdk/v2/client" -> "@altru-coder/sdk/v2/client"
 */
