 ...
 *
 * Transforms string literals containing opencode references to altru-coder:
 * - "opencode-ai" -> "@altru-coder/cli"
 * - "npx opencode" -> "npx @altru-coder/cli"
 * - etc.
 *
 * Usage:
...
const STRING_REPLACEMENTS: StringReplacement[] = [
  ...
  { pattern: /\bopencode-ai\b/g, replacement: "@altru-coder/cli" },
  ...
  // CLI commands
  { pattern: /\bnpx opencode\b/g, replacement: "npx @altru-coder/cli" },
  { pattern: /\bbun add opencode\b/g, replacement: "bun add @altru-coder/cli" },
  { pattern: /\bnpm install opencode\b/g, replacement: "npm install @altru-coder/cli" },
  { pattern: /\bnpm i opencode\b/g, replacement: "npm i @altru-coder/cli" },

  // Database filename
  { pattern: /\bopencode\.db\b/g, replacement: "altru-coder.db" },

  // Binary name references (be careful with these)
  { pattern: /\bopencode upgrade\b/g, replacement: "altru-coder upgrade" },
  ...
  { pattern: /\bVITE_OPENCODE_/g, replacement: "VITE_ALTRU_CODER_" },
  { pattern: /\b_EXTENSION_OPENCODE_/g, replacement: "_EXTENSION_ALTRU_CODER_" },
]
