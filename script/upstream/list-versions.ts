...
import { getAvailableUpstreamVersions, getCurrentAltruCoderVersion } from "./utils/version"
...
async function main() {
  ...
  const altruVersion = await getCurrentAltruCoderVersion()

  console.log()
  success(`Current Altru Coder version: ${altruVersion}`)
  console.log()
