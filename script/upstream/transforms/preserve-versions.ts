#!/usr/bin/env bun
/**
 * Preserve Altru Coder package versions during upstream merge
 *
 * This script ensures that Altru Coder's package versions are not overwritten
...
/**
 * Get the current Altru Coder version from the main package.json
 */
