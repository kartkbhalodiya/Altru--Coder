 ...
 * by transforming them from anomalyco/opencode to Altru-Coder/altrucoder.
 */
...
const SCRIPT_REPLACEMENTS: ScriptReplacement[] = [
  // GitHub API URLs
  {
    ...
    replacement: "api.github.com/repos/Altru-Coder/altrucoder",
    description: "GitHub API URL",
  },
  {
    pattern: /\/repos\/anomalyco\/opencode/g,
    replacement: "/repos/Altru-Coder/altrucoder",
  ...
  // gh CLI commands
  {
    ...
    replacement: 'gh api "/repos/Altru-Coder/altrucoder',
  ...
  // Release artifact names
  {
    ...
    replacement: "altru-coder-$1-$2$3$4",
