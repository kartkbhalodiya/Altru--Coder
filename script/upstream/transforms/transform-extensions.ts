#!/usr/bin/env bun
/**
 * Transform extension files (Zed, etc.) with Altru Coder branding
 *
 * This script handles extension configuration files by transforming
 * OpenCode references to Altru Coder.
 */
...
const EXTENSION_REPLACEMENTS: ExtensionReplacement[] = [
  // TOML files (Zed extension)
  {
    ...
    replacement: 'name = "altru-coder"',
    description: "Extension name",
    fileTypes: [".toml"],
  },
  {
    pattern: /id\s*=\s*"opencode"/g,
    replacement: 'id = "altru-coder"',
    description: "Extension ID",
    fileTypes: [".toml"],
  },
  {
    pattern: /description\s*=\s*"OpenCode[^"]*"/g,
    replacement: 'description = "Altru Coder - AI coding assistant"',
  ...
  // GitHub/Repository references
  {
    ...
    replacement: 'repository = "https://github.com/Altru-Coder/altrucoder"',
  ...
  // Binary/command references
  {
    ...
    replacement: 'command = "altru-coder"',
    description: "Command name",
    fileTypes: [".toml"],
  },

  // Generic OpenCode -> Altru Coder in strings
  {
    pattern: /"OpenCode"/g,
  ...
  },
  {
    ...
    replacement: "Altru Coder language server",
