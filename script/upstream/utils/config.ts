...
export interface MergeConfig {
  /** Package name mappings from opencode to altru-coder */
  packageMappings: PackageMapping[]

  /** Files to always keep Altru Coder's version (never take upstream changes) */
  keepOurs: string[]

  /** Files to skip entirely (don't add from upstream, remove if added) */
  skipFiles: string[]

  /** Files that should take upstream version and apply Altru Coder branding transforms */
  ...
  /** Directories that are Altru Coder-specific and should be preserved */
  altruDirectories: string[]
...
export const defaultConfig: MergeConfig = {
  packageMappings: [
    ...
    { from: "@opencode-ai/sdk", to: "@altru-coder/sdk" },
    { from: "@opencode-ai/plugin", to: "@altru-coder/plugin" },
  ],
  ...
  keepOurs: [
    ...
    // Altru Coder-specific command files
    ".opencode/command/commit.md",
    // Altru Coder-specific publish scripts
    ...
    // GitHub Action - Altru Coder version is fully ported and complete
    "github/action.yml",
    "github/README.md",
  ...
  // Files that only exist in upstream and should NOT be added to Altru Coder
  // These are removed during merge if they appear
  skipFiles: [
    // Translated README files (Altru Coder doesn't have these)
    "README.ar.md",
    "README.bn.md",
    "README.br.md",
    "README.bs.md",
    ...
    // Stats file
    "STATS.md",
    // Team members file (Altru Coder doesn't maintain this upstream list)
    ".github/TEAM_MEMBERS",
    // Workflows that don't exist in Altru Coder
    ".github/workflows/update-nix-hashes.yml",
    ".github/workflows/deploy.yml",
    ".github/workflows/docs-update.yml",
    ".github/workflows/docs-locale-sync.yml",
    // Workflows deleted in Altru Coder (replaced or no longer needed)
    ".github/workflows/opencode.yml",
    ".github/workflows/publish-vscode.yml",
    // VS Code example configs (Altru Coder ships real .vscode/* files)
    ".vscode/launch.example.json",
    ".vscode/settings.example.json",
    // Nix files for packages Altru Coder has removed / replaced with nix/altru.nix
    "nix/desktop.nix",
    "nix/opencode.nix",
    // opencode CLI bin (Altru Coder uses its own build output)
    "packages/opencode/bin/opencode",
    // Removed prompt file
    "packages/opencode/src/session/prompt/build-switch.txt",
    // Vouch files (Altru Coder doesn't use Vouch).
    ...
    // SST infrastructure files (Altru Coder is CLI-only, no hosted platform)
    "sst.config.ts",
    "sst-env.d.ts",
  ...
  // i18n translation files that need Altru Coder branding transforms
