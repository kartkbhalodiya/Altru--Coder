...
const skipNotes = process.env["ALTRU_CODER_SKIP_NOTES"] === "1" // altrucoder_change
if (skipNotes) console.log("changelog skipped: ALTRU_CODER_SKIP_NOTES=1") // altrucoder_change
...
if (!Script.preview) {
  ...
  // altrucoder_change start - skip draft flag when ALTRU_CODER_SKIP_NOTES=1 (used by publish-stable.yml which doesn't have a publish-complete step)
