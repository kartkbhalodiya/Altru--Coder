...
import { Icon, type IconProps } from "./icon" // altrucoder_change: added Icon
...
export interface BasicToolProps {
  ...
  locked?: boolean
  animated?: boolean
  allowPendingToggle?: boolean // altrucoder_change
...
export function BasicTool(props: BasicToolProps) {
  ...
  const handleOpenChange = (value: boolean) => {
    if (pending() && !props.allowPendingToggle) return // altrucoder_change
    if (props.hideDetails) return // altrucoder_change
