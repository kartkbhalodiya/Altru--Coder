...
export function Select<T>(props: SelectProps<T> & Omit<ButtonProps, "children">) {
  ...
  return (
    ...
    <Kobalte<T, { category: string; options: T[] }>
      ...
      overlap={local.triggerVariant === "settings"} // altrucoder_change
      fitViewport={local.triggerVariant === "settings"} // altrucoder_change
      overflowPadding={local.triggerVariant === "settings" ? 12 : undefined} // altrucoder_change
      gutter={4}
      value={local.current}
      options={grouped()}
