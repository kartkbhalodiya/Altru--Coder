...
export function ResizeHandle(props: ResizeHandleProps) {
  ...
  const handleMouseDown = (e: MouseEvent) => {
    ...
    // altrucoder_change start - set resize cursor on body during drag
    const cursor = local.direction === "horizontal" ? "col-resize" : "row-resize"
    // altrucoder_change end
    document.body.style.userSelect = "none"
    document.body.style.overflow = "hidden"
    document.body.style.cursor = cursor // altrucoder_change
    ...
    const onMouseUp = () => {
      ...
      document.body.style.cursor = "" // altrucoder_change
