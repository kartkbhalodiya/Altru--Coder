// @ts-nocheck
import { createMemo, onCleanup } from "solid-js" // altrucoder_change
import { createStore } from "solid-js/store"
import type { Todo } from "@altru-coder/sdk/v2"
...
export const Playground = {
  render: () => {
    const [cfg, setCfg] = createStore({
      ...
      collapsed: false, // altrucoder_change
    })
    const open = () => cfg.open
    const step = () => cfg.step
            ...
            <div data-component="todo-session-frame">
              <div data-component="todo-session-panel">
                ...
                <div data-component="todo-motion-dock" data-open={dockOpen()} data-collapsed={collapsed()}>
                  ...
                  <textarea placeholder="Ask Altru Coder to keep working..." />
                </div>
                {/* altrucoder_change end */}
              </div>
            </div>
