...
import type { SessionStatus } from "@altru-coder/sdk/v2"
...
export function SessionTurn(
  ...
  const pending = createMemo(() => {
    if (typeof props.active === "boolean" && typeof props.queued === "boolean") return // altrucoder_change
    const messages = allMessages() ?? emptyMessages
  ...
  // altrucoder_change start — restore queued feature
  ...
  const showThinking = createMemo(() => {
    ...
    if (queued()) return false // altrucoder_change
