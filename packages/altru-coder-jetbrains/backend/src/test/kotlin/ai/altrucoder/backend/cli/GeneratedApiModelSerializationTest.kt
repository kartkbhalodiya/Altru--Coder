 ...
 * [ai.altrucoder.jetbrains.api.model.*] serialize/deserialize correctly
 ...
 * spec — not our handwritten RPC DTOs in [ai.altrucoder.rpc.dto.*].
 *
 * Tests here protect against:
 * - OpenAPI generator/schema drift producing incompatible Kotlin classes
 * - Generated enum mappings breaking (e.g. [ai.altrucoder.jetbrains.api.model.Model.Status])
 * - Unknown CLI response fields causing deserialization failures
 * - Nested generated structures like model [ai.altrucoder.jetbrains.api.model.Model.capabilities]
 *   not matching expected shapes
 *
 * Do not add assertions for Altru Coder-specific fields here unless those fields
 ...
 * [AltruCoderCliDataParserTest] or workspace mapping tests.
 */
