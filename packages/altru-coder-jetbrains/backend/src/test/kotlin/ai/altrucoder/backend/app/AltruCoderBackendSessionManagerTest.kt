...
class AltruCoderBackendSessionManagerTest {
    ...
    private fun setup(): AltruCoderBackendAppService {
        return AltruCoderBackendAppService.create(scope, FakeCliServer(mock), log)
    }

    private suspend fun ready(app: AltruCoderBackendAppService) {
        app.connect()
        withTimeout(10_000) {
