...
import ai.altrucoder.jetbrains.api.model.AppSkills200ResponseInner
import ai.altrucoder.jetbrains.api.model.Command
import ai.altrucoder.jetbrains.api.model.ProviderList200Response
...
class ProjectModelSerializationTest {
    ...
    fun `provider list with isFree and status`() {
        ...
        assertEquals(
            ai.altrucoder.jetbrains.api.model.Model.Status.BETA,
            model.status,
        )
    }
