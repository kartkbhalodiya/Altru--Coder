...
import ai.altrucoder.client.session.ui.PickerRow
...
internal class ModelPickerRenderer(
    ...
    private object BadgeIcon : Icon {
        private val text = AltruCoderBundle.message("model.picker.free")
        ...
        override fun paintIcon(c: Component?, g: Graphics, x: Int, y: Int) {
            ...
            try {
                ...
                g2.color = JBColor.namedColor("Altru Coder.ModelPicker.freeBadgeForeground", JBColor.WHITE)
