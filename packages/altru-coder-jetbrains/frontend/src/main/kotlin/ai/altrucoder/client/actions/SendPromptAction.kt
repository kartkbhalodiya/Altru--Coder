...
class SendPromptAction : DumbAwareAction(
    AltruCoderBundle.message("action.Altru Coder.SendPrompt.text"),
    AltruCoderBundle.message("action.Altru Coder.SendPrompt.description"),
    null,
), ActionPromoter {
    companion object {
        const val ID = "Altru Coder.SendPrompt"
    }
