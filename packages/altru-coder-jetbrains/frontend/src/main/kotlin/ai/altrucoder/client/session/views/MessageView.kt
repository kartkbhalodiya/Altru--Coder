...
import ai.altrucoder.client.session.ui.SessionView
 ...
 * driven by [ai.altrucoder.client.session.ui.SessionLayout] so that each
 ...
 * messages is owned by [ai.altrucoder.client.session.ui.SessionLayout].
 */
class MessageView(
    val msg: Message,
    private var style: SessionStyle = SessionStyle.current(),
) : ai.altrucoder.client.session.ui.SessionLayoutPanel(UiStyle.Card.groupGap()), SessionStyleTarget, SessionView {
