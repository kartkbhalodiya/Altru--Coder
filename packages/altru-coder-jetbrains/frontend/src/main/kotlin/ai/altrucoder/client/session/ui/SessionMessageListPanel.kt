...
import ai.altrucoder.client.session.views.MessageView
import ai.altrucoder.client.session.views.TurnView
...
class SessionMessageListPanel(
    ...
    private fun onTurnAdded(turn: ai.altrucoder.client.session.model.Turn) {
    ...
    private fun onTurnUpdated(turn: ai.altrucoder.client.session.model.Turn) {
