...
import ai.altrucoder.client.session.update.SessionControllerListener
...
class ConnectionPanel(
    ...
    private val retry = ActionLink(AltruCoderBundle.message("session.connection.retry")) {
    ...
    private fun showConnecting() {
        ...
        label.text = AltruCoderBundle.message("session.connection.connecting")
        detail = null
        expanded = false
