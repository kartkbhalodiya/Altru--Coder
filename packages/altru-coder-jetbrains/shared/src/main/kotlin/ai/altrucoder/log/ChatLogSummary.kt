...
object ChatLogSummary {
    ...
    private fun mode(): Mode = when ((System.getProperty("altru-coder.dev.log.chat.content") ?: "off").lowercase()) {
        "preview" -> Mode.PREVIEW
        "full" -> Mode.FULL
        else -> Mode.OFF
    }

    private fun max(): Int = (System.getProperty("altru-coder.dev.log.chat.preview.max")?.toIntOrNull() ?: 160)
        .coerceIn(1, 2000)
