 ...
 */
@Rpc
interface AltruCoderSessionRpcApi : RemoteApi<Unit> {
    companion object {
        suspend fun getInstance(): AltruCoderSessionRpcApi {
            return RemoteApiProviderService.resolve(remoteApiDescriptor<AltruCoderSessionRpcApi>())
        }
    }
