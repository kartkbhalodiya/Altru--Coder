...
import type {
  AgentPartInput,
  AltruCoderClawChatCredentialsResponses,
  AltruCoderClawStatusResponses,
  AltruCoderCloudSessionGetErrors,
  AltruCoderCloudSessionGetResponses,
  AltruCoderCloudSessionImportErrors,
  AltruCoderCloudSessionImportResponses,
  AltruCoderCloudSessionsErrors,
  AltruCoderCloudSessionsResponses,
  AltruCoderFimErrors,
  AltruCoderFimResponses,
  AltrucoderHeapSnapshotErrors,
  AltrucoderHeapSnapshotResponses,
  AltruCoderModesResponses,
  AltruCoderNotificationsErrors,
  AltruCoderNotificationsResponses,
  AltruCoderOrganizationSetErrors,
  AltruCoderOrganizationSetResponses,
  AltruCoderProfileErrors,
  AltruCoderProfileResponses,
  AltrucoderRemoveAgentErrors,
  AltrucoderRemoveAgentResponses,
  AltrucoderRemoveSkillErrors,
  AltrucoderRemoveSkillResponses,
  AltrucoderSessionImportMessageErrors,
  AltrucoderSessionImportMessageResponses,
  AltrucoderSessionImportPartErrors,
  AltrucoderSessionImportPartResponses,
  AltrucoderSessionImportProjectErrors,
  AltrucoderSessionImportProjectResponses,
  AltrucoderSessionImportSessionErrors,
  AltrucoderSessionImportSessionResponses,
  AppAgentsResponses,
  AppLogErrors,
  AppLogResponses,
  AppSkillsResponses,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new AltruCoderClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Altru Coder configuration settings and preferences.
   */
   ...
   *
   * Update global Altru Coder configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Altru Coder server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Altru Coder system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Altru Coder instances, releasing all resources.
   */
   ...
   * Upgrade altru-coder
   *
   * Upgrade altru-coder to the specified version or latest if not specified.
   */
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Altru Coder system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Altru Coder system.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Altru Coder state.
   */
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Altru Coder sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Altru Coder.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Altru Coder is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Altru Coder.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Altru Coder configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Altru Coder configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Altru Coder sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Altru Coder session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Altru Coder session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Altru Coder instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the Altru Coder instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Altru Coder system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Telemetry extends HeyApiClient {
   ...
   *
   * Forward a telemetry event to PostHog via altru-coder-telemetry.
   */
   ...
   *
   * Update the PostHog client's opt-in/out state at runtime. The CLI reads ALTRU_CODER_TELEMETRY_LEVEL once at spawn — this route lets clients (e.g. the VS Code extension) propagate runtime telemetry consent changes.
   */
...
export class Altrucoder extends HeyApiClient {
  /**
   * Remove a skill
   *
...
export class Organization extends HeyApiClient {
  /**
   * Update Altru Coder Gateway organization
   *
   * Switch to a different Altru Coder Gateway organization
   */
  public set<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session3 extends HeyApiClient {
   ...
   * Get cloud session
   *
   * Fetch full session data from the Altru Coder cloud for preview
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      id: string
...
export class Claw extends HeyApiClient {
  /**
   * Get AltruCoderClaw instance status
   *
   * Fetch the user's AltruCoderClaw instance status via the AltruCoderClaw worker
   */
  public status<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<AltruCoderClawStatusResponses, unknown, ThrowOnError>({
  ...
  /**
   * Get AltruCoderClaw chat credentials
   *
   * Returns the bearer token and endpoint URLs the client uses to talk to the Altru Coder Chat worker and the Event Service. The bearer is the user's existing long-lived Altru Coder JWT — altru-coder-chat and event-service both verify it directly with NEXTAUTH_SECRET, so no separate token mint is needed.
   */
  public chatCredentials<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<AltruCoderClawChatCredentialsResponses, unknown, ThrowOnError>({
...
export class AltruCoder extends HeyApiClient {
  /**
   * Get Altru Coder Gateway profile
   *
   * Fetch user profile and organizations from Altru Coder Gateway
   */
  public profile<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<AltruCoderProfileResponses, AltruCoderProfileErrors, ThrowOnError>({
      url: "/altru/profile",
      ...options,
      ...params,
    })
  ...
  public modes<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<AltruCoderModesResponses, unknown, ThrowOnError>({
      url: "/altru/modes",
      ...options,
      ...params,
    })
   ...
   * FIM completion
   *
   * Proxy a Fill-in-the-Middle completion request to the Altru Coder Gateway
   */
  public fim<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).sse.post<AltruCoderFimResponses, AltruCoderFimErrors, ThrowOnError>({
      url: "/altru/fim",
      ...options,
      ...params,
      headers: {
  ...
  /**
   * Get Altru Coder notifications
   *
   * Fetch notifications from Altru Coder Gateway for CLI display
   */
   ...
   * Get cloud sessions
   *
   * Fetch cloud CLI sessions from Altru Coder API
   */
...
export class AltruCoderClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<AltruCoderClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    AltruCoderClient.__registry.set(this, args?.key)
  }
  ...
  private _altrucoder?: Altrucoder
  get altrucoder(): Altrucoder {
    return (this._altrucoder ??= new Altrucoder({ client: this.client }))
  }
