...
export type EventAltruCoderSessionsRemoteStatusChanged = {
  type: "altru-coder-sessions.remote-status-changed"
  properties: {
    enabled: boolean
    connected: boolean
  }
...
/**
 * Server configuration for altru-coder serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: altru-coder.local)
   */
  mdnsDomain?: string
  /**
...
export type IndexingConfig = {
  ...
  /**
   * Altru Coder-hosted embedding provider options
   */
  "altru-coder"?: {
    apiKey?: string
    baseUrl?: string
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://altru-coder.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Enable remote control of sessions via Altru Coder Cloud. Equivalent to running /remote on startup.
   */
  ...
  /**
   * Agent configuration, see https://altru-coder.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
...
export type EnhancePromptEnhanceData = {
  body?: {
    ...
    text: string
    /**
     * Preferred provider ID from the active chat model
     */
    providerID?: string
    /**
     * Preferred model ID from the active chat model
     */
    modelID?: string
  }
  path?: never
...
export type AltrucoderSessionImportProjectData = {
  body?: {
    id: string
    worktree: string
    vcs?: string
  ...
  url: "/altrucoder/session-import/project"
}

export type AltrucoderSessionImportProjectErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltrucoderSessionImportProjectError =
  AltrucoderSessionImportProjectErrors[keyof AltrucoderSessionImportProjectErrors]

export type AltrucoderSessionImportProjectResponses = {
  /**
...
export type AltrucoderSessionImportProjectResponse =
  AltrucoderSessionImportProjectResponses[keyof AltrucoderSessionImportProjectResponses]

export type AltrucoderSessionImportSessionData = {
  body?: {
    id: string
    projectID: string
    force?: boolean
  ...
  url: "/altrucoder/session-import/session"
}

export type AltrucoderSessionImportSessionErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltrucoderSessionImportSessionError =
  AltrucoderSessionImportSessionErrors[keyof AltrucoderSessionImportSessionErrors]

export type AltrucoderSessionImportSessionResponses = {
  /**
...
export type AltrucoderSessionImportSessionResponse =
  AltrucoderSessionImportSessionResponses[keyof AltrucoderSessionImportSessionResponses]

export type AltrucoderSessionImportMessageData = {
  body?: {
    id: string
    sessionID: string
    timeCreated: number
  ...
  url: "/altrucoder/session-import/message"
}

export type AltrucoderSessionImportMessageErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltrucoderSessionImportMessageError =
  AltrucoderSessionImportMessageErrors[keyof AltrucoderSessionImportMessageErrors]

export type AltrucoderSessionImportMessageResponses = {
  /**
...
export type AltrucoderSessionImportMessageResponse =
  AltrucoderSessionImportMessageResponses[keyof AltrucoderSessionImportMessageResponses]

export type AltrucoderSessionImportPartData = {
  body?: {
    id: string
    messageID: string
    sessionID: string
  ...
  url: "/altrucoder/session-import/part"
}

export type AltrucoderSessionImportPartErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltrucoderSessionImportPartError =
  AltrucoderSessionImportPartErrors[keyof AltrucoderSessionImportPartErrors]

export type AltrucoderSessionImportPartResponses = {
  /**
   * Part import result
   */
  200: {
...
export type AltrucoderSessionImportPartResponse =
  AltrucoderSessionImportPartResponses[keyof AltrucoderSessionImportPartResponses]

export type AltrucoderHeapSnapshotData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/altrucoder/heap/snapshot"
}

export type AltrucoderHeapSnapshotErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltrucoderHeapSnapshotError = AltrucoderHeapSnapshotErrors[keyof AltrucoderHeapSnapshotErrors]

export type AltrucoderHeapSnapshotResponses = {
  /**
...
export type AltrucoderHeapSnapshotResponse = AltrucoderHeapSnapshotResponses[keyof AltrucoderHeapSnapshotResponses]

export type AltrucoderRemoveSkillData = {
  body?: {
    location: string
  }
  path?: never
  ...
  url: "/altrucoder/skill/remove"
}

export type AltrucoderRemoveSkillErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltrucoderRemoveSkillError = AltrucoderRemoveSkillErrors[keyof AltrucoderRemoveSkillErrors]

export type AltrucoderRemoveSkillResponses = {
  /**
   * Skill removed
   */
  200: boolean
...
export type AltrucoderRemoveSkillResponse = AltrucoderRemoveSkillResponses[keyof AltrucoderRemoveSkillResponses]

export type AltrucoderRemoveAgentData = {
  body?: {
    name: string
  }
  path?: never
  ...
  url: "/altrucoder/agent/remove"
}

export type AltrucoderRemoveAgentErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltrucoderRemoveAgentError = AltrucoderRemoveAgentErrors[keyof AltrucoderRemoveAgentErrors]

export type AltrucoderRemoveAgentResponses = {
  /**
   * Agent removed
   */
  200: boolean
...
export type AltrucoderRemoveAgentResponse = AltrucoderRemoveAgentResponses[keyof AltrucoderRemoveAgentResponses]

export type AltruCoderProfileData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type AltruCoderProfileErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltruCoderProfileError = AltruCoderProfileErrors[keyof AltruCoderProfileErrors]

export type AltruCoderProfileResponses = {
  /**
   * Profile data
   */
  200: {
...
export type AltruCoderProfileResponse = AltruCoderProfileResponses[keyof AltruCoderProfileResponses]

export type AltruCoderOrganizationSetData = {
  body?: {
  ...
  url: "/altru/organization"
}

export type AltruCoderOrganizationSetErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltruCoderOrganizationSetError = AltruCoderOrganizationSetErrors[keyof AltruCoderOrganizationSetErrors]

export type AltruCoderOrganizationSetResponses = {
  /**
...
export type AltruCoderOrganizationSetResponse =
  AltruCoderOrganizationSetResponses[keyof AltruCoderOrganizationSetResponses]

export type AltruCoderModesData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type AltruCoderModesResponses = {
  /**
...
export type AltruCoderModesResponse = AltruCoderModesResponses[keyof AltruCoderModesResponses]

export type AltruCoderFimData = {
  body?: {
    prefix: string
    suffix: string
    model?: string
...
export type AltruCoderFimErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltruCoderFimError = AltruCoderFimErrors[keyof AltruCoderFimErrors]

export type AltruCoderFimResponses = {
  /**
...
export type AltruCoderFimResponse = AltruCoderFimResponses[keyof AltruCoderFimResponses]

export type AltruCoderNotificationsData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/altru/notifications"
}

export type AltruCoderNotificationsErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltruCoderNotificationsError = AltruCoderNotificationsErrors[keyof AltruCoderNotificationsErrors]

export type AltruCoderNotificationsResponses = {
  /**
   * Notifications list
   */
  200: Array<{
...
export type AltruCoderNotificationsResponse = AltruCoderNotificationsResponses[keyof AltruCoderNotificationsResponses]

export type AltruCoderCloudSessionGetData = {
  body?: never
  path: {
    id: string
  }
  ...
  url: "/altru/cloud/session/{id}"
}

export type AltruCoderCloudSessionGetErrors = {
  /**
   * Not found
   */
  404: NotFoundError
...
export type AltruCoderCloudSessionGetError = AltruCoderCloudSessionGetErrors[keyof AltruCoderCloudSessionGetErrors]

export type AltruCoderCloudSessionGetResponses = {
  /**
   * Cloud session data
   */
  200: unknown
...
export type AltruCoderCloudSessionImportData = {
  body?: {
    sessionId: string
  }
  path?: never
  ...
  url: "/altru/cloud/session/import"
}

export type AltruCoderCloudSessionImportErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltruCoderCloudSessionImportError =
  AltruCoderCloudSessionImportErrors[keyof AltruCoderCloudSessionImportErrors]

export type AltruCoderCloudSessionImportResponses = {
  /**
...
export type AltruCoderClawStatusData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/altru/claw/status"
}

export type AltruCoderClawStatusResponses = {
  /**
   * Instance status
   */
  200: {
...
export type AltruCoderClawStatusResponse = AltruCoderClawStatusResponses[keyof AltruCoderClawStatusResponses]

export type AltruCoderClawChatCredentialsData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/altru/claw/chat-credentials"
}

export type AltruCoderClawChatCredentialsResponses = {
  /**
   * Altru Coder Chat credentials or null
   */
  200: {
    token: string
    expiresAt: string
...
export type AltruCoderClawChatCredentialsResponse =
  AltruCoderClawChatCredentialsResponses[keyof AltruCoderClawChatCredentialsResponses]

export type AltruCoderCloudSessionsData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/altru/cloud-sessions"
}

export type AltruCoderCloudSessionsErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AltruCoderCloudSessionsError = AltruCoderCloudSessionsErrors[keyof AltruCoderCloudSessionsErrors]

export type AltruCoderCloudSessionsResponses = {
  /**
   * Cloud sessions list
   */
  200: {
...
export type AltruCoderCloudSessionsResponse = AltruCoderCloudSessionsResponses[keyof AltruCoderCloudSessionsResponses]
