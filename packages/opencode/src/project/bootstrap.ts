...
import { AltruCoderBootstrap } from "@/altrucoder/bootstrap" // altrucoder_change
// import { ShareNext } from "@/share/share-next" // altrucoder_change - handled by AltruCoderBootstrap
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    // const shareNext = yield* ShareNext.Service // altrucoder_change - handled by AltruCoderBootstrap
...
export const defaultLayer: Layer.Layer<Service> = layer.pipe(
  Layer.provide([
    ...
    // ShareNext.defaultLayer, // altrucoder_change - handled by AltruCoderBootstrap
