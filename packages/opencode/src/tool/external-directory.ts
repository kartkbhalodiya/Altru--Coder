...
// altrucoder_change start - root boundaries must not auto-allow external_directory
...
export const assertExternalDirectoryEffect = Effect.fn("Tool.assertExternalDirectory")(function* (
  ...
  // altrucoder_change start - keep root-workspace behavior intact outside permission prompts
