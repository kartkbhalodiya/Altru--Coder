...
const FILES = [
  "AGENTS.md",
  ...(Flag.ALTRU_CODER_DISABLE_CLAUDE_CODE_PROMPT ? [] : ["CLAUDE.md"]),
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const globalFiles = [
      // altrucoder_change start - prefer ALTRU_CODER_CONFIG_DIR profile when set
      ...(Flag.ALTRU_CODER_CONFIG_DIR ? [path.join(Flag.ALTRU_CODER_CONFIG_DIR, "AGENTS.md")] : []),
      // altrucoder_change end
      path.join(global.config, "AGENTS.md"),
      ...(!Flag.ALTRU_CODER_DISABLE_CLAUDE_CODE_PROMPT ? [path.join(global.home, ".claude", "CLAUDE.md")] : []),
    ]
