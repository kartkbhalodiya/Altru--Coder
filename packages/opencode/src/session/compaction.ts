...
import { AltruCoderCompactionPayloadRecovery } from "@/altrucoder/session/compaction-payload-recovery" // altrucoder_change
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const processCompaction = Effect.fn("SessionCompaction.process")(function* (input: {
      ...
      const result = yield* AltruCoderCompactionPayloadRecovery.process({
        processor,
        user: userMessage,
        agent,
        sessionID: input.sessionID,
    ...
    const create = Effect.fn("SessionCompaction.create")(function* (input: {
      ...
      // altrucoder_change start - keep auto-compaction markers visible during queued turns
      AltruCoderSessionPromptQueue.retarget(input.sessionID, msg.id)
      // altrucoder_change end
    })
