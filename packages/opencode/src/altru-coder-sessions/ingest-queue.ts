...
import type { AltruCoderSession } from "@/altrucoder/session"
...
export namespace IngestQueue {
  ...
  export type CloseReason = AltruCoderSession.CloseReason
  ...
  export function create(options: Options) {
    ...
    function key(item: Data) {
      ...
      if (item.type === "altru_coder_meta") return "altru_coder_meta"
