...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.ALTRU_CODER_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ALTRU_CODER_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ALTRU_CODER_WORKSPACE_ID: config.id,
        ALTRU_CODER_EXPERIMENTAL_WORKSPACES: "true",
