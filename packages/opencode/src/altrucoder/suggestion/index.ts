...
import { AltruCoderSessionPromptQueue } from "../session/prompt-queue"
...
export namespace Suggestion {
  ...
  // altrucoder_change - Instance.state() removed in v1.4.4; use module-level state
  ...
  export async function show(input: {
    ...
    if (AltruCoderSessionPromptQueue.hasFollowup(SessionID.make(input.sessionID))) {
