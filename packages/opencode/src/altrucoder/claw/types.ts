...
/**
 * AltruCoderClaw TUI types — Altru Coder Chat protocol.
 *
 * Mirrors `@altru-coder/altru-chat` from the cloud monorepo. We carry our own
...
export type ClawStatus = {
  ...
  secretCount?: number
  userId?: string
  // User-chosen name for the AltruCoderClaw bot, set during onboarding via the
  ...
  // literal string "AltruCoderClaw" when null.
  botName?: string | null
}
