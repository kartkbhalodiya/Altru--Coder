...
export namespace AltruCoderCostPropagation {
  /**
   ...
   */
  export const childCost = Effect.fn("AltruCoderCostPropagation.childCost")(function* (
   ...
   */
  export const propagate = Effect.fn("AltruCoderCostPropagation.propagate")(function* (
    sessions: Session.Interface,
    sid: SessionID,
    mid: MessageID,
    amount: number,
