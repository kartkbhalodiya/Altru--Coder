  ...
  new Hono()
    .post(
      ...
      describeRoute({
        ...
        operationId: "altrucoder.sessionImport.project",
        responses: {
          200: {
    ...
    .post(
      ...
      describeRoute({
        ...
        operationId: "altrucoder.sessionImport.session",
        responses: {
          200: {
    ...
    .post(
      ...
      describeRoute({
        ...
        operationId: "altrucoder.sessionImport.message",
        responses: {
          200: {
    ...
    .post(
      ...
      describeRoute({
        ...
        operationId: "altrucoder.sessionImport.part",
        responses: {
          200: {
