...
const TABLE_PATH = root + "packages/altru-coder-docs/markdoc/partials/cli-commands-table.md"
const REFERENCE_PATH = root + "packages/altru-coder-docs/pages/code-with-ai/platforms/cli-reference.md"
...
// them here as well to keep altru-coder.ai/docs in sync with the shipped binary.
