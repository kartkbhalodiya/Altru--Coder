...
/**
 * Altru Coder-specific helpers for the shared `@/question` module.
 *
 ...
 */
export namespace AltruCoderQuestion {
  ...
  export const guardFollowup = <E>(sessionID: SessionID, makeError: () => E) =>
    Effect.gen(function* () {
      if (!AltruCoderSessionPromptQueue.hasFollowup(sessionID)) return
