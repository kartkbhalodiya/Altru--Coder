/**
 * Altru Coder Gateway Profile Dialog
 *
...
import type { AltruCoderProfile, AltruCoderBalance } from "@altru-coder/altru-coder-gateway"

interface DialogAltruCoderProfileProps {
  profile: AltruCoderProfile
  balance: AltruCoderBalance | null
  currentOrgId?: string | null
}

export function DialogAltruCoderProfile(props: DialogAltruCoderProfileProps) {
  ...
  const usageUrl = props.currentOrgId
    ? `https://app.altru-coder.ai/organizations/${props.currentOrgId}/usage-details`
