/**
 * Altru Coder Notifications Dialog
 *
 * Displays all notifications from Altru Coder API in a scrollable dialog.
...
interface DialogAltruCoderNotificationsProps {
  notifications: AltruCoderNotification[]
}

export function DialogAltruCoderNotifications(props: DialogAltruCoderNotificationsProps) {
