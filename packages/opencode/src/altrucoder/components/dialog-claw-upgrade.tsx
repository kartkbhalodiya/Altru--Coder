...
/**
 * AltruCoderClaw Upgrade Dialog
 *
 * Shown when the user has an active AltruCoderClaw instance but no chat credentials,
  ...
  return (
    <box paddingLeft={2} paddingRight={2} gap={1}>
      <box flexDirection="row" justifyContent="space-between">
        <text fg={theme.text}>
          <span style={{ bold: true }}>AltruCoderClaw Chat requires an upgrade</span>
        </text>
