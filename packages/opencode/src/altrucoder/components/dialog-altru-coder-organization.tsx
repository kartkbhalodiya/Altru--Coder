/**
 * Altru Coder Gateway Organization Selection Dialog
 *
...
import { getOrganizationOptions, getDefaultOrganizationSelection } from "@altru-coder/altru-coder-gateway/tui"
...
interface DialogAltruCoderOrganizationProps {
...
export function DialogAltruCoderOrganization(props: DialogAltruCoderOrganizationProps) {
