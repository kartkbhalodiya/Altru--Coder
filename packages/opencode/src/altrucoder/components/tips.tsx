...
// Curated tips for Altru Coder CLI
const TIPS = [
  ...
  "Altru Coder can {highlight}configure itself{/highlight} if you ask it",
  "Ask Altru Coder to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Altru Coder to {highlight}create a review agent for this project{/highlight}",
  "Ask Altru Coder to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Altru Coder to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Altru Coder to {highlight}make my review agent read-only{/highlight}",
  "Ask Altru Coder to {highlight}require approval before git push{/highlight}",
  "Ask Altru Coder to {highlight}turn off auto-formatting{/highlight}",
  "Ask Altru Coder to {highlight}block access to .env files{/highlight}",
  "Ask Altru Coder to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Altru Coder to {highlight}match my terminal theme{/highlight}",
  "Ask Altru Coder to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Altru Coder to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Altru Coder to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Altru Coder to {highlight}save this workflow as a /command{/highlight}",
  "Altru Coder auto-handles OAuth for remote MCP servers requiring auth",
  "Altru Coder auto-formats files using prettier, gofmt, ruff, and more",
  "Altru Coder uses LSP servers for intelligent code analysis",
  "Use {highlight}altru-coder run{/highlight} for non-interactive scripting",
  "Use {highlight}altru-coder --continue{/highlight} to resume the last session",
  "Use {highlight}altru-coder run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}altru-coder serve{/highlight} for headless API access to Altru Coder",
  "Use {highlight}altru-coder run --attach{/highlight} to connect to a running server",
  "Run {highlight}altru-coder upgrade{/highlight} to update to the latest version",
  "Run {highlight}altru-coder auth list{/highlight} to see all configured providers",
