...
/**
 * AltruCoderClaw Setup Dialog
 *
 * Shown when the user has no AltruCoderClaw instance provisioned.
    ...
    <box paddingLeft={2} paddingRight={2} gap={1}>
      ...
      <box paddingBottom={1} gap={1}>
        ...
        <box flexDirection="row" marginTop={1}>
          <Link href="https://altru-coder.ai/altru-coder-claw" fg={theme.text}>
            Learn more
          </Link>
        </box>
      </box>
