...
export namespace AltruCoderTask {
  ...
  export const resolveModel = Effect.fn("AltruCoderTask.resolveModel")(function* (name: string) {
    if (Flag.ALTRU_CODER_CLIENT !== "cli") return undefined
