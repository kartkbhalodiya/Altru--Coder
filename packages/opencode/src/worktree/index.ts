...
import { WorktreeCleanup } from "@/altrucoder/worktree-cleanup" // altrucoder_change
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    // altrucoder_change start - use Altru Coder cleanup helper for slow Windows handle release
