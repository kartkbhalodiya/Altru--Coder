...
export const Action = Schema.NullOr(Schema.Literals(["ask", "allow", "deny"])) // altrucoder_change - nullable allows null as a delete sentinel
...
const normalizeInput = (input: Schema.Schema.Type<typeof InputSchema>): Schema.Schema.Type<typeof InputObject> =>
  input === null || typeof input === "string" ? { "*": input } : input // altrucoder_change
