...
import { PROMPTS } from "@altru-coder/altru-coder-gateway" // altrucoder_change
...
export const Model = Schema.Struct({
  ...
  prompt: Schema.optional(Schema.Literals(PROMPTS)), // altrucoder_change
  ...
  variants: Schema.optional(
    Schema.Record(
      Schema.String,
      Schema.NullOr(
        // altrucoder_change - allow null values so removed variants can be deleted via stripNulls on save
...
export const Info = Schema.Struct({
  ...
  models: Schema.optional(Schema.Record(Schema.String, Schema.NullOr(Model))), // altrucoder_change - allow null values so removed models can be deleted via stripNulls on save
})
