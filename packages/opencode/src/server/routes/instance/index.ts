...
import { register as registerAltruCoderRoutes } from "@/altrucoder/server/instance" // altrucoder_change

export const InstanceRoutes = (upgrade: UpgradeWebSocket): Hono => {
  const app = new Hono()

  const full = app // altrucoder_change
  full
  ...
  return registerAltruCoderRoutes(full) // altrucoder_change
}
