...
export class ServerAuthConfig extends ConfigService.Service<ServerAuthConfig>()(
  ...
  {
    password: Config.string("ALTRU_CODER_SERVER_PASSWORD").pipe(Config.option),
    username: Config.string("ALTRU_CODER_SERVER_USERNAME").pipe(Config.withDefault("altru-coder")), // altrucoder_change
  },
) {}
