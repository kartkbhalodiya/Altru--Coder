...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.ALTRU_CODER_WORKSPACE_ID ? WorkspaceID.make(Flag.ALTRU_CODER_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-altru-coder-directory"] || process.cwd()
}
