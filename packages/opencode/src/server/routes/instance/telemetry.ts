  ...
  new Hono()
    .post(
      ...
      describeRoute({
        ...
        description: "Forward a telemetry event to PostHog via altru-coder-telemetry.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description:
          ...
          "The CLI reads ALTRU_CODER_TELEMETRY_LEVEL once at spawn — this route lets clients " +
