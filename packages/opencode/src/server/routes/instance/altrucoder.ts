...
// Altru Coder-specific routes that live in the CLI package (direct access to internals).
// All future altru-coder-specific endpoints should be added here.
...
import { SessionImportRoutes } from "@/altrucoder/session-import/routes"
import { HeapSnapshot } from "@/altrucoder/cli/heap-snapshot"

export const AltruCoderRoutes = lazy(() =>
  new Hono()
    ...
    .post(
      ...
      describeRoute({
        ...
        operationId: "altrucoder.heap.snapshot",
        responses: {
          200: {
    ...
    .post(
      ...
      describeRoute({
        ...
        operationId: "altrucoder.removeSkill",
        responses: {
          200: {
    ...
    .post(
      ...
      describeRoute({
        ...
        operationId: "altrucoder.removeAgent",
        responses: {
          200: {
