...
export const GlobalRoutes = lazy(() =>
  new Hono()
    ...
    .post(
      ...
      async (c) => {
        await Config.invalidate(true) // altrucoder_change - also disposes instances; awaiting matches upstream behavior
    ...
    .post(
      "/upgrade",
      describeRoute({
        summary: "Upgrade altru-coder", // altrucoder_change
        description: "Upgrade altru-coder to the specified version or latest if not specified.", // altrucoder_change
