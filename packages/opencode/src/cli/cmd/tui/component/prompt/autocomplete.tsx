...
export type AutocompleteRef = {
  ...
  onCursorChange: () => void
  // altrucoder_change start - let the prompt close autocomplete without mutating draft text
  dismiss: () => void
...
export function Autocomplete(props: {
  ...
  // altrucoder_change start - keep slash text intact when overlays hide the prompt,
