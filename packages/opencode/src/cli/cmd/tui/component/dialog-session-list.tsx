...
export function DialogSessionList() {
  ...
  const [global, setGlobal] = createSignal(true) // altrucoder_change - show all worktrees by default

  // altrucoder_change start - always fetch from experimental endpoint (returns GlobalSession with worktree info)
  ...
  // altrucoder_change start - client-side worktree filtering when global is off
    ...
    dialog.replace(() => (
      <DialogSessionDeleteFailed
        ...
        onDelete={async () => {
          ...
          if (search()) await searchActions.refetch() // altrucoder_change - use createResource actions
  ...
  const options = createMemo(() => {
    ...
    const all = global() // altrucoder_change
    return sessions()
      ...
      .map((x) => {
        ...
        return {
          ...
          description: all && x.worktreeName ? `(${x.worktreeName})` : undefined, // altrucoder_change - worktree label
  ...
  return (
    <DialogSelect
      title={global() ? "Sessions (all worktrees)" : "Sessions (current worktree)"} // altrucoder_change
      options={options()}
      skipFilter={true}
      ...
      keybind={[
        {
          ...
          onTrigger: async (option) => {
            if (toDelete() === option.value) {
              ...
              void searchActions.refetch() // altrucoder_change
              setToDelete(undefined)
              return
            }
        ...
        },
        {
          ...
          title: "rename", // altrucoder_change
        ...
        // altrucoder_change end
        {
          ...
          title: "new workspace",
          side: "right",
          disabled: !Flag.ALTRU_CODER_EXPERIMENTAL_WORKSPACES,
          onTrigger: () => {
            createWorkspace()
          },
        },
