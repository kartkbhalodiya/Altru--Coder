...
import type { QuestionAnswer, QuestionRequest } from "@altru-coder/sdk/v2"
...
export function QuestionPrompt(props: {
  ...
  useKeyboard((evt) => {
    ...
    // altrucoder_change start - avoid intrusive key capture for non-blocking review suggestions
