...
import type { PermissionRequest } from "@altru-coder/sdk/v2"
...
export function PermissionPrompt(props: { request: PermissionRequest }) {
  ...
  const { theme } = useTheme()
  const keybind = useKeybind() // altrucoder_change
        ...
        {(() => {
          ...
          const header = () => (
            <box flexDirection="column" gap={0}>
              ...
              {/* // altrucoder_change start - explain config file edits always require approval */}
          ...
          // altrucoder_change start — hide "Always allow" for config file edits
  ...
  return (
    ...
    >
      <box gap={1} paddingLeft={1} paddingRight={3} paddingTop={1} paddingBottom={1}>
        ...
        <box paddingLeft={1}>
          {/* altrucoder_change */}
          <text fg={theme.textMuted}>Tell Altru Coder what to do differently</text>
        </box>
      </box>
      <box
