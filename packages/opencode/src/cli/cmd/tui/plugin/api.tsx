...
import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition, TuiSlotProps } from "@altru-coder/plugin/tui"
...
function routeCurrent(route: ReturnType<typeof useRoute>): TuiPluginApi["route"]["current"] {
  ...
  if (route.data.type === "altru-coder-claw") return { name: "altru-coder-claw" }
