// altrucoder_change start - use Altru Coder-specific tips component
export { Tips } from "@/altrucoder/components/tips"
...
// altrucoder_change - renamed Tips -> _Tips so the upstream implementation stays
// as shadowed dead code while we re-export the real Tips from @/altrucoder/components/tips
...
const TIPS = [
  ...
  "Run {highlight}docker run -it --rm ghcr.io/altru-org/altrucoder{/highlight} for containerized use",
