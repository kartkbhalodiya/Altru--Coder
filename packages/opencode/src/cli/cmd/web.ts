...
export const WebCommand = cmd({
  ...
  describe: "start altru-coder server and open web interface", // altrucoder_change
  handler: async (args) => {
    if (!Flag.ALTRU_CODER_SERVER_PASSWORD) {
      UI.println(UI.Style.TEXT_WARNING_BOLD + "!  ALTRU_CODER_SERVER_PASSWORD is not set; server is unsecured.")
    }
