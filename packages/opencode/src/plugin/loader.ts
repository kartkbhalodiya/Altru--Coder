...
import { isIndexingPlugin } from "@altru-coder/altru-coder-indexing/detect" // altrucoder_change
...
export namespace PluginLoader {
  ...
  async function attempt<R>(
    ...
    if (isIndexingPlugin(candidate.plan.spec)) return // altrucoder_change
