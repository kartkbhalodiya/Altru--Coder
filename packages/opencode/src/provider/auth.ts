import type { AuthOAuthResult, Hooks } from "@altru-coder/plugin"
...
export const layer: Layer.Layer<Service, never, Auth.Service | Plugin.Service> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const callback = Effect.fn("ProviderAuth.callback")(function* (input: { providerID: ProviderID } & CallbackInput) {
      ...
      // altrucoder_change start - Update telemetry identity on Altru Coder auth
      if (input.providerID === "altru-coder") {
