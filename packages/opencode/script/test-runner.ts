...
// resources (ports, global filesystem like ~/.local/share/altru), not CPU.
...
const files = patterns.length > 0 ? matched : matched.filter((f) => !skipped.has(f)) // altrucoder_change
