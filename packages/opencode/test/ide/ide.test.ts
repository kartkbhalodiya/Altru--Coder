...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ALTRU_CODER_CALLER", () => {
    process.env["ALTRU_CODER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ALTRU_CODER_CALLER", () => {
    process.env["ALTRU_CODER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ALTRU_CODER_CALLER", () => {
    process.env["ALTRU_CODER_CALLER"] = "unknown"
