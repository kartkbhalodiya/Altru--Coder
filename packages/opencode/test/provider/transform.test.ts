...
describe("ProviderTransform.variants", () => {
  ...
  // altrucoder_change start
  describe("@altru-coder/altru-coder-gateway", () => {
    test("claude models return empty variants (reasoning disabled)", () => {
      const model = createMockModel({
        id: "altru-coder/anthropic/claude-sonnet-4",
        providerID: "altru-coder",
        capabilities: { reasoning: false },
        api: {
          id: "anthropic/claude-sonnet-4",
          url: "https://gateway.altru-coder.ai",
    ...
    test("anthropic models in api.id return empty variants (reasoning disabled)", () => {
      const model = createMockModel({
        id: "altru-coder/anthropic/claude-opus-4",
        providerID: "altru-coder",
        capabilities: { reasoning: false },
        api: {
    ...
    test("gemini-3 models return OPENAI_EFFORTS with reasoning and encrypted content", () => {
      const model = createMockModel({
        id: "altru-coder/google/gemini-3-pro",
        providerID: "altru-coder",
        api: {
    ...
    test("grok-3-mini returns low and high with reasoning", () => {
      const model = createMockModel({
        id: "altru-coder/x-ai/grok-3-mini",
        providerID: "altru-coder",
        api: {
          id: "x-ai/grok-3-mini",
          url: "https://gateway.altru-coder.ai",
    ...
    test("codex models return OPENAI_EFFORTS with object-based reasoning format", () => {
      const model = createMockModel({
        id: "altru-coder/openai/gpt-5.2-codex",
        providerID: "altru-coder",
        api: {
    ...
    // altrucoder_change start
    test("mercury-2 uses server-provided variants from altru-coder gateway", () => {
      ...
      const model = createMockModel({
        id: "altru-coder/inception/mercury-2",
        providerID: "altru-coder",
        api: {
          id: "inception/mercury-2",
          url: "https://gateway.altru-coder.ai",
  ...
  describe("ProviderTransform.smallOptions", () => {
    describe("@altru-coder/altru-coder-gateway", () => {
      ...
      test("google models disable reasoning", () => {
        const model = createMockModel({
          id: "altru-coder/google/gemini-2.0-flash",
          providerID: "altru-coder",
          api: {
...
// altrucoder_change start - tests for reasoningSummary guard
describe("ProviderTransform.options - OpenAI Responses API params guard", () => {
  ...
  test("includes reasoningSummary for @altru-coder/altru-coder-gateway", () => {
    const result = ProviderTransform.options({
      model: gpt5Model("@altru-coder/altru-coder-gateway", "altru-coder"),
      sessionID,
    })
    expect(result.reasoningSummary).toBe("auto")
  })
