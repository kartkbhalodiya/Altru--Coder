...
const original = Flag.ALTRU_CODER_EXPERIMENTAL_WORKSPACES
...
afterEach(async () => {
  ...
  Flag.ALTRU_CODER_EXPERIMENTAL_WORKSPACES = original
  await resetDatabase()
})
...
// altrucoder_change - skip these tests after upstream's Workspace refactor.
