...
const disableDefault = process.env.ALTRU_CODER_DISABLE_DEFAULT_PLUGINS
process.env.ALTRU_CODER_DISABLE_DEFAULT_PLUGINS = "1"
...
const experimental = Flag.ALTRU_CODER_EXPERIMENTAL_WORKSPACES
...
afterAll(() => {
  if (disableDefault === undefined) {
    delete process.env.ALTRU_CODER_DISABLE_DEFAULT_PLUGINS
  } else {
    process.env.ALTRU_CODER_DISABLE_DEFAULT_PLUGINS = disableDefault
  }

  Flag.ALTRU_CODER_EXPERIMENTAL_WORKSPACES = experimental
})
