...
import { MessageID, PartID, SessionID } from "../../src/session/schema" // altrucoder_change - SessionID used by cost propagation tests
...
// altrucoder_change start - stub signature + prompt body extended to persist assistant cost for propagation tests
    ...
    provideTmpdirInstance(
      () =>
        Effect.gen(function* () {
          ...
          // altrucoder_change start — use arrayContaining: Altru Coder appends inherited caller restrictions
        ...
        }),
      {
        config: {
          ...
          experimental: {
            ...
            openTelemetry: true, // altrucoder_change
          },
        },
      },
    ),
...
// altrucoder_change start - subagent cost propagation coverage (#6321)
