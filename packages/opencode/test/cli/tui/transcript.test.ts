...
import type { AssistantMessage, Part, Provider, UserMessage } from "@altru-coder/sdk/v2"
...
describe("transcript", () => {
  ...
  describe("formatMessage", () => {
    ...
    test("formats assistant message with metadata", () => {
      ...
      const result = formatMessage(msg, parts, options)
      expect(result).toContain("## Assistant (Code · Claude Sonnet 4 · 5.4s)") // altrucoder_change
  ...
  describe("formatTranscript", () => {
    test("formats complete transcript", () => {
      ...
      expect(result).toContain("## User")
      expect(result).toContain("Hello")
      expect(result).toContain("## Assistant (Code · Claude Sonnet 4 · 0.5s)") // altrucoder_change
    ...
    test("formats transcript without assistant metadata", () => {
      ...
      expect(result).not.toContain("Code") // altrucoder_change
