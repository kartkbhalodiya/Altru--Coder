...
// parseShareUrl tests
test("parses valid Altru Coder share URLs", () => {
  expect(parseShareUrl("https://app.altru-coder.ai/s/7a755b04-b0fe-4e66-8b30-0ab52a181bd4")).toBe(
    "7a755b04-b0fe-4e66-8b30-0ab52a181bd4",
  )
  expect(parseShareUrl("https://app.altru-coder.ai/s/Jsj3hNIW")).toBe("Jsj3hNIW")
  expect(parseShareUrl("https://app.altru-coder.ai/s/test_id-123")).toBe("test_id-123")
})

test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://app.altru-coder.ai/s/")).toBeNull()
  expect(parseShareUrl("https://app.altru-coder.ai/s/id/extra")).toBeNull()
