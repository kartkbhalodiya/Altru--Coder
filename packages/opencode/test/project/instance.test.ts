...
describe("InstanceStore", () => {
  ...
  // altrucoder_change - Altru Coder wraps init in the Instance ALS so AltruCoderBootstrap (and the
  // AltruCoderIndexing.init that it forkDetaches) can read Instance.directory. Upstream's test
  // asserted the opposite contract; rewrite to assert Altru Coder's contract.
  it.live("installs Instance ALS around Effect init for Altru Coder bootstrap compatibility", () =>
    Effect.gen(function* () {
