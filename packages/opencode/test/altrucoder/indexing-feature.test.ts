...
} from "../../src/altrucoder/indexing-feature"
...
describe("indexing plugin helpers", () => {
  ...
  test("does not add duplicate indexing plugin", () => {
    const list = ensureIndexingPlugin(["@altru-coder/altru-coder-indexing@1.0.0"], INDEXING_PLUGIN)
    expect(list).toEqual(["@altru-coder/altru-coder-indexing@1.0.0"])
  })
