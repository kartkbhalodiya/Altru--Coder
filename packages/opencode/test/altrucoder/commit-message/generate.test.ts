...
import type { GitContext } from "@/altrucoder/commit-message/types"
...
const realGitContext = await import("@/altrucoder/commit-message/git-context")
...
mock.module("@/altrucoder/commit-message/git-context", () => ({
  ...realGitContext,
...
import { generateCommitMessage } from "../../../src/altrucoder/commit-message/generate"
