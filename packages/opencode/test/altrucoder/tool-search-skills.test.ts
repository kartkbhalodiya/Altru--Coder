...
describe("Altru Coder built-in skills", () => {
  test("includes review, workflow, and skill-management skills", () => {
    ...
    expect(names.has("ui-ux-pro-max")).toBe(true)
    expect(names.has("ckm:ui-styling")).toBe(true)
    expect(names.has("ckm:design-system")).toBe(true)
    expect(names.has("ckm:brand")).toBe(true)
    expect(names.has("ckm:slides")).toBe(true)
    expect(names.has("ckm:banner-design")).toBe(true)
    expect(names.has("ckm:design")).toBe(true)
    expect(names.has("ui-ux-pro-max-full")).toBe(true)
