...
// altrucoder integration in shared LSP files, these tests catch it.

import { describe, test, expect, spyOn, afterEach } from "bun:test"
import path from "path"
import * as LSPServer from "../../src/lsp/server"
import { TsClient } from "../../src/altrucoder/ts-client"
import { TsCheck } from "../../src/altrucoder/ts-check"
...
describe("typescript lightweight mode", () => {
  ...
  describe("source integration guards", () => {
    // These tests verify that altrucoder integration code exists in shared
    ...
    test("lsp/server.ts gates Typescript.spawn behind flag", async () => {
      ...
      expect(src).toContain("ALTRU_CODER_EXPERIMENTAL_LSP_TOOL")
