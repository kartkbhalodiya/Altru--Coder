...
// 1. Imports DEFAULT_THEMES from our local default-themes (which includes Altru Coder themes)
// 2. Default theme changed from "oc-1" to "altru-coder"
...
const DEFAULT_THEME_ID = "altru-coder"
