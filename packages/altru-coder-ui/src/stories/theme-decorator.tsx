...
const STYLE_ID = "storybook-altru-coder-theme"
...
export function applyAltruCoderTheme(themeId: string, colorScheme: "light" | "dark") {
...
export function ThemeDecorator(props: ThemeDecoratorProps): JSX.Element {
  createEffect(() => {
    applyAltruCoderTheme(props.theme, props.colorScheme)
  })
  return <props.Story />
}
