  ...
  render: () => (
    <Accordion collapsible defaultValue={["item-1"]}>
      <Accordion.Item value="item-1">
        <Accordion.Header>
          <Accordion.Trigger>What is Altru Coder?</Accordion.Trigger>
        </Accordion.Header>
        <Accordion.Content>
          <div style={{ padding: "8px 16px" }}>
            Altru Coder is an AI-powered coding assistant that helps you write, debug, and understand code.
          </div>
        </Accordion.Content>
      </Accordion.Item>
      <Accordion.Item value="item-2">
        ...
        <Accordion.Content>
          <div style={{ padding: "8px 16px" }}>
            Altru Coder uses large language models to understand your codebase and provide intelligent suggestions.
          </div>
        </Accordion.Content>
      </Accordion.Item>
      <Accordion.Item value="item-3">
        ...
        <Accordion.Content>
          <div style={{ padding: "8px 16px" }}>
            Altru Coder supports all major programming languages including TypeScript, Python, Go, Rust, and more.
          </div>
        </Accordion.Content>
      </Accordion.Item>
    </Accordion>
