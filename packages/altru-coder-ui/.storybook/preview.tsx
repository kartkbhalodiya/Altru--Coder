...
import { applyAltruCoderTheme, applyVscodeTheme, clearVscodeTheme } from "../src/stories/theme-decorator"
import "./fonts.css"
import "../src/styles/index.css"

const themeDecorator: DecoratorFunction<SolidRenderer> = (Story, context) => {
  const themeId = (context.globals["theme"] as string) ?? "altru-coder"
