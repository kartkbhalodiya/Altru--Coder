module.exports = [
  {
    source: "/docs/contributing/cline-to-altru-coder-migration",
  ...
  // ============================================
  // COLLABORATE - Altru Coder for Teams
  // ============================================
  {
  ...
  // ============================================
  // AUTOMATE - Extending Altru Coder
  // ============================================
  {
  ...
  {
    source: "/docs/features/mcp/using-mcp-in-altru-coder",
    destination: "/docs/automate/mcp/using-in-altru-coder",
    basePath: false,
    permanent: true,
  },
  {
  ...
  },
  {
    ...
    destination: "/docs/getting-started/using-altru-coder-for-free",
    basePath: false,
    permanent: true,
  },
  {
  ...
  {
    source: "/docs/automate/altru-coder-claw/:path*",
    destination: "/docs/altru-coder-claw/:path*",
    basePath: false,
    permanent: true,
  },
  {
  ...
  // ============================================
  {
    source: "/docs/altru-coder-claw/suggested-configuration",
    destination: "/docs/altru-coder-claw/end-to-end",
    basePath: false,
    permanent: true,
  },
  {
    source: "/docs/altru-coder-claw/control-ui",
    destination: "/docs/altru-coder-claw/control-ui/overview",
    basePath: false,
    permanent: true,
  },
  {
    source: "/docs/altru-coder-claw/pricing",
    destination: "/docs/altru-coder-claw/faq/pricing",
    basePath: false,
    permanent: true,
  },
  {
    source: "/docs/altru-coder-claw/troubleshooting",
    destination: "/docs/altru-coder-claw/troubleshooting/common-questions",
    basePath: false,
    permanent: true,
  },
  {
    source: "/docs/altru-coder-claw/version-pinning",
    destination: "/docs/altru-coder-claw/control-ui/version-pinning",
    basePath: false,
    permanent: true,
  },
]
