...
const mainNavItems: NavItem[] = [
  ...
  { label: "Altru Coder Gateway", href: "/gateway" },
  { label: "AltruCoderClaw", href: "/altru-coder-claw" },
  { label: "Contributing", href: "/contributing" },
]

const contributingItems: DropdownItem[] = [
  { label: "Contributing Guide", href: "/contributing", description: "How to contribute to Altru Coder" },
  {
    label: "Code of Conduct",
    href: "https://github.com/Altru-Coder/altrucoder?tab=coc-ov-file",
    description: "Our community guidelines",
  },
  { label: "GitHub Repository", href: "https://github.com/Altru-Coder/", description: "View source and issues" },
  { label: "Discord Community", href: "https://altru-coder.ai/discord", description: "Join our community" },
]
...
const helpItems: DropdownItem[] = [
  ...
  { label: "Support", href: "https://altru-coder.ai/support", description: "Get help from the team" },
  {
    label: "Changelog",
    href: "https://github.com/Altru-Coder/altrucoder/releases",
...
function preview(url: string) {
  ...
  if (value.hostname !== "altru-coder.ai" || !value.pathname.startsWith("/docs")) return url
    ...
    <header className="top-header">
      ...
      <div className="top-bar">
        ...
        <Link href="/" className="logo-link flex gap-2 items-center">
          ...
          <div>
            <span className="logo-text font-brand">Altru Coder</span>
        ...
        <div className="right-actions">
          ...
          <ThemeToggle />
          <Link href="https://altru-coder.ai/github" className="github-link desktop-nav">
            GitHub
          </Link>
          <Link href="https://app.altru-coder.ai" className="signin-btn desktop-nav">
            Sign in
          </Link>
        </div>
      </div>
