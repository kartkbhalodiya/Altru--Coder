Altru Coder supports all JetBrains IDEs including IntelliJ IDEA, WebStorm, PyCharm, and more.

### Prerequisites

Before installing the Altru Coder plugin, ensure you have:
...
2. Then, you can click the button below to install Altru Coder directly from the JetBrains Marketplace:

[![Install Altru Coder](https://raster.shields.io/badge/Install%20Altru%20Coder-F8F674?style=for-the-badge)](https://plugins.jetbrains.com/plugin/28350-altru-coder)
