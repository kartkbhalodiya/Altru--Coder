---
title: "Customize"
description: "Make Altru Coder work your way with custom modes, rules, instructions, and more"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Altru Coder is highly customizable. Tailor its behavior to match your workflow, team standards, and project requirements with custom modes, rules, instructions, and more.
{% /callout %}

## Customization

Configure how Altru Coder behaves and responds:
...
- [**Skills**](/docs/customize/skills) - Extend Altru Coder's capabilities with reusable skill definitions
- [**Prompt Engineering**](/docs/customize/prompt-engineering) - Write effective prompts for better results

## Context & Indexing

Help Altru Coder understand your codebase better:
...
1. **Start with Custom Instructions** — Set up instructions in the [Custom Instructions](/docs/customize/custom-instructions) section to guide Altru Coder's behavior
2. **Explore Custom Modes** — Try the built-in modes first, then create your own
3. **Enable Codebase Indexing** — Help Altru Coder understand your project structure
...
- Check out [**Code with AI**](/docs/code-with-ai) to learn how to use Altru Coder effectively
