...
Prompt engineering is the art of crafting effective instructions for AI models like Altru Coder. Well-written prompts lead to better results, fewer errors, and a more efficient workflow.

## General Principles

- **Be Clear and Specific:** Clearly state what you want Altru Coder to do. Avoid ambiguity.
  - **Bad:** Fix the code.
...
It's often helpful to guide Altru Coder through a "think-then-do" process:

1.  **Analyze:** Ask Altru Coder to analyze the current code, identify problems, or plan the approach.
2.  **Plan:** Have Altru Coder outline the steps it will take to complete the task.
3.  **Execute:** Instruct Altru Coder to implement the plan, one step at a time.
4.  **Review:** Carefully review the results of each step before proceeding.

## Using Custom Instructions

You can provide custom instructions to further tailor Altru Coder's behavior. There are two types of custom instructions:
...
- Adjust Altru Coder's tone or personality.

See the [Custom Instructions](/docs/customize/custom-instructions) section for more details.

## Handling Ambiguity

If your request is ambiguous or lacks sufficient detail, Altru Coder might:
...
If Altru Coder doesn't produce the desired results, you can provide feedback by:

- **Rejecting Actions:** Click the "Reject" button when Altru Coder proposes an action you don't want.
- **Providing Explanations:** When rejecting, explain _why_ you're rejecting the action. This helps Altru Coder learn from its mistakes.
...
By following these tips, you can write effective prompts that get the most out of Altru Coder's capabilities.
