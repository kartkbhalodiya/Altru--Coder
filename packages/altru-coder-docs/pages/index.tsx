...
const terminalContent = {
  installation: (
    <>
      <span className="terminal-comment"># Install Altru Coder VS Code Extension</span>
      {"\n"}
      <span className="terminal-prompt">$</span> code --install-extension altrucoder.altru-coder
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or install via CLI</span>
      {"\n"}
      <span className="terminal-prompt">$</span> npm install -g @altru-coder/cli
    </>
  ),
  gateway: (
    <>
      <span className="terminal-comment"># Call Altru Coder Gateway with a quick curl script</span>
      {"\n"}
      <span className="terminal-prompt">$</span> export ALTRU_CODER_API_KEY="YOUR_API_KEY"
      {"\n"}
      <span className="terminal-prompt">$</span> curl https://api.altru-coder.ai/api/gateway/chat/completions \{"\n"}
      -H "Authorization: Bearer $ALTRU_CODER_API_KEY" \{"\n"}
      -H "Content-Type: application/json" \{"\n"}
      {`  -d '{"model":"anthropic/claude-sonnet-4.5","messages":[{"role":"user","content":"Say hi from Altru Coder Gateway"}]}'`}
    </>
  ),
  firstTask: (
    <>
      <span className="terminal-comment"># Start a new task with Altru Coder</span>
      {"\n"}
      <span className="terminal-prompt">$</span> altru-coder "Create a React component for a user profile"
      {"\n"}
      {"\n"}
      <span className="terminal-comment">
        # Or for interactive sessions, just run the Altru Coder CLI in your project folder
      </span>
      {"\n"}
      <span className="terminal-prompt">$</span> altru-coder
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Run in architect mode for planning</span>
      {"\n"}
      <span className="terminal-prompt">$</span> altru-coder --mode architect "Design a REST API"
    </>
  ),
  customRules: (
    <>
      ...
      {"\n"}
      <span className="terminal-prompt">$</span> touch .altrucoder/rules.md
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or use the CLI to add rules</span>
      {"\n"}
      <span className="terminal-prompt">$</span> altru-coder rules add "Always use TypeScript"
      {"\n"}
      <span className="terminal-prompt">$</span> altru-coder rules add "Follow React best practices"
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># List all active rules</span>
      {"\n"}
      <span className="terminal-prompt">$</span> altru-coder rules list
    </>
  ),
  altru-coder-claw: (
    <>
      <span className="terminal-comment"># Chat with your AltruCoderClaw agent from the CLI</span>
      {"\n"}
      <span className="terminal-prompt">$</span> altru-coder /claw
      {"\n"}
      {"\n"}
      ...
      {"\n"}
      <span className="terminal-prompt">$</span> curl -X POST https://your-instance.altru-coder-claw.ai/webhook \{"\n"}
      -H "Content-Type: application/json" \{"\n"}
...
const categories = [
  {
    title: "Get Started",
    description: "Install Altru Coder and get up and running in minutes",
  ...
  {
    title: "Code with AI",
    description: "Learn how to use Altru Coder to write, edit, and understand code",
    href: "/code-with-ai",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    ...
    href: "/altru-coder-claw/overview",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    links: [
      { title: "Overview", href: "/altru-coder-claw/overview" },
      { title: "Chat Platforms", href: "/altru-coder-claw/chat-platforms" },
      { title: "Development Tools", href: "/altru-coder-claw/development-tools" },
    ],
  },
  {
    title: "Collaborate",
    ...
    links: [
      ...
      { title: "Altru Coder for Teams", href: "/collaborate" },
  ...
  {
    title: "Contributing",
    description: "Help improve Altru Coder and learn about its architecture",
    href: "/contributing",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path
...
export default function HomePage() {
  const [activeTab, setActiveTab] = useState<"installation" | "firstTask" | "customRules" | "gateway" | "altru-coder-claw">(
    "installation",
  )
    ...
    <div className="homepage">
      ...
      <section className="hero">
        <div className="hero-content">
          <h1 className="hero-title">Altru Coder Documentation</h1>
          <p className="hero-subtitle">
            Explore guides and examples for the Altru Coder platform — from coding agents and AI-powered development to hosted
            agentic infrastructure with AltruCoderClaw.
          </p>
          <div className="hero-buttons">
            <Link href="/getting-started" className="btn btn-primary">
              Get started with Altru Coder →
            </Link>
            <Link href="/altru-coder-claw/overview" className="btn btn-secondary">
              Explore AltruCoderClaw
            </Link>
          </div>
        </div>
        ...
        <div className="quick-panel">
          <div className="quick-section">
            <h3 className="quick-title">ALTRU CODER</h3>
          ...
          <div className="quick-section">
            <h3 className="quick-title">ALTRU CODER CLAW</h3>
            <div className="quick-links">
              <Link href="/altru-coder-claw/overview" className="quick-link">
                Overview
              </Link>
              <Link href="/altru-coder-claw/chat-platforms" className="quick-link">
                Chat Platforms
              </Link>
              <Link href="/altru-coder-claw/development-tools" className="quick-link">
                Development Tools
              </Link>
            </div>
          </div>
      ...
      <section className="terminal-section">
        <div className="terminal-intro">
          ...
          <p className="terminal-description">Get started quickly with Altru Coder, AltruCoderClaw, and Altru Coder Gateway</p>
        </div>
        <div className="terminal-container">
          <div className="terminal-tabs">
            ...
            <button
              className={`terminal-tab ${activeTab === "altru-coder-claw" ? "active" : ""}`}
              onClick={() => setActiveTab("altru-coder-claw")}
            >
              AltruCoderClaw
            </button>
            <button
        ...
        <div className="footer-grid">
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://altru-coder.ai/discord" className="footer-link">
                Join our Discord
              </Link>
            </div>
          </div>
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/Altru-Coder/altrucoder/releases" className="footer-link">
                Changelog
              </Link>
            </div>
          </div>
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/Altru-Coder/altrucoder/issues" className="footer-link">
                Report an issue
              </Link>
            </div>
          </div>
