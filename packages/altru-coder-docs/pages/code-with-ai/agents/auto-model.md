...
Auto Model is a smart model routing system that automatically selects the optimal AI model based on the Altru Coder mode you're using. It comes in multiple tiers so you can balance cost and capability to fit your needs.

| Tier | Best For | Pricing |
|---|---|---|
| `altru-coder-auto/frontier` | Maximum capability with the best available models | Paid |
| `altru-coder-auto/balanced` | Strong performance at a lower cost | Paid |
| `altru-coder-auto/free` | The best free models available | Free |

## How It Works

1. Select an Auto Model tier (e.g. `altru-coder-auto/frontier`) in the model dropdown
...
You can see which underlying models are used, as well as the cost, in the expanded model picker. Model mapping information is also available on the [Gateway Model page](/docs/gateway/models-and-providers#altru-coder-autofrontier).
...
Select an Auto Model tier from the model dropdown in the Altru Coder chat interface. That's all you need to do.
{% /callout %}

1. Open Altru Coder in VS Code or JetBrains
2. Click the model selector dropdown
3. Choose an Auto Model such as `altru-coder-auto/frontier` or `altru-coder-auto/balanced`
...
- **New Altru Coder users** - Great defaults without needing to understand model differences
...
Auto Model is actively being improved. We'd love to hear how it's working for you! Share feedback in our [Discord](https://altru-coder.ai/discord) or [open an issue on GitHub](https://github.com/Altru-Coder/altrucoder/issues).
{% /callout %}

## Related

- [Model Selection Guide](/docs/code-with-ai/agents/model-selection) - General guidance on choosing models
- [Using Agents](/docs/code-with-ai/agents/using-agents) - Learn about different Altru Coder agents
- [Using Altru Coder for Free](/docs/getting-started/using-altru-coder-for-free) - Cost-effective alternatives
