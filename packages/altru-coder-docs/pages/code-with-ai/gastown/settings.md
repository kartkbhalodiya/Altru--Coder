...
Popular choices:
- **Altru Coder Auto Frontier** — highest quality models, best results (recommended)
- **Altru Coder Auto Balanced** — good balance of quality and cost (minimum for Gas Town)
...
Adding a GitHub PAT ensures that all commits, branches, and PRs created by your agents appear as **you** in git history. Without it, activity shows up under the Altru Coder GitHub App bot account.
{% /callout %}
...
- PRs show as created by the Altru Coder bot
- Some `gh` CLI operations may not work

### GitHub App Installation

The [Altru Coder GitHub App](https://github.com/apps/altru-coder) provides base-level repository access. It's installed per-organization or per-repository and gives agents read/write access to code, PRs, and issues.
