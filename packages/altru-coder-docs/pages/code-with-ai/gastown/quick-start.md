...
- A [Altru Coder account](https://app.altru-coder.ai) (free tier works)
...
{% browserFrame url="app.altru-coder.ai/gastown" caption="The new town onboarding flow" %}
...
Gastown uses the [Altru Coder GitHub App](https://github.com/apps/altru-coder) to access your repository. You'll be prompted to install it if you haven't already.

{% browserFrame url="app.altru-coder.ai/gastown/town/rigs/new" caption="Adding a new rig — connect your repository" %}
...
{% browserFrame url="app.altru-coder.ai/gastown/town/rigs/main" caption="The rig page — convoy tracker and kanban board showing beads in various states" %}
...
{% browserFrame url="app.altru-coder.ai/gastown/town" caption="The Mayor — your conversational interface to the town" %}
