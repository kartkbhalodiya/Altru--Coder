...
{% browserFrame url="app.altru-coder.ai/gastown/town/rigs/main" caption="A staged convoy — review the task breakdown before agents begin" %}
...
{% browserFrame url="app.altru-coder.ai/gastown/town/rigs/main" caption="Convoy in progress — review bead detail showing the refinery at work" %}
...
4. **Combined with Altru Coder Review** — if configured, human reviewers see the final PR too
...
{% browserFrame url="app.altru-coder.ai/gastown/town/rigs/main" caption="Convoy tracker — see exactly where execution has reached" %}
...
{% browserFrame url="app.altru-coder.ai/gastown/town/rigs/main" caption="Kanban board — beads flow through columns as agents work" %}
...
{% browserFrame url="app.altru-coder.ai/gastown/town/beads" caption="Beads page — filterable list of all work items" %}
...
{% browserFrame url="app.altru-coder.ai/gastown/town/beads/detail" caption="Bead detail — full history and status" %}
