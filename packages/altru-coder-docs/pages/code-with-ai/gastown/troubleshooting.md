...
**Fix:**
1. Check that the [Altru Coder GitHub App](https://github.com/apps/altru-coder) is installed on your repository
...
| Cause | Fix |
|---|---|
| GitHub App uninstalled | Reinstall at [github.com/apps/altru-coder](https://github.com/apps/altru-coder) |
...
3. **Contact support** — reach out at [altru-coder.ai/discord](https://altru-coder.ai/discord) with your town ID
