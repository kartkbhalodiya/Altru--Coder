---
title: "Gas Town by Altru Coder"
description: "Autonomous AI agent orchestration for your codebase"
---

# {% $markdoc.frontmatter.title %}

Gastown by Altru Coder is an autonomous agent orchestration platform that manages teams of AI agents working on your codebase. Built on [Gastown](https://gastown.dev) — the open protocol for agent orchestration — Altru Coder's implementation coordinates coding agents, a code review agent, and a conversational coordinator to ship features, fix bugs, and maintain your projects with minimal human intervention.
...
{% browserFrame url="app.altru-coder.ai/gastown/town" caption="A Gas Town with active agents, convoy progress, and Mayor chat" %}
...
{% browserFrame url="app.altru-coder.ai/gastown/town/rigs/main" caption="A staged convoy ready to be kicked off" %}
...
{% browserFrame url="app.altru-coder.ai/gastown/town/rigs/main" caption="Agents working on a convoy — beads flowing through the pipeline" %}
...
{% browserFrame url="app.altru-coder.ai/gastown/town/beads" caption="The beads page — all work items with status, type, and history" %}
...
{% browserFrame url="app.altru-coder.ai/gastown/town/rigs/main" caption="Staged convoy detail — review the plan before agents start" %}
