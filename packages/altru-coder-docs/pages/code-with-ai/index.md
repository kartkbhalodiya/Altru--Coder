---
title: "Code with AI"
description: "Learn how to code with AI using Altru Coder across different platforms and interfaces"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Altru Coder is your AI pair programmer that works in your IDE, terminal, or browser. Generate code, refactor, debug, and ship faster with AI that understands your codebase and context.
{% /callout %}

## Getting Started

New to Altru Coder? Start here to understand the core concepts:

- [**Install Altru Coder**](/docs/getting-started/installing) — Get started in VS Code, JetBrains, CLI, or mobile
...
Use Altru Coder wherever you work:
...
- [**Cloud Agent**](/docs/code-with-ai/platforms/cloud-agent) — Run Altru Coder in the cloud
- [**Mobile Apps**](/docs/code-with-ai/platforms/mobile) — iOS and Android support
- [**Slack**](/docs/code-with-ai/platforms/slack) — Chat with Altru Coder in your workspace
- [**App Builder**](/docs/code-with-ai/app-builder) — Create full-stack applications with AI

## Working with Agents

Altru Coder uses specialized agents to help with different tasks:
...
- Explore [**Customize**](/docs/customize) to tailor Altru Coder to your workflow
