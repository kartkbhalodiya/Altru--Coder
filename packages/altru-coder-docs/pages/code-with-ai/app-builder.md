---
title: "App Builder"
description: "Build complete applications with Altru Coder"
---

# App Builder

Altru Coder's **App Builder** lets you create end-to-end applications through natural language conversation. Describe what you want to build, watch it come to life in a real-time preview, and deploy directly from your Altru Coder dashboard. No local environment setup required.
...
- **Active Altru Coder account**
  Sign up or log in at [app.altru-coder.ai](https://app.altru-coder.ai)

---

## Cost

- You pay only for the AI model usage via Altru Coder credits
...
1. Navigate to **[App Builder](https://app.altru-coder.ai/app-builder)** from your Altru Coder dashboard.
