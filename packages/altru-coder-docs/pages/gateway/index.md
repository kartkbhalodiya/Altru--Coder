...
The Altru Coder AI Gateway provides a unified, OpenAI-compatible API to access hundreds of AI models through a single endpoint at `https://api.altru-coder.ai/api/gateway`. It gives you the ability to track usage, manage costs, bring your own API keys, and enforce organization-level controls.
...
```
https://api.altru-coder.ai/api/gateway
```
