---
title: "Usage & Billing"
description: "Understand how the Altru Coder AI Gateway tracks costs, manages balances, and enforces organization-level spending controls."
---

# Usage & Billing

The Altru Coder AI Gateway tracks usage and costs for every request with microdollar precision (1 USD = 1,000,000 microdollars). This enables accurate billing even for very low-cost requests.
...
- **BYOK requests**: When using your own API key, the cost is set to $0 on Altru Coder's side. You pay the provider directly based on your agreement with them

## Balance management

### Individual accounts

Your account balance is the difference between total credits purchased and total usage. Check your balance in the [Altru Coder dashboard](https://app.altru-coder.ai).
...
```json
{
  "error": {
    ...
    "code": 402,
    "metadata": {
      "buyCreditsUrl": "https://app.altru-coder.ai/credits"
    }
  }
}
```
