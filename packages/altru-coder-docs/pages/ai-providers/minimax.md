---
title: "Using MiniMax with Altru Coder"
description: "Configure MiniMax AI models in Altru Coder. Guide to getting an API key and setup for VS Code and the CLI."
sidebar_label: MiniMax
---

# Using MiniMax With Altru Coder
...
3. **Create a Key:** Click to generate a new API key and give it a descriptive name (e.g., "Altru Coder").
