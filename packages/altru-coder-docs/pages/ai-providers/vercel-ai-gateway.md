---
title: "Using Vercel AI Gateway with Altru Coder"
description: Configure the Vercel AI Gateway in Altru Coder to robustly access 100+ language models from various providers through a centralized interface.
keywords:
  - altru coder
  - vercel ai gateway
  - ai provider
...
# Using Vercel AI Gateway With Altru Coder
...
The Vercel AI Gateway supports a large and growing number of models. Altru Coder automatically fetches the list of available models from the `https://ai-gateway.vercel.sh/v1/models` endpoint. Only language models are shown.
