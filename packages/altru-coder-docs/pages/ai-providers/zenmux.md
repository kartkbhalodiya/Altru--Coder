---
title: "Using ZenMux with Altru Coder | Unified AI Gateway"
description: "Access OpenAI, Anthropic, Google, and other AI models through ZenMux in Altru Coder with automatic routing and cost optimization."
sidebar_label: ZenMux
---

# Using ZenMux With Altru Coder
...
3. **Configure in Altru Coder:** Add your API key to Altru Coder settings.
...
- Check the [Altru Coder GitHub repository](https://github.com/Altru-Coder/altrucoder) for integration-specific issues
