---
title: "Using GCP Vertex AI with Altru Coder"
description: "Connect Google Cloud Vertex AI to Altru Coder to use Claude, Gemini, and other models through your GCP account."
sidebar_label: GCP Vertex AI
---

# Using GCP Vertex AI With Altru Coder

Altru Coder supports accessing models through Google Cloud Platform's Vertex AI, a managed machine learning platform that provides access to various foundation models, including Anthropic's Claude family.
...
- **Application Default Credentials (ADC):** Altru Coder uses Application Default Credentials to authenticate with Vertex AI. The easiest way to set this up is to:
...
- **Prompt caching:** Claude models served through Vertex AI support Altru Coder prompt caching. Altru Coder applies Anthropic cache controls and tracks cache write/read tokens when Vertex reports them. Native Vertex Gemini models use Google's implicit server-side caching; no extra Altru Coder configuration is required, and Gemini may not report cache write tokens.
