---
title: "Using xAI Grok with Altru Coder"
description: "Connect xAI's Grok models to Altru Coder. Guide to getting an API key and configuring Grok in VS Code and the CLI."
sidebar_label: xAI (Grok)
---

# Using xAI (Grok) With Altru Coder
...
3.  **Create a Key:** Click to create a new API key. Give your key a descriptive name (e.g., "Altru Coder").
