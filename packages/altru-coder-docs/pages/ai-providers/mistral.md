---
title: "Using Mistral AI with Altru Coder"
description: "Configure Mistral AI models, including Codestral, in Altru Coder. Guide to getting an API key and setup for VS Code and the CLI."
sidebar_label: Mistral AI
---

# Using Mistral AI With Altru Coder

Altru Coder supports accessing models through the Mistral AI API, including both standard Mistral models and the code-specialized Codestral model.
...
Mistral's adjustable reasoning support is exposed only for reasoning-capable Mistral Small 4 models: `mistral-small-2603` and `mistral-small-latest`. When one of these models is selected, Altru Coder offers a `high` variant that sends `reasoningEffort: "high"` to the Mistral provider.
