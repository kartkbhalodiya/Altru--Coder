---
title: "Using SAP AI Core with Altru Coder"
description: "Connect SAP AI Core to Altru Coder to use enterprise foundation models from your SAP BTP account. Setup and authentication guide."
sidebar_label: SAP AI Core
---

# Using SAP AI Core With Altru Coder

Altru Coder supports accessing models through SAP AI Core, a service in the SAP Business Technology Platform that lets you efficiently run AI scenarios in a standardized, scalable, and hyperscaler-agnostic manner.
...
To use SAP AI Core with Altru Coder, you'll need to create a service key for your SAP AI Core service instance:
...
Altru Coder applies the following filters when fetching models:
...
3. Configure Altru Coder with your credentials
