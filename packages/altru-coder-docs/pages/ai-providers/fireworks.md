---
title: "Using Fireworks AI with Altru Coder | Fast Inference"
description: "Run open-source and proprietary models on Fireworks AI's high-performance platform in Altru Coder. Setup guide for VS Code and the CLI."
---

# Using Fireworks AI With Altru Coder
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "Altru Coder").
