---
title: "Using DeepSeek with Altru Coder"
description: "Connect DeepSeek's reasoning and coding models to Altru Coder. Setup guide for DeepSeek-V3 and DeepSeek-R1 in VS Code and the CLI."
sidebar_label: DeepSeek
---

# Using DeepSeek With Altru Coder

Altru Coder supports accessing models through the DeepSeek API, including `deepseek-chat` and `deepseek-reasoner`.
