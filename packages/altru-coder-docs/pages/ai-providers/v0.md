---
title: "Using Vercel v0 with Altru Coder"
description: "Connect Vercel's v0 models to Altru Coder for UI-focused code generation. Setup guide for VS Code and the CLI."
sidebar_label: v0
---

# Using v0 With Altru Coder

Altru Coder supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with Altru Coder through the familiar OpenAI API interface.

## Prerequisites

To use v0 with Altru Coder, you'll need:
...
Setting up v0 in Altru Coder is straightforward:

1. In Altru Coder settings (click the {% codicon name="gear" /%} icon):
...
<!-- <img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in Altru Coder settings" width="600" /> -->
