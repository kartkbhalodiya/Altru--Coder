---
title: "Using Anthropic Claude with Altru Coder"
description: "Configure Anthropic's Claude models in Altru Coder. Guide to getting an API key, setting up Claude Sonnet and Opus in VS Code and the CLI."
sidebar_label: Anthropic
---

# Using Anthropic With Altru Coder
...
3.  **Create a Key:** Click "Create Key". Give your key a descriptive name (e.g., "Altru Coder").
