---
title: "Using Requesty with Altru Coder"
description: "Route AI model requests through Requesty in Altru Coder for cost optimization and access to multiple providers from one API key."
sidebar_label: Requesty
---

# Using Requesty With Altru Coder

Altru Coder supports accessing models through the [Requesty](https://www.requesty.ai/) AI platform. Requesty provides an easy and optimized API for interacting with 150+ large language models (LLMs).
