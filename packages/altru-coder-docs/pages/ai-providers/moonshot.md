---
title: "Using Moonshot AI (Kimi) with Altru Coder"
description: "Connect Moonshot's Kimi models to Altru Coder. Setup guide for getting an API key and selecting models in VS Code and the CLI."
sidebar_label: Moonshot.ai
---

# Using Moonshot.ai With Altru Coder
...
3. **Create a Key:** Click to generate a new API key. Give it a descriptive name (e.g., "Altru Coder").
...
- **Kimi-specific prompting:** Altru Coder automatically uses a Kimi-tuned system prompt for model IDs containing `kimi`; no extra configuration is required.
