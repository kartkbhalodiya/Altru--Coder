---
title: "Using Glama with Altru Coder"
description: "Connect Glama's unified AI gateway to Altru Coder to access Claude, GPT, and other leading models through a single API key."
sidebar_label: Glama
---

# Using Glama With Altru Coder
...
Altru Coder will automatically try to fetch a list of available models from the Glama API. Some models that are commonly available through Glama include:

- **Anthropic Claude models:** (e.g., `anthropic/claude-3-5-sonnet`) These are generally recommended for best performance with Altru Coder.
...
Glama is not yet available as a CLI provider. Check the [Altru Coder releases](https://github.com/Altru-Coder/altrucoder/releases) for updates on provider support.
{% /callout %}
