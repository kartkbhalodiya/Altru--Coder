---
title: "Using Synthetic with Altru Coder"
description: "Access open-source AI models through Synthetic in Altru Coder. Setup guide for getting an API key and configuring models."
sidebar_label: Synthetic
---

# Using Synthetic With Altru Coder
...
Altru Coder supports all "always on" Synthetic AI models. The available models include various open-source options optimized for different use cases.
