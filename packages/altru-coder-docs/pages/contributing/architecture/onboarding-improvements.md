...
Users aren't guided through Altru Coder's modes or key features. The existing tab-based tutorial is easily dismissed, causing users to miss critical functionality.
...
├── Content: "Welcome to AltruCoder! Let's take a quick tour."
...
## Altru Coder Provider Settings UI Improvements

The "Set API Key" button is at the bottom of settings, making Altru Coder setup hard to discover and complete.

**Improvements:**

- Move "Set API Key" button next to API key input field
- Rearrange layout for better flow
- Make Altru Coder provider setup prominent
...
- Integration with Altru Coder teams for company/repo-personalized onboarding
