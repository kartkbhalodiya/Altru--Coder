...
{% callout type="info" %}
**New versions of the VS Code extension and CLI are being developed in [Altru-Coder/altrucoder](https://github.com/Altru-Coder/altrucoder)** (extension at `packages/altru-coder-vscode`, CLI at `packages/opencode`). For extension and CLI development, please head over to that repository.
{% /callout %}
...
1. **Fork and Clone the Repository**:
   - **Fork the Repository**:
     - Visit the [Altru Coder GitHub repository](https://github.com/Altru-Coder/altrucoder)
     - Click the "Fork" button in the top-right corner to create your own copy.
   - **Clone Your Fork**:
     ```bash
     git clone https://github.com/[YOUR-USERNAME]/altrucoder.git
     cd altrucoder
     ```
...
2. This will open a new VSCode window with Altru Coder loaded
...
```bash
code --install-extension "$(ls -1v bin/altru-coder-*.vsix | tail -n1)"
```
...
Altru Coder uses several types of tests to ensure quality:
...
- Check the Output panel in VSCode (View > Output) and select "Altru Coder" from the dropdown
