...
## Why Altru Coder Uses MCP

Altru Coder leverages MCP to provide:
...
MCP creates a universal connector between Altru Coder and external services, with REST APIs often powering those services behind the scenes.
