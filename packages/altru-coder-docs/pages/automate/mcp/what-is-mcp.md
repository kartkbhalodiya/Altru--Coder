...
Altru Coder implements the Model Context Protocol to:
...
- [Using MCP in Altru Coder](using-in-altru-coder) - Get started with MCP in Altru Coder, including creating simple servers
