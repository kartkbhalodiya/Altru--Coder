...
description: "How to configure and use MCP servers in the Altru Coder CLI"
---

# Using MCP in the CLI

The Altru Coder CLI supports both local and remote MCP servers. Once added, MCP tools are automatically available to the LLM alongside built-in tools.
...
|---|---|---|
| **Global** | `~/.config/altru-coder/altru-coder.json` | `altru-coder.jsonc`, `config.json` |
| **Project** | `./altru-coder.json` or `./.altru-coder/altru-coder.json` | `altru-coder.jsonc` |
...
Browse community-contributed MCP server configurations and agent skills in the [Altru Coder Marketplace](https://github.com/Altru-Coder/altru-marketplace). The marketplace includes ready-to-use configs for popular tools like Figma, Sentry, and more.
