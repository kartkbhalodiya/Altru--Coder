...
Altru Coder's Code Reviews integrate with GitHub via a **GitHub App** to automatically review pull requests with AI. When a PR is opened, updated, or marked ready for review, the Review Agent analyzes the changes and posts feedback directly on the pull request.
...
1. A 👀 reaction appears on the PR — this means Altru Coder is reviewing
...
1. Go to your GitHub Settings → Applications → AltruCoderConnect → Configure
