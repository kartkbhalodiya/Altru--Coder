...
Altru Coder's **Code Reviews** feature automatically analyzes your pull or merge requests using an AI model of your choice. It can review code the moment a PR/MR is opened or updated, surface issues, and provide structured feedback across performance, security, style, and test coverage.
...
- **A platform integration must be configured:** Connect your GitHub or GitLab account via the [Integrations page](https://app.altru-coder.ai/integrations) so that the Review Agent can access your repositories. See the [Integration setup guide](/docs/automate/integrations) for detailed instructions.
- **Altru Coder credits:** The AI model uses credits when analyzing your code.

## Cost

- **Compute and review time are free during limited beta**
  - Feedback is welcome in the Code Reviews beta Discord channel:
    - [Altru Coder Discord](https://discord.gg/hZnd57qN)
- **Altru Coder credits are still used** when the agent performs model reasoning during a review.

## Getting Started

1. Go to the **Code Reviews** page in your [personal dashboard](https://app.altru-coder.ai/profile) or [organization dashboard](https://app.altru-coder.ai/organizations).
