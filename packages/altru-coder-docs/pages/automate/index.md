---
title: "Automate"
description: "Automate your development workflows with Altru Coder"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Altru Coder's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Altru Coder to external tools and services:
...
- [**Using MCP in Altru Coder**](/docs/automate/mcp/using-in-altru-coder) — Configuration guide
...
Connect Altru Coder with your development tools:
...
## Extending Altru Coder

Customize and extend Altru Coder's capabilities:
...
2. Configure [MCP servers](/docs/automate/mcp/using-in-altru-coder) for external integrations
