...
Audit Logs record key actions that occur in the management of your Altru Coder seats, including user logins, adding or removing models, providers, and modes, and role changes.
...
Here is the list of all events included in the Altru Coder audit logs:
