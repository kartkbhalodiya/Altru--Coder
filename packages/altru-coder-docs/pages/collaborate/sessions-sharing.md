...
This information lets Altru Coder show your recent sessions and continue right from the same context the next time you open it.
...
3. Interact with Altru Coder via any of our interfaces- the CLI, the Cloud Agent, or the Extensions in your favorite IDE.
...
To keep sessions fast and resumable, Altru Coder stores small JSON blobs associated with your session. These include your conversation history and task metadata. If you share a session, Altru Coder keeps a public copy used by the share link while your private session remains under your account.
