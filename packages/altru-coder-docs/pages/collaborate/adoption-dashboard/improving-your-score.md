...
**Action:** Install the Altru Coder CLI to enable AI-assisted terminal workflows:
...
**Action:** Use [Altru Coder Deploy](/docs/deploy-secure/deploy) to spin up live URLs for branches, allowing your team to verify changes before merging.
...
Most teams start with Code mode and stop there. But Altru Coder's other modes unlock additional value.
...
4. Consider Altru Coder Deploy to validate AI output
