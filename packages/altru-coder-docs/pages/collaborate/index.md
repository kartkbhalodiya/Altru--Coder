---
title: "Collaborate"
description: "Work together with Altru Coder team features"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Altru Coder makes it easy to work together with your team. Share sessions, manage team settings, and track AI adoption across your organization.
{% /callout %}

## Sessions & Sharing

Sessions are your platform-agnostic interaction with Altru Coder. They remember your repository, task, and conversation so you can pause and resume work without losing context.

- [**Sessions & Sharing**](/docs/collaborate/sessions-sharing) — Share and collaborate on Altru Coder sessions
...
Altru Coder's paid plans provide powerful team management features:
...
- **Enterprise ([Contact Sales](https://altru-coder.ai/contact-sales))** — Model controls, audit logs, SSO, dedicated support
