...
Custom Modes let you create tailored versions of Altru Coder's built-in [agents](/docs/code-with-ai/agents/using-agents) for your organization. You can also adjust the settings for Altru Coder's original default modes. You can define a mode's purpose, behavior, and tool access — helping Altru Coder adapt to your team's unique workflows.
...
| **Role Definition** | Describe Altru Coder's role and personality for this mode. Shapes how it reasons and responds. |
