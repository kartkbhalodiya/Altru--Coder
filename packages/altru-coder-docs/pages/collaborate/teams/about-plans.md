---
title: "About Plans"
description: "Overview of Altru Coder plans and pricing"
---

# About Plans

Altru Coder accelerates development with AI-driven code generation and task automation. You can use Altru Coder as an open source extension in VS Code or JetBrains IDEs.
...
Altru Coder's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of Altru Coder's paid plans are separate from model provider credits.

No credits are included with a Teams or Enterprise plan purchase.

{% /callout %}

## What You Get from Altru Coder Teams
...
## What You Get from Altru Coder Enterprise
...
**Cost:** [Contact Sales](https://altru-coder.ai/contact-sales)
