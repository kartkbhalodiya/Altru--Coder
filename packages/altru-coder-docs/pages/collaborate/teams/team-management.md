...
description: "Add and manage team members in Altru Coder"
---
...
Members can use the Altru Coder extension and see data on the team's usage in the [usage dashboard](/docs/collaborate/teams/analytics).
