...
description: "How AltruCoderClaw instances are structured"
---

# Architecture Notes

For advanced users — how AltruCoderClaw instances are structured:
...
- **Network isolation** — OpenClaw binds to loopback only; external traffic is proxied through a Altru Coder controller.
