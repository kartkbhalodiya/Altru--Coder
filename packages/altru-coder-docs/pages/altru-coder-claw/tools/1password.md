...
description: "Connect your AltruCoderClaw agent to 1Password to securely manage credentials"
---

# 1Password Integration Guide

Connect your AltruCoderClaw agent to 1Password to securely manage credentials. This allows your agent to fetch API keys or passwords without ever seeing them in plain text.
...
2. Create a **New Vault** (e.g., name it `Altru-Coder-Agent-Vault`).
...
## Step 3: Configure AltruCoderClaw

1. Navigate to your AltruCoderClaw dashboard: [app.altru-coder.ai/claw](https://app.altru-coder.ai/claw).
