---
title: "Discord"
description: "Use AltruCoderClaw with Discord: setup, DM access control, and channel configuration"
---

# Discord

This page covers everything you need to use AltruCoderClaw with Discord: connecting your bot, controlling who can DM it, and adding it to specific channels.

## Connecting AltruCoderClaw to Discord

Create a bot in the Discord Developer Portal and link it to your AltruCoderClaw dashboard.
...
2. Copy the token that appears and paste it into the **Discord Bot Token** field in your AltruCoderClaw dashboard.

{% image src="/docs/img/altru-coder-claw/discord.png" alt="Connect account screen" width="800" caption="Discord bot token entry" /%}

Enter the token in the Settings tab and click **Save**. You can remove or replace a configured token at any time.

## Redeploy to Apply Changes

After saving your token, click **Redeploy** (the yellow button at the top of the AltruCoderClaw dashboard) to apply the changes. The server will restart in about 30–45 seconds. Wait for the redeploy to complete before pairing.
...
4. Return to [app.altru-coder.ai/claw](https://app.altru-coder.ai/claw) and confirm the pairing code and approve
5. You should now be able to chat with the bot from Discord

## Restricting AltruCoderClaw to DMs Only (Just You)

By default, AltruCoderClaw will respond to any DMs. To lock it down to only DMs with you:
...
## Adding AltruCoderClaw to a Specific Discord Channel

By default, your AltruCoderClaw will not respond in channels, even if added. To have AltruCoderClaw participate in a specific channel:
