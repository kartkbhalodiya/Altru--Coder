...
description: "Connect a GitHub account to your AltruCoderClaw agent for repository access"
---

# GitHub Integration

Connect a GitHub account to your AltruCoderClaw agent so it can clone repositories, push commits, open pull requests, and leave code reviews — all autonomously.
...
AltruCoderClaw uses a [fine grained Personal Access Token](https://github.com/settings/tokens?type=beta) to authenticate as your bot. When creating the token, use these settings:

| Setting | Recommended Value |
|---|---|
| **Token name** | `altru-coder-claw-bot` (or any descriptive name) |
...
### Step 3: Enter credentials in AltruCoderClaw
...
AltruCoderClaw accepts both GitHub token formats:
...
When your instance starts, AltruCoderClaw automatically:
...
- Tokens are encrypted at rest using AltruCoderClaw's secret management system
