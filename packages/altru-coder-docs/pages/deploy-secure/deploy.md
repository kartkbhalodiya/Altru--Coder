---
title: "Deploy"
description: "Deploy your applications with Altru Coder"
---

# Deploy

Altru Coder Deploy lets you ship **Next.js** and **static sites** directly from Altru Coder, with:

- **One-click deployment** from the Altru Coder dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to Altru Coder
...
- Navigate to your [Organization dashboard](https://app.altru-coder.ai/organizations) or [Profile](https://app.altru-coder.ai/profile)
...
Altru Coder Deploy does **not** include built-in database hosting, but you can connect to any external database service.

---

## Environment Variables

Altru Coder Deploy supports Environment Variables and Secrets. Add the variable **key** and **value** during the **Create New Deployment** step, and toggle to mark as secrets.
