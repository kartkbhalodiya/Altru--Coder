---
title: "Deploy & Secure"
description: "Deploy applications and manage security with Altru Coder"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Deploy your applications directly from Altru Coder and manage security with AI-powered reviews and scans.
{% /callout %}
