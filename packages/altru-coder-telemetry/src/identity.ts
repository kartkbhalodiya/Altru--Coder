...
import { fetchProfile } from "@altru-coder/altru-coder-gateway"
...
export namespace Identity {
  ...
  export async function getMachineId(): Promise<string | undefined> {
    ...
    const override = process.env.ALTRU_CODER_MACHINE_ID
    if (override) {
      machineId = override
      return machineId
    }
  ...
  export async function updateFromAltruCoderAuth(token: string | null, accountId?: string): Promise<void> {
