...
async function loadLanguageForFileExt(fileExtension: string): Promise<Language> {
  ...
  // In production (compiled): __dirname = /path/to/altrucoder/src/dist or dist/
  // In development: __dirname = /path/to/altrucoder/src/services/autocomplete/continuedev/core/util
  const candidatePaths: string[] = [
