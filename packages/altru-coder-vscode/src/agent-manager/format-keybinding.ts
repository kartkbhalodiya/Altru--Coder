...
const AM_PREFIX = "altru-coder.new.agentManager."

/** Global commands whose keybindings are forwarded to the webview. */
const GLOBAL_KEYBINDINGS: Record<string, string> = {
  "altru-coder.new.agentManagerOpen": "agentManagerOpen",
  "altru-coder.new.cycleAgentMode": "cycleAgentMode",
  "altru-coder.new.cyclePreviousAgentMode": "cyclePreviousAgentMode",
}
