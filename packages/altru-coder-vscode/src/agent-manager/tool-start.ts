...
async function prompt(client: AltruCoderClient, sid: string, dir: string, task: ToolTask) {
...
async function local(deps: ToolDeps, client: AltruCoderClient, task: ToolTask, directory?: string) {
