...
import { ALTRU_CODER_DIR } from "../constants"
 ...
 * - If the entry is a symlink, the resolved target must live inside the .altru-coder directory
 */
...
export class RunScriptService {
  ...
  constructor(root: string) {
    this.dir = path.join(root, ALTRU_CODER_DIR)
  }
