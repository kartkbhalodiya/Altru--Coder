...
export class DiffVirtualProvider implements vscode.Disposable {
  ...
  constructor(private readonly extensionUri: vscode.Uri) {
    this.outputChannel = vscode.window.createOutputChannel("Altru Coder Diff Virtual")
  }
  ...
  public open(diff: DiffVirtualFile): void {
    ...
    const panel = vscode.window.createWebviewPanel("altru-coder.new.DiffVirtualPanel", title, vscode.ViewColumn.One, {
      enableScripts: true,
