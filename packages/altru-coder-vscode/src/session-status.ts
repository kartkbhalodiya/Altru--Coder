import type { AltruCoderClient, SessionStatus } from "@altru-coder/sdk/v2/client"
...
export async function seedSessionStatuses(
  ...
  try {
    ...
    console.error("[Altru Coder New] AltruCoderProvider: Failed to seed session statuses:", error)
  }
}
