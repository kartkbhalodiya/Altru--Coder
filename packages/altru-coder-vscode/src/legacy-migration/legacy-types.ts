/**
 * legacy-migration - Types for legacy Altru Coder extension (v5.x) data structures.
 *
 * These types represent the shapes stored in VS Code SecretStorage and on disk
 * by the legacy extension (altrucoder.altru-coder v5.x, a Roo Code fork).
...
// ---------------------------------------------------------------------------
// Settings (stored in VS Code globalState under "altru-coder.*" keys)
// ---------------------------------------------------------------------------
