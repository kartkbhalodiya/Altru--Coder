...
export class DiffViewerProvider implements vscode.Disposable {
  public static readonly viewType = "altru-coder.new.DiffViewerPanel"
  ...
  constructor(
    ...
    this.output = vscode.window.createOutputChannel("Altru Coder Diff Panel")
  }
  ...
  /**
   * Entry point for the `altru-coder.new.showChanges` command. Composes the
  ...
  private onWebviewReady(): void {
    ...
    void this.panel.webview.postMessage({
      ...
      languageOverride: vscode.workspace.getConfiguration("altru-coder.new").get<string>("language"),
