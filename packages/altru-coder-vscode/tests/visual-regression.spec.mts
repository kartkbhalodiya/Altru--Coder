...
const DOCS = new Map<string, string[]>([
  [
    ...
    [
      "packages/altru-coder-docs/pages/code-with-ai/features/task-todo-list.md:/docs/img/screenshot-tests/altru-coder-vscode/visual-regression/chat/task-header-with-todos-chromium-linux.png",
    ],
  ],
  [
    "composite-webview--todo-write-docs-overview",
    [
      "packages/altru-coder-docs/pages/code-with-ai/features/task-todo-list.md:/docs/img/screenshot-tests/altru-coder-vscode/visual-regression/composite-webview/todo-write-docs-overview-chromium-linux.png",
    ],
  ],
  [
    "settings--agent-behaviour-workflows",
    [
      "packages/altru-coder-docs/pages/customize/workflows.md:/docs/img/screenshot-tests/altru-coder-vscode/visual-regression/settings/agent-behaviour-workflows-chromium-linux.png",
    ],
  ],
])
...
for (const story of stories) {
  test(`${story.title} / ${story.name}`, async ({ page }) => {
    ...
    await page.goto(
      `/iframe.html?id=${story.id}&viewMode=story&globals=colorScheme:dark;theme:altru-coder-vscode;vscodeTheme:dark-modern`,
      { waitUntil: "load" },
    )
