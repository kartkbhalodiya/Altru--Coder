 ...
 *   - Webview (sidebar + agent manager): merged from app, ui, altru-coder-i18n, agent-manager dicts
...
// Layer 2: upstream UI (@opencode-ai/ui re-exported via @altru-coder/altru-coder-ui)
...
// Layer 3: altru-coder-i18n overrides
import { dict as altruEn } from "../../../altru-coder-i18n/src/en"
import { dict as altruZh } from "../../../altru-coder-i18n/src/zh"
import { dict as altruZht } from "../../../altru-coder-i18n/src/zht"
import { dict as altruKo } from "../../../altru-coder-i18n/src/ko"
import { dict as altruDe } from "../../../altru-coder-i18n/src/de"
import { dict as altruEs } from "../../../altru-coder-i18n/src/es"
import { dict as altruFr } from "../../../altru-coder-i18n/src/fr"
import { dict as altruDa } from "../../../altru-coder-i18n/src/da"
import { dict as altruJa } from "../../../altru-coder-i18n/src/ja"
import { dict as altruPl } from "../../../altru-coder-i18n/src/pl"
import { dict as altruRu } from "../../../altru-coder-i18n/src/ru"
import { dict as altruAr } from "../../../altru-coder-i18n/src/ar"
import { dict as altruNo } from "../../../altru-coder-i18n/src/no"
import { dict as altruBr } from "../../../altru-coder-i18n/src/br"
import { dict as altruTh } from "../../../altru-coder-i18n/src/th"
import { dict as altruBs } from "../../../altru-coder-i18n/src/bs"
import { dict as altruTr } from "../../../altru-coder-i18n/src/tr"
import { dict as altruNl } from "../../../altru-coder-i18n/src/nl"
import { dict as altruUk } from "../../../altru-coder-i18n/src/uk"
...
const altruLocales: Record<string, Record<string, string>> = {
  en: altruEn,
  zh: altruZh,
  zht: altruZht,
  ko: altruKo,
...
describe("i18n locale completeness — every English key exists in all locales", () => {
  ...
  it("altru-coder-i18n: every English key has a translation in all locales", () => {
    const missing = findMissingLocaleKeys(altruEn, altruLocales)
    if (missing.length > 0) {
      expect(
        missing,
        `Found ${missing.length} missing altru-coder-i18n translation(s):\n${formatLocaleReport(missing)}`,
      ).toEqual([])
    }
    expect(missing).toEqual([])
  })
