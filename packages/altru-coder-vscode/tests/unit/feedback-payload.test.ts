...
describe("buildFeedbackProperties — non-Altru Coder providers", () => {
...
describe("buildFeedbackProperties — Altru Coder Gateway", () => {
  it("includes sessionID, messageID, parentMessageID", () => {
    const props = buildFeedbackProperties({ ...baseInput, providerID: "altru-coder", next: "up" })
    expect(props).toEqual({
