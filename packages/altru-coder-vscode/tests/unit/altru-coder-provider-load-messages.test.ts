...
function makeProvider(client: ReturnType<typeof createClient>) {
  ...
  const provider = new AltruCoderProvider({} as never, connection as never)
...
describe("AltruCoderProvider.handleLoadMessages / focus mode freshness", () => {
...
describe("AltruCoderProvider.loadMessages / sub-agent viewer full history", () => {
...
describe("AltruCoderProvider.handleLoadMessages / prepend into deleted session", () => {
