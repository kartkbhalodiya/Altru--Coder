...
import { DialogProvider, useDialog } from "@altru-coder/altru-coder-ui/context/dialog"
import { Dialog } from "@altru-coder/altru-coder-ui/dialog"
import { DropdownMenu } from "@altru-coder/altru-coder-ui/dropdown-menu"
import { ContextMenu } from "@altru-coder/altru-coder-ui/context-menu"
...
import { Toast, showToast } from "@altru-coder/altru-coder-ui/toast"
import { ResizeHandle } from "@altru-coder/altru-coder-ui/resize-handle"
...
import { Tooltip, TooltipKeybind } from "@altru-coder/altru-coder-ui/tooltip"
import { Popover } from "@altru-coder/altru-coder-ui/popover"
...
import { AltruCoderEmbeddingModelsProvider } from "../src/context/altru-coder-embedding-models"
  ...
  onMount(() => {
    ...
    const unsub = vscode.onMessage((msg) => {
      ...
      if (msg.type === "agentManager.state") {
        ...
        // When not a git repo, also mark sessions as loaded since the Altru Coder
      ...
      // to send the prompt through the normal AltruCoderProvider sendMessage path.
