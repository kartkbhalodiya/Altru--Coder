...
import { ALTRU_CODER_GATEWAY_ID, providerSortKey } from "../src/components/shared/model-selector-utils"
import {
...
export const MultiModelSelector: Component<{
  ...
  const visibleModels = createMemo(() => {
    const c = connected()
    return models().filter((m) => m.providerID === ALTRU_CODER_GATEWAY_ID || c.includes(m.providerID))
  })
