// AltruCoderClaw lightweight language context
//
// Self-contained i18n for the AltruCoderClaw panel. Does not depend on
...
export function AltruCoderClawLanguageProvider(props: { locale: () => string | undefined; children: JSX.Element }) {
...
export function useAltruCoderClawLanguage(): LanguageCtx {
  const ctx = useContext(LanguageContext)
  if (!ctx) throw new Error("useAltruCoderClawLanguage must be used within AltruCoderClawLanguageProvider")
  return ctx
}
