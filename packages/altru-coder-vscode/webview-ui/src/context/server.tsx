...
export const ServerProvider: ParentComponent = (props) => {
  ...
  onMount(() => {
    const unsubscribe = vscode.onMessage((message: ExtensionMessage) => {
      switch (message.type) {
        case "ready":
          console.log("[Altru Coder New] Server ready:", message.serverInfo)
        ...
        case "connectionState":
          console.log("[Altru Coder New] Connection state changed:", message.state)
        ...
        case "error":
          console.error("[Altru Coder New] Server error:", message.message)
          setErrorMessage(message.message)
          setErrorDetails(message.message)
          break

        case "profileData":
          console.log("[Altru Coder New] Profile data:", message.data ? "received" : "null")
          setProfileData(message.data)
          break

        case "deviceAuthStarted":
          console.log("[Altru Coder New] Device auth started")
          setDeviceAuth({
            status: "pending",
            code: message.code,
        ...
        case "deviceAuthComplete":
          console.log("[Altru Coder New] Device auth complete")
        ...
        case "deviceAuthFailed":
          console.log("[Altru Coder New] Device auth failed:", message.error)
          setDeviceAuth({ status: "error", error: message.error })
          break

        case "deviceAuthCancelled":
          console.log("[Altru Coder New] Device auth cancelled")
    ...
    console.log("[Altru Coder New] Webview ready")
   ...
   * outside the Profile page — e.g. the Altru Coder Gateway card in the Providers
