...
import type { AltruCoderNotification, ExtensionMessage } from "../types/messages"

interface NotificationsContextValue {
  notifications: Accessor<AltruCoderNotification[]>
  filteredNotifications: Accessor<AltruCoderNotification[]>
