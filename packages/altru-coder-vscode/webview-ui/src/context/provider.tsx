...
import type { ProviderAuthMethod } from "@altru-coder/sdk/v2/client"
import { flattenModels, isModelValid as isValid } from "./provider-utils"
import { ALTRU_CODER_AUTO } from "../../../src/shared/provider-model"
...
export const ProviderProvider: ParentComponent = (props) => {
  ...
  const [defaultSelection, setDefaultSelection] = createSignal<ModelSelection>(ALTRU_CODER_AUTO)
  ...
  function findModel(selection: ModelSelection | null): EnrichedModel | undefined {
    ...
    return { ...model, id: selection.modelID, providerID: provider.id, providerName: provider.name }
  }
