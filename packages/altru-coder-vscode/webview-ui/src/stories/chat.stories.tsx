  ...
  [toolAssistantID]: [
    {
      ...
      state: {
        ...
        output: "/Users/marius/Documents/git/altrucoder/.altru-coder/worktrees/zest-kettledrum",
        title: "pwd",
        metadata: {},
...
// ---------------------------------------------------------------------------
// Welcome screen with AccountSwitcher + AltruCoderNotifications
// ---------------------------------------------------------------------------
...
const mockServer = {
  ...
  profileData: () => ({
    profile: {
      email: "dev@altru-coder.dev",
      name: "Dev User",
      organizations: [{ id: "org-1", name: "Altru Coder Org", role: "member" }],
    },
    balance: { balance: 5.0 },
    currentOrgId: "org-1",
  }),
