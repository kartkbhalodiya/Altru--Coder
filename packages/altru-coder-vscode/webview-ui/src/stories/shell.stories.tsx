...
import type { AssistantMessage, ToolPart } from "@altru-coder/sdk/v2"
...
const shellPart: ToolPart = {
  ...
  state: {
    ...
    input: {
      ...
      command: `grep -n "migration\\|openMigration" packages/altru-coder-vscode/webview-ui/src/types/messages.ts`,
    },
