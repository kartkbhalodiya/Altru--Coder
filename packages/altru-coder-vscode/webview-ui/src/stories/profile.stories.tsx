  ...
  render: () => (
    <StoryProviders noPadding>
      <div style={{ width: "420px", height: "500px" }}>
        <ProfileView profileData={loggedInProfile} deviceAuth={idleAuth} onLogin={noop} onDashboard={noop} />
      </div>
    </StoryProviders>
  ),
}
  ...
  render: () => (
    <StoryProviders noPadding>
      <div style={{ width: "420px", height: "400px" }}>
        <ProfileView profileData={personalProfile} deviceAuth={idleAuth} onLogin={noop} onDashboard={noop} />
      </div>
    </StoryProviders>
  ),
}
  ...
  render: () => (
    <StoryProviders noPadding>
      <div style={{ width: "420px", height: "300px" }}>
        <ProfileView profileData={null} deviceAuth={idleAuth} onLogin={noop} onDashboard={noop} />
      </div>
    </StoryProviders>
  ),
}
