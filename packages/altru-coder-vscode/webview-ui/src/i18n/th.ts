export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Altru Coder",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Altru Coder",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Altru Coder ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Altru Coder ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Altru Coder",
  ...
  "sidebar.gettingStarted.line1": "Altru Coder รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Altru Coder",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Altru Coder มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Altru Coder มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Altru Coder เปิดตัว",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้ Altru Coder เวอร์ชันล่าสุด",
  ...
  "settings.indexing.altruCoderModel.title": "พรีเซ็ตโมเดล Altru Coder",
  "settings.indexing.altruCoderModel.description": "เลือกโมเดลการฝังที่ Altru Coder โฮสต์และรองรับ",
  "settings.indexing.altruCoderSignIn.title": "ต้องลงชื่อเข้าใช้ Altru Coder",
  "settings.indexing.altruCoderSignIn.description": "ลงชื่อเข้าใช้ Altru Coder เพื่อใช้การฝังแบบโฮสต์",
  ...
  "settings.providers.betaNotice":
    "ปัจจุบันสามารถตั้งค่าได้เฉพาะผู้ให้บริการ Altru Coder Gateway ในหน้าการตั้งค่าเท่านั้น การรองรับการตั้งค่าผู้ให้บริการรายอื่นจะพร้อมใช้งานในเร็วๆ นี้ในช่วงเบต้า ในระหว่างนี้คุณสามารถตั้งค่าผู้ให้บริการผ่าน CLI หรือไฟล์คอนฟิกได้ เรามุ่งมั่นที่จะรักษาให้ Altru Coder เปิดกว้างและไม่มีการผูกมัด",
  ...
  "settings.config.title": "เปิดไฟล์การตั้งค่า Altru Coder ({{scope}})",
  "settings.config.placeholder":
    "ไฟล์การตั้งค่าจะถูกผสานตามลำดับ ไฟล์ที่ถูกทำเครื่องหมายว่าโหลดแล้วจะมีผลกับการตั้งค่าในปัจจุบัน",
  "settings.config.noWorkspace": "เปิดโฟลเดอร์พื้นที่ทำงานเพื่อแก้ไขไฟล์การตั้งค่า Altru Coder ภายใน",
  "settings.config.openFailed": "ไม่สามารถเปิดไฟล์การตั้งค่า Altru Coder ({{scope}}): {{message}}",
  "settings.config.source.xdg": "การตั้งค่า XDG ทั่วโลก",
  "settings.config.source.homeAltruCoder": "การตั้งค่า .altru-coder ของ Home",
  "settings.config.source.homeAltrucoder": "การตั้งค่า .altrucoder ของ Home",
  "settings.config.source.homeOpencode": "การตั้งค่า .opencode ของ Home",
  "settings.config.source.envFile": "ไฟล์สภาพแวดล้อม ALTRU_CODER_CONFIG",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "การตั้งค่าสภาพแวดล้อมแบบอินไลน์",
  "settings.config.source.projectAltruCoder": "การตั้งค่า .altru-coder ของโปรเจกต์",
  "settings.config.source.projectRoot": "การตั้งค่ารูทของโปรเจกต์",
  "settings.config.source.projectAltrucoder": "การตั้งค่า .altrucoder แบบเก่า",
  ...
  "session.cloud.import.placeholder": "ID เซสชัน, URL หรือคำสั่ง altru-coder import",
  ...
  "deviceAuth.title": "เข้าสู่ระบบ Altru Coder",
  ...
  "profile.action.login": "เข้าสู่ระบบด้วย Altru Coder",
  ...
  "settings.aboutAltruCoder.title": "เกี่ยวกับ Altru Coder",

  "session.messages.empty": "เริ่มการสนทนาโดยพิมพ์ข้อความด้านล่าง",
  "session.messages.welcome": "Altru Coder เป็นผู้ช่วยเขียนโค้ด AI ขอให้สร้างฟีเจอร์ แก้ไขบัก หรืออธิบายโค้ดเบสของคุณ",
  ...
  "settings.aboutAltruCoder.status.connected": "เชื่อมต่อแล้ว",
  "settings.aboutAltruCoder.status.connecting": "กำลังเชื่อมต่อ...",
  "settings.aboutAltruCoder.status.disconnected": "ตัดการเชื่อมต่อ",
  "settings.aboutAltruCoder.status.error": "ข้อผิดพลาด",
  "settings.aboutAltruCoder.cliServer": "เซิร์ฟเวอร์ CLI",
  "settings.aboutAltruCoder.status.label": "สถานะ:",
  "settings.aboutAltruCoder.port.label": "พอร์ต:",
  "settings.aboutAltruCoder.versionInfo": "ข้อมูลเวอร์ชัน",
  "settings.aboutAltruCoder.version.label": "เวอร์ชัน:",
  "settings.aboutAltruCoder.extensionName": "ส่วนขยาย Altru Coder",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "รีเซ็ตการตั้งค่าทั้งหมด",
  "settings.aboutAltruCoder.settingsTransfer.title": "ถ่ายโอนการตั้งค่า",
  "settings.aboutAltruCoder.settingsTransfer.description":
    "ส่งออกหรือนำเข้าการตั้งค่าเพื่อถ่ายโอนระหว่างอินสแตนซ์ VS Code",
  "settings.aboutAltruCoder.exportSettings": "ส่งออก",
  "settings.aboutAltruCoder.importSettings": "นำเข้า",
  "settings.aboutAltruCoder.importSettings.invalidJson": "ไฟล์ JSON ไม่ถูกต้อง กรุณาเลือกไฟล์การตั้งค่าที่ถูกต้อง",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "ไฟล์ไม่มีการตั้งค่า Altru Coder ที่ถูกต้อง",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "เปิดการตั้งค่า Telemetry",
  ...
  "settings.language.description": 'เลือกภาษาสำหรับ UI ของ Altru Coder "อัตโนมัติ" จะใช้ภาษาการแสดงผลของ VS Code',
  ...
  "settings.experimental.remote.description":
    "เปิดใช้งานการควบคุม Remote ของเซสชันผ่าน Altru Coder Cloud ซึ่งจะส่งผลต่อ CLI บนเครื่องนี้ด้วย",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "โหลดคำแนะนำและทักษะจาก CLAUDE.md ในไดเรกทอรีการกำหนดค่า Claude Code ของคุณลงในเซสชัน เปิดใช้งานตัวเลือกนี้หากคุณต้องการให้ Altru Coder ใช้คำแนะนำและทักษะจาก Claude Code ของคุณ จำเป็นต้องรีสตาร์ท",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "ไม่ได้กำหนดค่าเซิร์ฟเวอร์ MCP เพิ่มเซิร์ฟเวอร์ MCP ใน altru-coder.jsonc หรือขอให้เอเจนต์เพิ่มให้คุณ",
  ...
  "settings.display.fontSize.description": "ปรับขนาดฟอนต์ webview UI ของ Altru Coder แยกเป็นอิสระจาก VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "การย้ายข้อมูลจากเวอร์ชันดั้งเดิม",
  "settings.aboutAltruCoder.legacyMigration.description":
    "ย้ายการตั้งค่าจากการติดตั้ง Altru Coder ก่อนหน้านี้ รวมถึงคีย์ API ของผู้ให้บริการและโมเดลเริ่มต้น",

  // Screen 1 — What's New
  "migration.whatsNew.title": "มีอะไรใหม่ใน Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "แกนหลักขนาดเล็กและมีประสิทธิภาพเดียวกันในทุกผลิตภัณฑ์ Altru Coder ประสบการณ์ที่คุ้นเคยไม่ว่าคุณจะเลือกทำงานอย่างไร",
  ...
  "diffViewer.source.session.tooltip":
    "ไฟล์ที่ Altru Coder แก้ไขในช่วงเซสชันปัจจุบัน โดยอิงจากสแน็ปช็อตต่อเทิร์น จะรีเซ็ตเมื่อเริ่มเซสชันใหม่",
