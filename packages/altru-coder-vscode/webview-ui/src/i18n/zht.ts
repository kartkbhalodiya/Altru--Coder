...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Altru Coder 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Altru Coder 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Altru Coder 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Altru Coder 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Altru Coder 伺服器。",
  ...
  "toast.update.description": "Altru Coder 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Altru Coder 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意：Altru Coder 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Altru Coder 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Altru Coder 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Altru Coder 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Altru Coder 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Altru Coder。",
  ...
  "settings.providers.betaNotice":
    "目前在設定介面中僅能配置 Altru Coder Gateway 供應商。在測試期間，即將推出配置其他供應商的支援。在此期間，您可以使用 CLI 或設定檔來配置供應商。我們致力於保持 Altru Coder 開放，絕不綁定。",
  ...
  "settings.config.title": "開啟 {{scope}} Altru Coder 設定檔",
  "settings.config.placeholder": "設定檔會按順序合併；標記為已載入的檔案目前會影響設定。",
  "settings.config.noWorkspace": "開啟工作區資料夾以編輯本地 Altru Coder 設定檔。",
  "settings.config.openFailed": "無法開啟 {{scope}} Altru Coder 設定檔：{{message}}",
  "settings.config.source.xdg": "XDG 全域設定",
  "settings.config.source.homeAltruCoder": "主目錄 .altru-coder 設定",
  "settings.config.source.homeAltrucoder": "主目錄 .altrucoder 設定",
  "settings.config.source.homeOpencode": "主目錄 .opencode 設定",
  "settings.config.source.envFile": "ALTRU_CODER_CONFIG 環境變數檔案",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "內聯環境設定",
  "settings.config.source.projectAltruCoder": "專案 .altru-coder 設定",
  "settings.config.source.projectRoot": "專案根目錄設定",
  "settings.config.source.projectAltrucoder": "舊版 .altrucoder 設定",
  ...
  "session.cloud.import.placeholder": "工作階段 ID、URL 或 altru-coder import 指令",
  ...
  "deviceAuth.title": "登入 Altru Coder",
  ...
  "profile.action.login": "使用 Altru Coder 登入",
  ...
  "settings.aboutAltruCoder.title": "關於 Altru Coder",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "Altru Coder 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutAltruCoder.status.connected": "已連線",
  "settings.aboutAltruCoder.status.connecting": "連線中...",
  "settings.aboutAltruCoder.status.disconnected": "已中斷",
  "settings.aboutAltruCoder.status.error": "錯誤",
  "settings.aboutAltruCoder.cliServer": "CLI 伺服器",
  "settings.aboutAltruCoder.status.label": "狀態：",
  "settings.aboutAltruCoder.port.label": "連接埠：",
  "settings.aboutAltruCoder.versionInfo": "版本資訊",
  "settings.aboutAltruCoder.version.label": "版本：",
  "settings.aboutAltruCoder.extensionName": "Altru Coder 擴充功能",
  "settings.aboutAltruCoder.community": "社群與支援",
  "settings.aboutAltruCoder.feedback.prefix": "如果您有任何問題或回饋，歡迎在以下平台提交 issue",
  "settings.aboutAltruCoder.feedback.or": "或",
  "settings.aboutAltruCoder.support.prefix": "如有帳單或帳戶問題，請聯繫客戶支援",
  "settings.aboutAltruCoder.resetSettings.title": "重置設定",
  "settings.aboutAltruCoder.resetSettings.description":
    "此操作僅將 VS Code 擴充功能專屬設定重置為預設值。與 CLI 共享的設定（例如模式和自動核准規則）儲存在 CLI 設定中，不會被重置。",
  "settings.aboutAltruCoder.resetSettings.button": "重置所有設定",
  "settings.aboutAltruCoder.settingsTransfer.title": "設定轉移",
  "settings.aboutAltruCoder.settingsTransfer.description": "匯出或匯入設定，以便在 VS Code 實例之間轉移。",
  "settings.aboutAltruCoder.exportSettings": "匯出",
  "settings.aboutAltruCoder.importSettings": "匯入",
  "settings.aboutAltruCoder.importSettings.invalidJson": "無效的 JSON 檔案。請選擇有效的設定檔。",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "檔案不包含有效的 Altru Coder 設定。",
  "settings.aboutAltruCoder.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutAltruCoder.importSettings.newerVersion": "此檔案由較新版本的 Altru Coder 匯出。部分設定可能會被忽略。",
  "settings.aboutAltruCoder.importSettings.success": "設定已匯入。請檢視上方的變更，然後點擊儲存。",

  "settings.aboutAltruCoder.telemetry.title": "遙測",
  "settings.aboutAltruCoder.telemetry.description":
    '遙測由 VS Code 內建的遙測設定控制。若要停用，請前往「設定」>「遙測」>「遙測層級」並將其設為 "off"。重新啟動 VS Code 以套用變更。',
  "settings.aboutAltruCoder.telemetry.openSettings": "開啟遙測設定",
  ...
  "settings.language.description": "選擇 Altru Coder 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.experimental.remote.description": "透過 Altru Coder Cloud 啟用工作階段的 Remote 控制。這也會影響此電腦上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 Altru Coder 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未設定 MCP 伺服器。在 altru-coder.jsonc 中新增 MCP 伺服器，或請代理為您新增。",
  ...
  "settings.display.fontSize.description": "獨立於 VS Code 調整 Altru Coder webview UI 的字體大小。",
  ...
  "settings.indexing.altruCoderModel.title": "Altru Coder 模型預設",
  "settings.indexing.altruCoderModel.description": "選擇支援的 Altru Coder 託管嵌入模型。",
  "settings.indexing.altruCoderSignIn.title": "需要登入 Altru Coder",
  "settings.indexing.altruCoderSignIn.description": "登入 Altru Coder 以使用託管嵌入。",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "舊版遷移",
  "settings.aboutAltruCoder.legacyMigration.description":
    "從舊版 Altru Coder 安裝遷移設定，包括供應商 API 金鑰和預設模型。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Altru Coder 新功能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Altru Coder 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
  ...
  "diffViewer.source.session.tooltip": "Altru Coder 在目前工作階段中變更的檔案，依據每輪快照。開始新工作階段時重置。",
