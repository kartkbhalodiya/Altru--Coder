export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Altru Coder.",
  ...
  "dialog.server.description": "تبديل خادم Altru Coder الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Altru Coder ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Altru Coder",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Altru Coder لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Altru Coder نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Altru Coder",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Altru Coder على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Altru Coder.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Altru Coder",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Altru Coder.",
  ...
  "settings.providers.betaNotice":
    "حالياً، يمكن إعداد مزود Altru Coder Gateway فقط في واجهة الإعدادات. سيتوفر دعم إعداد المزودين الآخرين قريباً خلال الفترة التجريبية. في غضون ذلك، يمكنك إعداد المزودين باستخدام CLI أو ملف التكوين. نحن ملتزمون بإبقاء Altru Coder مفتوحاً، دون تقييد.",
  ...
  "settings.config.title": "فتح ملف تكوين Altru Coder {{scope}}",
  "settings.config.placeholder": "يتم دمج ملفات التكوين بالترتيب؛ الملفات المحددة كمحملة تؤثر حاليًا على الإعدادات.",
  "settings.config.noWorkspace": "افتح مجلد مساحة عمل لتحرير ملف تكوين Altru Coder المحلي.",
  "settings.config.openFailed": "فشل فتح ملف تكوين Altru Coder {{scope}}: {{message}}",
  "settings.config.source.xdg": "تكوين XDG العالمي",
  "settings.config.source.homeAltruCoder": "تكوين .altru-coder في Home",
  "settings.config.source.homeAltrucoder": "تكوين .altrucoder في Home",
  "settings.config.source.homeOpencode": "تكوين .opencode في Home",
  "settings.config.source.envFile": "ملف بيئة ALTRU_CODER_CONFIG",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "تكوين البيئة المضمن",
  "settings.config.source.projectAltruCoder": "تكوين .altru-coder للمشروع",
  "settings.config.source.projectRoot": "تكوين جذر المشروع",
  "settings.config.source.projectAltrucoder": "تكوين .altrucoder القديم",
  ...
  "session.cloud.import.placeholder": "معرّف الجلسة أو الرابط أو أمر altru-coder import",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Altru Coder",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Altru Coder",
  ...
  "settings.indexing.altruCoderModel.title": "إعداد مسبق لنموذج Altru Coder",
  "settings.indexing.altruCoderModel.description": "اختر نموذج تضمين مدعومًا ومستضافًا بواسطة Altru Coder.",
  "settings.indexing.altruCoderSignIn.title": "تسجيل الدخول إلى Altru Coder مطلوب",
  "settings.indexing.altruCoderSignIn.description": "سجّل الدخول إلى Altru Coder لاستخدام التضمينات المستضافة.",
  ...
  "settings.aboutAltruCoder.title": "حول Altru Coder",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "Altru Coder هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutAltruCoder.status.connected": "متصل",
  "settings.aboutAltruCoder.status.connecting": "جارٍ الاتصال...",
  "settings.aboutAltruCoder.status.disconnected": "غير متصل",
  "settings.aboutAltruCoder.status.error": "خطأ",
  "settings.aboutAltruCoder.cliServer": "خادم CLI",
  "settings.aboutAltruCoder.status.label": "الحالة:",
  "settings.aboutAltruCoder.port.label": "المنفذ:",
  "settings.aboutAltruCoder.versionInfo": "معلومات الإصدار",
  "settings.aboutAltruCoder.version.label": "الإصدار:",
  "settings.aboutAltruCoder.extensionName": "إضافة Altru Coder",
  "settings.aboutAltruCoder.community": "المجتمع والدعم",
  "settings.aboutAltruCoder.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutAltruCoder.feedback.or": "أو",
  "settings.aboutAltruCoder.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutAltruCoder.resetSettings.title": "إعادة تعيين الإعدادات",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  "settings.aboutAltruCoder.settingsTransfer.title": "نقل الإعدادات",
  "settings.aboutAltruCoder.settingsTransfer.description": "تصدير أو استيراد إعداداتك لنقلها بين نُسخ VS Code.",
  "settings.aboutAltruCoder.exportSettings": "تصدير",
  "settings.aboutAltruCoder.importSettings": "استيراد",
  "settings.aboutAltruCoder.importSettings.invalidJson": "ملف JSON غير صالح. يرجى اختيار ملف إعدادات صالح.",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات Altru Coder صالحة.",
  "settings.aboutAltruCoder.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من Altru Coder. قد يتم تجاهل بعض الإعدادات.",
  "settings.aboutAltruCoder.importSettings.success": "تم استيراد الإعدادات. راجع التغييرات أعلاه، ثم انقر على حفظ.",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "فتح إعدادات Telemetry",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Altru Coder. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر Altru Coder Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم Altru Coder مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "لم يتم تهيئة خوادم MCP. أضف خوادم MCP في altru-coder.jsonc، أو اطلب من الوكيل إضافتها لك.",
  ...
  "settings.display.fontSize.description": "اضبط حجم خط webview UI الخاص بـ Altru Coder بشكل مستقل عن VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutAltruCoder.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Altru Coder، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات Altru Coder. تجربة مألوفة بغض النظر عن طريقة عملك.",
  ...
  "diffViewer.source.session.tooltip":
    "الملفات التي غيّرها Altru Coder خلال الجلسة الحالية، بناءً على لقطات لكل دور. يُعاد ضبطها عند بدء جلسة جديدة.",
