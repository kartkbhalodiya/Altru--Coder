export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Altru Coder.",
  ...
  "dialog.server.description": "Trocar para qual servidor Altru Coder este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Altru Coder ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Altru Coder",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Altru Coder ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Altru Coder",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Altru Coder aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Altru Coder é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Altru Coder iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Altru Coder.",
  ...
  "settings.providers.betaNotice":
    "Atualmente, apenas o provedor Altru Coder Gateway pode ser configurado na interface de configurações. O suporte para a configuração de outros provedores estará disponível em breve durante o período beta. Enquanto isso, você pode configurar provedores usando a CLI ou o arquivo de configuração. Estamos comprometidos em manter o Altru Coder aberto, sem lock-in.",
  ...
  "settings.config.title": "Abrir arquivo de configuração {{scope}} do Altru Coder",
  ...
  "settings.config.noWorkspace":
    "Abra uma pasta de espaço de trabalho para editar o arquivo de configuração local do Altru Coder.",
  "settings.config.openFailed": "Falha ao abrir o arquivo de configuração {{scope}} do Altru Coder: {{message}}",
  "settings.config.source.xdg": "Configuração global do XDG",
  "settings.config.source.homeAltruCoder": "Configuração .altru-coder da Home",
  "settings.config.source.homeAltrucoder": "Configuração .altrucoder da Home",
  "settings.config.source.homeOpencode": "Configuração .opencode da Home",
  "settings.config.source.envFile": "Arquivo de ambiente ALTRU_CODER_CONFIG",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "Configuração de ambiente embutida",
  "settings.config.source.projectAltruCoder": "Configuração .altru-coder do projeto",
  "settings.config.source.projectRoot": "Configuração raiz do projeto",
  "settings.config.source.projectAltrucoder": "Configuração .altrucoder legada",
  ...
  "session.cloud.import.placeholder": "ID da sessão, URL ou comando altru-coder import",
  ...
  "deviceAuth.title": "Entrar no Altru Coder",
  ...
  "profile.action.login": "Entrar com Altru Coder",
  ...
  "settings.aboutAltruCoder.title": "Sobre o Altru Coder",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "Altru Coder é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutAltruCoder.status.error": "Erro",
  "settings.aboutAltruCoder.cliServer": "Servidor CLI",
  "settings.aboutAltruCoder.status.label": "Status:",
  "settings.aboutAltruCoder.port.label": "Porta:",
  "settings.aboutAltruCoder.versionInfo": "Informações da Versão",
  "settings.aboutAltruCoder.version.label": "Versão:",
  "settings.aboutAltruCoder.extensionName": "Extensão Altru Coder",
  "settings.aboutAltruCoder.community": "Comunidade e Suporte",
  "settings.aboutAltruCoder.feedback.prefix": "Se você tiver perguntas ou feedback, abra uma issue no",
  "settings.aboutAltruCoder.feedback.or": "ou",
  "settings.aboutAltruCoder.support.prefix":
    "Para questões de cobrança ou conta, entre em contato com o Suporte ao Cliente em",
  "settings.aboutAltruCoder.resetSettings.title": "Redefinir Configurações",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Redefinir Todas as Configurações",
  "settings.aboutAltruCoder.settingsTransfer.title": "Transferência de configurações",
  ...
  "settings.aboutAltruCoder.importSettings.invalidConfig": "O arquivo não contém configurações válidas do Altru Coder.",
  ...
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Este arquivo foi exportado de uma versão mais recente do Altru Coder. Algumas configurações podem ser ignoradas.",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Abrir Configurações de Telemetria",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do Altru Coder. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.experimental.remote.description":
    "Habilite o controle Remote de sessões via Altru Coder Cloud. Isso também afetará as CLIs nesta máquina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carrega as instruções e skills do CLAUDE.md a partir do seu diretório de configuração do Claude Code para as sessões. Ative esta opção se deseja que o Altru Coder utilize suas instruções e skills do Claude Code. Requer reinicialização.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nenhum servidor MCP configurado. Adicione servidores MCP em altru-coder.jsonc ou peça ao agente para adicioná-los.",
  ...
  "settings.display.fontSize.description":
    "Ajuste o tamanho da fonte da webview UI do Altru Coder independentemente do VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Migração Legada",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do Altru Coder, incluindo chaves de API de provedor e modelo padrão.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Um núcleo pequeno e eficiente em todos os produtos Altru Coder. Uma experiência familiar independentemente de como você escolha trabalhar.",
  ...
  "diffViewer.source.session.tooltip":
    "Arquivos modificados pelo Altru Coder durante a sessão atual, com base em snapshots por turno. Reinicia ao começar uma nova sessão.",
