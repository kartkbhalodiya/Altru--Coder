export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Altru Coder-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Altru Coder-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Altru Coder-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Altru Coder server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Altru Coder-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Altru Coder timu",
  ...
  "sidebar.gettingStarted.line1": "Altru Coder uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Altru Coder-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Altru Coder izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Altru Coder-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Altru Coder pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Altru Coder-a.",
  ...
  "settings.indexing.altruCoderModel.title": "Preset Altru Coder modela",
  "settings.indexing.altruCoderModel.description": "Odaberite podržani model embeddinga hostovan na Altru Coder.",
  "settings.indexing.altruCoderSignIn.title": "Potrebna je prijava na Altru Coder",
  "settings.indexing.altruCoderSignIn.description": "Prijavite se na Altru Coder za korištenje hostovanih embeddinga.",
  ...
  "settings.providers.betaNotice":
    "Trenutno se samo Altru Coder Gateway provajder može konfigurisati u interfejsu za postavke. Podrška za konfigurisanje drugih provajdera stiže uskoro tokom beta perioda. U međuvremenu, provajdere možete konfigurisati koristeći CLI ili konfiguracijsku datoteku. Posvećeni smo tome da Altru Coder ostane otvoren, bez vezivanja.",
  ...
  "settings.config.source.homeAltrucoder": "Home .altrucoder konfiguracija",
  "settings.config.source.homeOpencode": "Home .opencode konfiguracija",
  "settings.config.source.envFile": "ALTRU_CODER_CONFIG datoteka okruženja",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "Ugrađena konfiguracija okruženja",
  "settings.config.source.projectAltruCoder": "Projektna .altru-coder konfiguracija",
  "settings.config.source.projectRoot": "Konfiguracija korijena projekta",
  "settings.config.source.projectAltrucoder": "Zastarjela .altrucoder konfiguracija",
  ...
  "session.cloud.import.placeholder": "ID sesije, URL ili altru-coder import naredba",
  ...
  "deviceAuth.title": "Prijavite se u Altru Coder",
  ...
  "profile.action.login": "Prijavite se putem Altru Coder",
  ...
  "settings.aboutAltruCoder.title": "O Altru Coder-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "Altru Coder je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutAltruCoder.status.connected": "Povezano",
  "settings.aboutAltruCoder.status.connecting": "Povezivanje...",
  "settings.aboutAltruCoder.status.disconnected": "Odspojeno",
  "settings.aboutAltruCoder.status.error": "Greška",
  ...
  "settings.aboutAltruCoder.versionInfo": "Informacije o verziji",
  "settings.aboutAltruCoder.version.label": "Verzija:",
  "settings.aboutAltruCoder.extensionName": "Altru Coder ekstenzija",
  "settings.aboutAltruCoder.community": "Zajednica i podrška",
  "settings.aboutAltruCoder.feedback.prefix": "Ako imate pitanja ili povratne informacije, slobodno otvorite issue na",
  "settings.aboutAltruCoder.feedback.or": "ili",
  "settings.aboutAltruCoder.support.prefix": "Za pitanja o naplati ili računu, kontaktirajte korisničku podršku na",
  "settings.aboutAltruCoder.resetSettings.title": "Resetovanje postavki",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Resetuj sve postavke",
  "settings.aboutAltruCoder.settingsTransfer.title": "Prijenos postavki",
  "settings.aboutAltruCoder.settingsTransfer.description":
    "Izvezite ili uvezite postavke za prijenos između VS Code instanci.",
  "settings.aboutAltruCoder.exportSettings": "Izvezi",
  ...
  "settings.aboutAltruCoder.telemetry.title": "Telemetrija",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Otvori postavke telemetrije",
  ...
  "settings.language.description": 'Odaberite jezik za Altru Coder sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.experimental.remote.description":
    "Omogućite Remote kontrolu sesija putem Altru Coder Cloud. Ovo će također utjecati na CLI-jeve na ovoj mašini.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Učitajte CLAUDE.md instrukcije i vještine iz vašeg Claude Code konfiguracijskog direktorija u sesije. Omogućite ovo ako želite da Altru Coder koristi vaše Claude Code instrukcije i vještine. Zahtijeva ponovno pokretanje.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nema konfiguriranih MCP servera. Dodajte MCP servere u altru-coder.jsonc ili zamolite agenta da ih doda.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Migracija sa prethodne verzije",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije Altru Coder, uključujući API ključeve provajdera i podrazumijevani model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno malo, efikasno jezgro kroz sve Altru Coder proizvode. Poznato iskustvo bez obzira na to kako odaberete raditi.",
  ...
  "diffViewer.source.session.tooltip":
    "Datoteke koje je Altru Coder promijenio tokom trenutne sesije, na osnovu snapshota po koraku. Resetuje se kada pokrenete novu sesiju.",
