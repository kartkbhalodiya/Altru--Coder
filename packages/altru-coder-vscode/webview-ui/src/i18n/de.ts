...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Altru Coder zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Altru Coder zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Altru Coder zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Altru Coder-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Altru Coder ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Altru Coder-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Altru Coder unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Altru Coder ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Altru Coder auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Altru Coder anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Altru Coder automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Altru Coder.",
  ...
  "settings.config.title": "{{scope}} Altru Coder-Konfigurationsdatei öffnen",
  ...
  "settings.config.noWorkspace":
    "Öffnen Sie einen Arbeitsbereichsordner, um die lokale Altru Coder-Konfigurationsdatei zu bearbeiten.",
  "settings.config.openFailed": "Fehler beim Öffnen der {{scope}} Altru Coder-Konfigurationsdatei: {{message}}",
  ...
  "settings.config.source.envFile": "ALTRU_CODER_CONFIG Umgebungsdatei",
  ...
  "settings.config.source.projectAltrucoder": "Veraltete .altrucoder-Konfiguration",
  ...
  "session.cloud.import.placeholder": "Sitzungs-ID, URL oder altru-coder import-Befehl",
  ...
  "deviceAuth.title": "Bei Altru Coder anmelden",
  ...
  "profile.action.login": "Mit Altru Coder anmelden",
  ...
  "settings.aboutAltruCoder.title": "Über Altru Coder",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "Altru Coder ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutAltruCoder.status.connected": "Verbunden",
  "settings.aboutAltruCoder.status.connecting": "Verbindung wird hergestellt...",
  "settings.aboutAltruCoder.status.disconnected": "Getrennt",
  "settings.aboutAltruCoder.status.error": "Fehler",
  ...
  "settings.aboutAltruCoder.versionInfo": "Versionsinformationen",
  "settings.aboutAltruCoder.version.label": "Version:",
  "settings.aboutAltruCoder.extensionName": "Altru Coder Erweiterung",
  "settings.aboutAltruCoder.community": "Community & Support",
  "settings.aboutAltruCoder.feedback.prefix": "Bei Fragen oder Feedback können Sie ein Issue eröffnen auf",
  "settings.aboutAltruCoder.feedback.or": "oder",
  "settings.aboutAltruCoder.support.prefix":
    "Bei Abrechnungs- oder Kontofragen wenden Sie sich an den Kundensupport unter",
  "settings.aboutAltruCoder.resetSettings.title": "Einstellungen zurücksetzen",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Alle Einstellungen zurücksetzen",
  "settings.aboutAltruCoder.settingsTransfer.title": "Einstellungen übertragen",
  ...
  "settings.aboutAltruCoder.exportSettings": "Exportieren",
  ...
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von Altru Coder exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Telemetrie-Einstellungen öffnen",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die Altru Coder Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über Altru Coder Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn Altru Coder Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Keine MCP-Server konfiguriert. Fügen Sie MCP-Server in altru-coder.jsonc hinzu oder bitten Sie den Agenten, sie hinzuzufügen.",
  ...
  "settings.aboutAltruCoder.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von Altru Coder, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle Altru Coder-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
  ...
  "diffViewer.source.session.tooltip":
    "Von Altru Coder während der aktuellen Sitzung geänderte Dateien, basierend auf Snapshots pro Runde. Wird beim Start einer neuen Sitzung zurückgesetzt.",
