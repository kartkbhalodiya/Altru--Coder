...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Altru Coder.",
  ...
  "dialog.server.description": "Bytt hvilken Altru Coder server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Altru Coder ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Altru Coder teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Altru Coder ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Altru Coder",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Altru Coder ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Altru Coder er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Altru Coder starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Altru Coder.",
  ...
  "settings.providers.betaNotice":
    "For øyeblikket kan kun Altru Coder Gateway-leverandøren konfigureres i innstillingsgrensesnittet. Støtte for konfigurering av andre leverandører kommer snart i løpet av betaperioden. I mellomtiden kan du konfigurere leverandører via CLI eller konfigurasjonsfilen. Vi er forpliktet til å holde Altru Coder åpent, ingen lock-in.",
  ...
  "settings.config.source.homeAltrucoder": "Home .altrucoder-konfigurasjon",
  "settings.config.source.homeOpencode": "Home .opencode-konfigurasjon",
  "settings.config.source.envFile": "ALTRU_CODER_CONFIG miljøfil",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "Innebygd miljøkonfigurasjon",
  "settings.config.source.projectAltruCoder": "Prosjekt .altru-coder-konfigurasjon",
  "settings.config.source.projectRoot": "Prosjektets rotkonfigurasjon",
  "settings.config.source.projectAltrucoder": "Eldre .altrucoder-konfigurasjon",
  ...
  "session.cloud.import.placeholder": "Økt-ID, URL eller altru-coder import-kommando",
  ...
  "deviceAuth.title": "Logg inn på Altru Coder",
  ...
  "profile.action.login": "Logg inn med Altru Coder",
  ...
  "settings.aboutAltruCoder.title": "Om Altru Coder",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "Altru Coder er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutAltruCoder.status.connected": "Tilkoblet",
  "settings.aboutAltruCoder.status.connecting": "Kobler til...",
  "settings.aboutAltruCoder.status.disconnected": "Frakoblet",
  "settings.aboutAltruCoder.status.error": "Feil",
  ...
  "settings.aboutAltruCoder.versionInfo": "Versjonsinformasjon",
  "settings.aboutAltruCoder.version.label": "Versjon:",
  "settings.aboutAltruCoder.extensionName": "Altru Coder-utvidelse",
  "settings.aboutAltruCoder.community": "Fellesskap og støtte",
  "settings.aboutAltruCoder.feedback.prefix": "Hvis du har spørsmål eller tilbakemeldinger, åpne gjerne en issue på",
  "settings.aboutAltruCoder.feedback.or": "eller",
  "settings.aboutAltruCoder.support.prefix": "For fakturerings- eller kontospørsmål, kontakt kundestøtte på",
  "settings.aboutAltruCoder.resetSettings.title": "Tilbakestill innstillinger",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Tilbakestill alle innstillinger",
  "settings.aboutAltruCoder.settingsTransfer.title": "Overføring av innstillinger",
  ...
  "settings.aboutAltruCoder.exportSettings": "Eksporter",
  "settings.aboutAltruCoder.importSettings": "Importer",
  "settings.aboutAltruCoder.importSettings.invalidJson": "Ugyldig JSON-fil. Vennligst velg en gyldig innstillingsfil.",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "Filen inneholder ikke gyldige Altru Coder-innstillinger.",
  "settings.aboutAltruCoder.importSettings.tooLarge": "Filen er for stor. Innstillingsfiler må være under 1 MB.",
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Denne filen ble eksportert fra en nyere versjon av Altru Coder. Noen innstillinger kan bli ignorert.",
  ...
  "settings.aboutAltruCoder.telemetry.title": "Telemetri",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Åpne innstillinger for telemetri",
  ...
  "settings.language.description": 'Velg språket for Altru Coder-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.experimental.remote.description":
    "Aktiver Remote-kontroll av økter via Altru Coder Cloud. Dette vil også påvirke CLI-er på denne maskinen.",
  ...
  "settings.indexing.altruCoderModel.title": "Altru Coder-modellforhåndsvalg",
  "settings.indexing.altruCoderModel.description": "Velg en støttet Altru Coder-hostet embedding-modell.",
  "settings.indexing.altruCoderSignIn.title": "Altru Coder-pålogging kreves",
  "settings.indexing.altruCoderSignIn.description": "Logg inn på Altru Coder for å bruke hostede embeddings.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Last inn CLAUDE.md-instruksjoner og ferdigheter fra Claude Code-konfigurasjonsmappen din i økter. Aktiver dette hvis du vil at Altru Coder skal bruke dine Claude Code-instruksjoner og ferdigheter. Krever omstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigurert. Legg til MCP-servere i altru-coder.jsonc, eller be agenten om å legge dem til.",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Altru Coder webview UI uavhengig av VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Migrering fra eldre versjon",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av Altru Coder, inkludert API-nøkler for leverandører og standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én liten, effektiv kjerne på tvers av alle Altru Coder-produkter. En kjent opplevelse uansett hvordan du velger å jobbe.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer endret av Altru Coder i løpet av gjeldende økt, basert på øyeblikksbilder per tur. Tilbakestilles når du starter en ny økt.",
