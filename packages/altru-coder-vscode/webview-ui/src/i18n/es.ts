export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Altru Coder.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Altru Coder se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Altru Coder ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Altru Coder",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Altru Coder no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Altru Coder",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Altru Coder en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Altru Coder.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Altru Coder",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Altru Coder.",
  ...
  "settings.indexing.altruCoderModel.title": "Preajuste de modelo de Altru Coder",
  "settings.indexing.altruCoderModel.description": "Elige un modelo de embeddings alojado por Altru Coder compatible.",
  "settings.indexing.altruCoderSignIn.title": "Se requiere iniciar sesión en Altru Coder",
  "settings.indexing.altruCoderSignIn.description": "Inicia sesión en Altru Coder para usar embeddings alojados.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor Altru Coder Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener Altru Coder abierto, sin ataduras.",
  ...
  "settings.config.title": "Abrir archivo de configuración Altru Coder {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Abre una carpeta de espacio de trabajo para editar el archivo de configuración Altru Coder local.",
  "settings.config.openFailed": "Error al abrir el archivo de configuración Altru Coder {{scope}}: {{message}}",
  "settings.config.source.xdg": "Configuración global XDG",
  "settings.config.source.homeAltruCoder": "Configuración .altru-coder de Home",
  "settings.config.source.homeAltrucoder": "Configuración .altrucoder de Home",
  "settings.config.source.homeOpencode": "Configuración .opencode de Home",
  "settings.config.source.envFile": "Archivo de entorno ALTRU_CODER_CONFIG",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "Configuración de entorno en línea",
  "settings.config.source.projectAltruCoder": "Configuración .altru-coder del proyecto",
  "settings.config.source.projectRoot": "Configuración raíz del proyecto",
  "settings.config.source.projectAltrucoder": "Configuración heredada .altrucoder",
  ...
  "session.cloud.import.placeholder": "ID de sesión, URL o comando altru-coder import",
  ...
  "deviceAuth.title": "Iniciar sesión en Altru Coder",
  ...
  "profile.action.login": "Iniciar sesión con Altru Coder",
  ...
  "settings.aboutAltruCoder.title": "Acerca de Altru Coder",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "Altru Coder es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutAltruCoder.status.connected": "Conectado",
  "settings.aboutAltruCoder.status.connecting": "Conectando...",
  "settings.aboutAltruCoder.status.disconnected": "Desconectado",
  "settings.aboutAltruCoder.status.error": "Error",
  "settings.aboutAltruCoder.cliServer": "Servidor CLI",
  "settings.aboutAltruCoder.status.label": "Estado:",
  "settings.aboutAltruCoder.port.label": "Puerto:",
  "settings.aboutAltruCoder.versionInfo": "Información de versión",
  "settings.aboutAltruCoder.version.label": "Versión:",
  "settings.aboutAltruCoder.extensionName": "Extensión Altru Coder",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Restablecer toda la configuración",
  "settings.aboutAltruCoder.settingsTransfer.title": "Transferencia de ajustes",
  ...
  "settings.aboutAltruCoder.exportSettings": "Exportar",
  "settings.aboutAltruCoder.importSettings": "Importar",
  "settings.aboutAltruCoder.importSettings.invalidJson":
    "Archivo JSON no válido. Seleccione un archivo de ajustes válido.",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de Altru Coder.",
  ...
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de Altru Coder. Algunos ajustes podrían ignorarse.",
  ...
  "settings.aboutAltruCoder.telemetry.title": "Telemetría",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Abrir configuración de telemetría",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Altru Coder. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de Altru Coder Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que Altru Coder utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No hay servidores MCP configurados. Añada servidores MCP en altru-coder.jsonc o pida al agente que los añada.",
  ...
  "settings.display.fontSize.description":
    "Ajusta el tamaño de fuente de la webview UI de Altru Coder de forma independiente a VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Migración heredada",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Altru Coder, incluyendo las claves API de proveedores y el modelo predeterminado.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos Altru Coder. Una experiencia familiar sin importar cómo elijas trabajar.",
  ...
  "diffViewer.source.session.tooltip":
    "Archivos modificados por Altru Coder durante la sesión actual, basado en snapshots por turno. Se reinicia al empezar una nueva sesión.",
