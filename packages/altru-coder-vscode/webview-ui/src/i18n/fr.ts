export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Altru Coder.",
  ...
  "dialog.server.description": "Changez le serveur Altru Coder auquel cette application se connecte.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Altru Coder",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Altru Coder ne supporte pas encore l'authentification MCP.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Altru Coder",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Altru Coder sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Altru Coder.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Altru Coder",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Altru Coder.",
  ...
  "settings.providers.betaNotice":
    "Actuellement, seul le fournisseur Altru Coder Gateway peut être configuré dans l'interface des paramètres. La prise en charge de la configuration d'autres fournisseurs sera bientôt disponible pendant la période bêta. En attendant, vous pouvez configurer les fournisseurs à l'aide de la CLI ou du fichier de configuration. Nous nous engageons à maintenir Altru Coder ouvert, sans enfermement propriétaire.",
  ...
  "settings.config.title": "Ouvrir le fichier de configuration Altru Coder {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Ouvrez un dossier d'espace de travail pour modifier le fichier de configuration Altru Coder local.",
  "settings.config.openFailed": "Échec de l'ouverture du fichier de configuration Altru Coder {{scope}} : {{message}}",
  "settings.config.source.xdg": "Configuration globale XDG",
  "settings.config.source.homeAltruCoder": "Configuration .altru-coder de Home",
  "settings.config.source.homeAltrucoder": "Configuration .altrucoder de Home",
  "settings.config.source.homeOpencode": "Configuration .opencode de Home",
  "settings.config.source.envFile": "Fichier d'environnement ALTRU_CODER_CONFIG",
  ...
  "settings.config.source.projectAltruCoder": "Configuration .altru-coder du projet",
  "settings.config.source.projectRoot": "Configuration racine du projet",
  "settings.config.source.projectAltrucoder": "Configuration obsolète .altrucoder",
  ...
  "session.cloud.import.placeholder": "ID de session, URL ou commande altru-coder import",
  ...
  "deviceAuth.title": "Se connecter à Altru Coder",
  ...
  "profile.action.login": "Se connecter avec Altru Coder",
  ...
  "settings.aboutAltruCoder.title": "À propos de Altru Coder",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "Altru Coder est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutAltruCoder.status.connected": "Connecté",
  "settings.aboutAltruCoder.status.connecting": "Connexion en cours...",
  "settings.aboutAltruCoder.status.disconnected": "Déconnecté",
  "settings.aboutAltruCoder.status.error": "Erreur",
  "settings.aboutAltruCoder.cliServer": "Serveur CLI",
  "settings.aboutAltruCoder.status.label": "Statut :",
  "settings.aboutAltruCoder.port.label": "Port :",
  "settings.aboutAltruCoder.versionInfo": "Informations de version",
  "settings.aboutAltruCoder.version.label": "Version :",
  "settings.aboutAltruCoder.extensionName": "Extension Altru Coder",
  "settings.aboutAltruCoder.community": "Communauté et support",
  ...
  "settings.aboutAltruCoder.resetSettings.title": "Réinitialiser les paramètres",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Réinitialiser tous les paramètres",
  "settings.aboutAltruCoder.settingsTransfer.title": "Transfert des paramètres",
  ...
  "settings.aboutAltruCoder.exportSettings": "Exporter",
  ...
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Ce fichier a été exporté depuis une version plus récente de Altru Coder. Certains paramètres pourraient être ignorés.",
  ...
  "settings.aboutAltruCoder.telemetry.title": "Télémétrie",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Ouvrir les paramètres de télémétrie",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Altru Coder. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via Altru Coder Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Charge les instructions et les compétences de CLAUDE.md depuis votre répertoire de configuration Claude Code dans les sessions. Activez cette option si vous souhaitez que Altru Coder utilise vos instructions et compétences Claude Code. Nécessite un redémarrage.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Aucun serveur MCP configuré. Ajoutez des serveurs MCP dans altru-coder.jsonc ou demandez à l'agent de les ajouter.",
  ...
  "settings.display.fontSize.description":
    "Ajustez la taille de la police de la webview UI de Altru Coder indépendamment de VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Altru Coder, y compris les clés d'API des fournisseurs et le modèle par défaut.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un noyau petit et efficace partagé par tous les produits Altru Coder. Une expérience familière quelle que soit votre façon de travailler.",
  ...
  "diffViewer.source.session.tooltip":
    "Fichiers modifiés par Altru Coder pendant la session actuelle, basé sur des snapshots par tour. Réinitialisé lors du démarrage d'une nouvelle session.",
