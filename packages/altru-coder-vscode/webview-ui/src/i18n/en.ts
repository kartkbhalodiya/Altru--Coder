export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Altru Coder.",
  ...
  "dialog.server.description": "Switch which Altru Coder server this app connects to.",
  ...
  "toast.update.description": "A new version of Altru Coder ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Altru Coder team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Altru Coder does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.project.recentSessions": "Recent sessions",
  "sidebar.project.viewAllSessions": "View all sessions",

  "app.name.desktop": "Altru Coder Desktop",
  ...
  "settings.general.row.language.description": "Change the display language for Altru Coder",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Altru Coder looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Altru Coder is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Altru Coder launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Altru Coder.",
  ...
  "settings.providers.betaNotice":
    "Currently only the Altru Coder Gateway provider can be configured in the settings interface. Support for configuring other providers is coming soon during the beta period. In the interim you can configure providers using the CLI or config file. We're committed to keeping Altru Coder open, no lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Altru Coder config file",
  "settings.config.placeholder": "Config files are merged in order; files marked loaded currently affect settings.",
  "settings.config.noWorkspace": "Open a workspace folder to edit the local Altru Coder config file.",
  "settings.config.openFailed": "Failed to open {{scope}} Altru Coder config file: {{message}}",
  "settings.config.source.xdg": "XDG global config",
  "settings.config.source.homeAltruCoder": "Home .altru-coder config",
  "settings.config.source.homeAltrucoder": "Home .altrucoder config",
  "settings.config.source.homeOpencode": "Home .opencode config",
  "settings.config.source.envFile": "ALTRU_CODER_CONFIG environment file",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "Inline environment config",
  "settings.config.source.projectAltruCoder": "Project .altru-coder config",
  "settings.config.source.projectRoot": "Project root config",
  "settings.config.source.projectAltrucoder": "Legacy .altrucoder config",
  ...
  "settings.models.addModel.description":
    "Connect an OpenAI-compatible provider or enter model IDs manually. Saved models appear in the chat model picker.",
  ...
  "deviceAuth.title": "Sign in to Altru Coder",
  ...
  "profile.action.login": "Login with Altru Coder",
  ...
  "settings.indexing.altruCoderModel.title": "Altru Coder model preset",
  "settings.indexing.altruCoderModel.description": "Choose a supported Altru Coder-hosted embedding model.",
  "settings.indexing.altruCoderSignIn.title": "Altru Coder sign-in required",
  "settings.indexing.altruCoderSignIn.description": "Sign in to Altru Coder to use hosted embeddings.",
  ...
  "settings.aboutAltruCoder.title": "About Altru Coder",
  ...
  "settings.aboutAltruCoder.status.connected": "Connected",
  "settings.aboutAltruCoder.status.connecting": "Connecting...",
  "settings.aboutAltruCoder.status.disconnected": "Disconnected",
  "settings.aboutAltruCoder.status.error": "Error",
  "settings.aboutAltruCoder.cliServer": "CLI Server",
  "settings.aboutAltruCoder.status.label": "Status:",
  "settings.aboutAltruCoder.port.label": "Port:",
  "settings.aboutAltruCoder.versionInfo": "Version Information",
  "settings.aboutAltruCoder.version.label": "Version:",
  "settings.aboutAltruCoder.extensionName": "Altru Coder Extension",
  "settings.aboutAltruCoder.community": "Community & Support",
  "settings.aboutAltruCoder.feedback.prefix": "If you have any questions or feedback, feel free to open an issue on",
  "settings.aboutAltruCoder.feedback.or": "or",
  "settings.aboutAltruCoder.support.prefix": "For billing or account questions, contact Customer Support at",
  "settings.aboutAltruCoder.resetSettings.title": "Reset Settings",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Reset All Settings",
  "settings.aboutAltruCoder.settingsTransfer.title": "Settings Transfer",
  "settings.aboutAltruCoder.settingsTransfer.description":
    "Export or import your settings to transfer them between VS Code instances.",
  "settings.aboutAltruCoder.exportSettings": "Export",
  "settings.aboutAltruCoder.importSettings": "Import",
  "settings.aboutAltruCoder.importSettings.invalidJson": "Invalid JSON file. Please select a valid settings file.",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "File does not contain valid Altru Coder settings.",
  "settings.aboutAltruCoder.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "This file was exported from a newer version of Altru Coder. Some settings may be ignored.",
  "settings.aboutAltruCoder.importSettings.success": "Settings imported. Review the changes above, then click Save.",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Open Telemetry Settings",
  ...
  "settings.language.description":
    'Choose the language for the Altru Coder UI. "Auto" uses your VS Code display language.',
  ...
  "settings.experimental.remote.description":
    "Enable remote control of sessions via Altru Coder Cloud. This will also affect CLIs on this machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Load CLAUDE.md instructions and skills from your Claude Code configuration directory into sessions. Enable this if you want Altru Coder to use your Claude Code instructions and skills. Requires restart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No MCP servers configured. Add MCP servers in altru-coder.jsonc, or ask the agent to add them for you.",
  ...
  "settings.display.fontSize.description": "Adjust the Altru Coder webview UI font size independently from VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Legacy Migration",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Migrate settings from a previous installation of Altru Coder, including provider API keys and default model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "One small, efficient core across every Altru Coder product. A familiar experience however you choose to work.",
  ...
  "diffViewer.source.workspace.tooltip":
    "Current working-tree changes only: staged, unstaged, and untracked files relative to HEAD.",
  "diffViewer.source.session.label": "Session",
  "diffViewer.source.session.tooltip":
    "Files changed by Altru Coder during the current session, based on per-turn snapshots. Resets when you start a new session.",
