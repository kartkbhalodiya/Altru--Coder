export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Введіть свій API-ключ {{provider}}, щоб підключити акаунт {{provider}} і використовувати моделі {{provider}} в Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " щоб отримати код авторизації для підключення акаунта та використання моделей {{provider}} у Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " та введіть код нижче, щоб підключити акаунт і використовувати моделі {{provider}} у Altru Coder.",
  ...
  "dialog.server.description": "Змінити, до якого сервера Altru Coder підключається цей додаток.",
  ...
  "toast.update.description": "Нова версія Altru Coder ({{version}}) готова до встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Altru Coder",
  ...
  "sidebar.gettingStarted.line1": "Altru Coder включає безкоштовні моделі, тому ви можете почати відразу.",
  ...
  "settings.general.row.language.description": "Змінити мову відображення Altru Coder",
  "settings.general.row.appearance.title": "Вигляд",
  "settings.general.row.appearance.description": "Налаштувати вигляд Altru Coder на вашому пристрої",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштувати тему Altru Coder.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти оновлення при запуску Altru Coder",
  ...
  "settings.updates.toast.latest.description": "У вас встановлена остання версія Altru Coder.",
  ...
  "settings.providers.betaNotice":
    "Наразі в інтерфейсі налаштувань можна налаштувати лише провайдера Altru Coder Gateway. Підтримка інших провайдерів з'явиться в бета-версії найближчим часом. Тим часом ви можете налаштовувати провайдерів через CLI або файл конфігурації. Altru Coder залишається відкритим — без прив'язки.",
  ...
  "settings.config.source.homeAltrucoder": "Конфігурація .altrucoder (Home)",
  "settings.config.source.homeOpencode": "Конфігурація .opencode (Home)",
  "settings.config.source.envFile": "Файл середовища ALTRU_CODER_CONFIG",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "Вбудована конфігурація середовища",
  "settings.config.source.projectAltruCoder": "Конфігурація .altru-coder проєкту",
  "settings.config.source.projectRoot": "Коренева конфігурація проєкту",
  "settings.config.source.projectAltrucoder": "Застаріла конфігурація .altrucoder",
  ...
  "session.cloud.import.placeholder": "Ідентифікатор сесії, URL або команда altru-coder import",
  ...
  "deviceAuth.title": "Увійти до Altru Coder",
  ...
  "profile.action.login": "Увійти через Altru Coder",
  ...
  "settings.aboutAltruCoder.title": "Про Altru Coder",

  "session.messages.empty": "Напишіть повідомлення нижче, щоб розпочати чат.",
  "session.messages.welcome":
    "Altru Coder — це асистент з кодування на базі ШІ. Попросіть його розробити функцію, виправити помилку або пояснити вашу кодову базу.",
  ...
  "settings.aboutAltruCoder.status.connected": "Підключено",
  "settings.aboutAltruCoder.status.connecting": "Підключення...",
  "settings.aboutAltruCoder.status.disconnected": "Відключено",
  "settings.aboutAltruCoder.status.error": "Помилка",
  ...
  "settings.aboutAltruCoder.versionInfo": "Інформація про версію",
  "settings.aboutAltruCoder.version.label": "Версія:",
  "settings.aboutAltruCoder.extensionName": "Розширення Altru Coder",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Скинути всі налаштування",
  "settings.aboutAltruCoder.settingsTransfer.title": "Перенесення налаштувань",
  ...
  "settings.aboutAltruCoder.exportSettings": "Експортувати",
  "settings.aboutAltruCoder.importSettings": "Імпортувати",
  "settings.aboutAltruCoder.importSettings.invalidJson":
    "Недійсний файл JSON. Будь ласка, виберіть дійсний файл налаштувань.",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "Файл не містить дійсних налаштувань Altru Coder.",
  "settings.aboutAltruCoder.importSettings.tooLarge": "Файл занадто великий. Файли налаштувань мають бути менше 1 МБ.",
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Цей файл було експортовано з новішої версії Altru Coder. Деякі налаштування можуть бути проігноровані.",
  "settings.aboutAltruCoder.importSettings.success":
    "Налаштування імпортовано. Перегляньте зміни вище, потім натисніть Зберегти.",

  "settings.aboutAltruCoder.telemetry.title": "Телеметрія",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Відкрити налаштування телеметрії",
  ...
  "settings.language.description":
    '"Автоматично" використовує мову відображення VS Code. Виберіть мову для інтерфейсу Altru Coder.',
  ...
  "settings.experimental.remote.description":
    "Увімкніть керування Remote сеансами через Altru Coder Cloud. Це також вплине на CLI на цьому комп'ютері.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Завантажувати інструкції та навички CLAUDE.md з вашого каталогу конфігурації Claude Code у сесії. Увімкніть це, якщо ви хочете, щоб Altru Coder використовував ваші інструкції та навички Claude Code. Потребує перезапуску.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверів не налаштовано. Додайте MCP-сервери до altru-coder.jsonc або попросіть агента додати їх.",
  ...
  "settings.display.fontSize.description": "Налаштуйте розмір шрифту webview UI для Altru Coder незалежно від VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Перенесення зі старої версії",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Перенести налаштування з попередньої версії Altru Coder, включаючи API-ключі провайдерів та стандартну модель.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Що нового в Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Малий та ефективний ядерний модуль у кожному продукті Altru Coder. Знайомий досвід незалежно від того, як ви вважаєте за краще працювати.",
  ...
  "settings.indexing.altruCoderModel.title": "Пресет моделі Altru Coder",
  "settings.indexing.altruCoderModel.description": "Виберіть підтримувану модель Altru Coder-hosted embeddings.",
  "settings.indexing.altruCoderSignIn.title": "Потрібен вхід у Altru Coder",
  "settings.indexing.altruCoderSignIn.description": "Увійдіть у Altru Coder, щоб використовувати hosted embeddings.",
  ...
  "diffViewer.source.session.tooltip":
    "Файли, змінені Altru Coder під час поточної сесії, на основі знімків по ходу. Скидається при старті нової сесії.",
