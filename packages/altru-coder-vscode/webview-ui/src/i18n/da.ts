export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Altru Coder.",
  ...
  "dialog.server.description": "Skift hvilken Altru Coder server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Altru Coder ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Altru Coder teamet",
  ...
  "sidebar.gettingStarted.line1": "Altru Coder inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Altru Coder",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Altru Coder ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Altru Coder er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Altru Coder starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Altru Coder.",
  ...
  "settings.indexing.altruCoderModel.title": "Altru Coder-modelpreset",
  "settings.indexing.altruCoderModel.description": "Vælg en understøttet Altru Coder-hostet embedding-model.",
  "settings.indexing.altruCoderSignIn.title": "Altru Coder-login kræves",
  "settings.indexing.altruCoderSignIn.description": "Log ind på Altru Coder for at bruge hostede embeddings.",
  ...
  "settings.providers.betaNotice":
    "I øjeblikket kan kun Altru Coder Gateway-udbyderen konfigureres i indstillingsgrænsefladen. Understøttelse af konfiguration af andre udbydere kommer snart i løbet af betaperioden. I mellemtiden kan du konfigurere udbydere via CLI eller konfigurationsfilen. Vi er dedikerede til at holde Altru Coder åben, ingen lock-in.",
  ...
  "settings.config.title": "Åbn {{scope}} Altru Coder konfigurationsfil",
  "settings.config.placeholder":
    "Konfigurationsfiler flettes i rækkefølge; filer markeret som indlæst påvirker i øjeblikket indstillingerne.",
  "settings.config.noWorkspace": "Åbn en arbejdsområdemappe for at redigere den lokale Altru Coder konfigurationsfil.",
  "settings.config.openFailed": "Kunne ikke åbne {{scope}} Altru Coder konfigurationsfil: {{message}}",
  "settings.config.source.xdg": "XDG global konfiguration",
  "settings.config.source.homeAltruCoder": "Home .altru-coder konfiguration",
  "settings.config.source.homeAltrucoder": "Home .altrucoder konfiguration",
  ...
  "settings.config.source.projectAltruCoder": "Projekt .altru-coder konfiguration",
  "settings.config.source.projectRoot": "Projekt rodkonfiguration",
  "settings.config.source.projectAltrucoder": "Forældet .altrucoder konfiguration",
  ...
  "session.cloud.import.placeholder": "Sessions-ID, URL eller altru-coder import-kommando",
  ...
  "deviceAuth.title": "Log ind på Altru Coder",
  ...
  "profile.action.login": "Log ind med Altru Coder",
  ...
  "session.messages.welcome":
    "Altru Coder er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutAltruCoder.status.connected": "Forbundet",
  "settings.aboutAltruCoder.status.connecting": "Forbinder...",
  "settings.aboutAltruCoder.status.disconnected": "Afbrudt",
  "settings.aboutAltruCoder.status.error": "Fejl",
  ...
  "settings.aboutAltruCoder.versionInfo": "Versionsinformation",
  "settings.aboutAltruCoder.version.label": "Version:",
  "settings.aboutAltruCoder.extensionName": "Altru Coder-udvidelse",
  "settings.aboutAltruCoder.community": "Fællesskab og support",
  ...
  "settings.aboutAltruCoder.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutAltruCoder.resetSettings.title": "Nulstil indstillinger",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Nulstil alle indstillinger",
  "settings.aboutAltruCoder.settingsTransfer.title": "Overførsel af indstillinger",
  ...
  "settings.aboutAltruCoder.exportSettings": "Eksportér",
  "settings.aboutAltruCoder.importSettings": "Importér",
  "settings.aboutAltruCoder.importSettings.invalidJson": "Ugyldig JSON-fil. Vælg venligst en gyldig indstillingsfil.",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "Filen indeholder ikke gyldige Altru Coder-indstillinger.",
  "settings.aboutAltruCoder.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af Altru Coder. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Åbn telemetriindstillinger",
  ...
  "settings.language.description": 'Vælg sproget til Altru Coder-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via Altru Coder Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have Altru Coder til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigureret. Tilføj MCP-servere i altru-coder.jsonc, eller bed agenten om at tilføje dem.",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Altru Coder webview UI uafhængigt af VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Legacy-migrering",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Altru Coder, herunder udbyder API-nøgler og standardmodel.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle Altru Coder-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer ændret af Altru Coder i den aktuelle session, baseret på snapshots pr. tur. Nulstilles, når du starter en ny session.",
