export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Altru Coder.",
  ...
  "dialog.server.description": "Przełącz serwer Altru Coder, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Altru Coder ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Altru Coder",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Altru Coder nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Altru Coder",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Altru Coder na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Altru Coder.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Altru Coder",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Altru Coder.",
  ...
  "settings.providers.betaNotice":
    "Obecnie w interfejsie ustawień można skonfigurować tylko dostawcę Altru Coder Gateway. Obsługa konfiguracji innych dostawców pojawi się wkrótce w fazie beta. W międzyczasie możesz konfigurować dostawców za pomocą CLI lub pliku konfiguracyjnego. Zależy nam na zachowaniu otwartości Altru Coder, bez lock-inu.",
  ...
  "settings.config.source.homeAltrucoder": "Konfiguracja .altrucoder (Home)",
  "settings.config.source.homeOpencode": "Konfiguracja .opencode (Home)",
  "settings.config.source.envFile": "Plik środowiskowy ALTRU_CODER_CONFIG",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "Wbudowana konfiguracja środowiska",
  "settings.config.source.projectAltruCoder": "Konfiguracja .altru-coder projektu",
  "settings.config.source.projectRoot": "Konfiguracja główna projektu",
  "settings.config.source.projectAltrucoder": "Przestarzała konfiguracja .altrucoder",
  ...
  "session.cloud.import.placeholder": "ID sesji, URL lub polecenie altru-coder import",
  ...
  "deviceAuth.title": "Zaloguj się do Altru Coder",
  ...
  "profile.action.login": "Zaloguj się przez Altru Coder",
  ...
  "settings.aboutAltruCoder.title": "O Altru Coder",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "Altru Coder to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutAltruCoder.status.connected": "Połączono",
  "settings.aboutAltruCoder.status.connecting": "Łączenie...",
  "settings.aboutAltruCoder.status.disconnected": "Rozłączono",
  "settings.aboutAltruCoder.status.error": "Błąd",
  "settings.aboutAltruCoder.cliServer": "Serwer CLI",
  "settings.aboutAltruCoder.status.label": "Status:",
  "settings.aboutAltruCoder.port.label": "Port:",
  "settings.aboutAltruCoder.versionInfo": "Informacje o wersji",
  "settings.aboutAltruCoder.version.label": "Wersja:",
  "settings.aboutAltruCoder.extensionName": "Rozszerzenie Altru Coder",
  "settings.aboutAltruCoder.community": "Społeczność i wsparcie",
  "settings.aboutAltruCoder.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutAltruCoder.feedback.or": "lub",
  "settings.aboutAltruCoder.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutAltruCoder.resetSettings.title": "Resetuj ustawienia",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Resetuj wszystkie ustawienia",
  "settings.aboutAltruCoder.settingsTransfer.title": "Przenoszenie ustawień",
  ...
  "settings.aboutAltruCoder.exportSettings": "Eksportuj",
  "settings.aboutAltruCoder.importSettings": "Importuj",
  "settings.aboutAltruCoder.importSettings.invalidJson": "Nieprawidłowy plik JSON. Wybierz prawidłowy plik ustawień.",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień Altru Coder.",
  "settings.aboutAltruCoder.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Ten plik został wyeksportowany z nowszej wersji Altru Coder. Niektóre ustawienia mogą zostać zignorowane.",
  ...
  "settings.aboutAltruCoder.telemetry.title": "Telemetria",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Otwórz ustawienia telemetrii",
  ...
  "settings.language.description": 'Wybierz język interfejsu Altru Coder. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.experimental.remote.description":
    "Włącz sterowanie Remote sesjami za pośrednictwem Altru Coder Cloud. Wpłynie to również na CLI na tej maszynie.",
  ...
  "settings.indexing.altruCoderModel.title": "Preset modelu Altru Coder",
  "settings.indexing.altruCoderModel.description": "Wybierz obsługiwany model osadzania hostowany przez Altru Coder.",
  "settings.indexing.altruCoderSignIn.title": "Wymagane logowanie do Altru Coder",
  "settings.indexing.altruCoderSignIn.description": "Zaloguj się do Altru Coder, aby używać hostowanych osadzeń.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Wczytuje instrukcje CLAUDE.md oraz umiejętności z katalogu konfiguracyjnego Claude Code do sesji. Włącz tę opcję, jeśli chcesz, aby Altru Coder korzystał z Twoich instrukcji i umiejętności Claude Code. Wymaga ponownego uruchomienia.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Brak skonfigurowanych serwerów MCP. Dodaj serwery MCP w altru-coder.jsonc lub poproś agenta o ich dodanie.",
  ...
  "settings.display.fontSize.description": "Dostosuj rozmiar czcionki webview UI Altru Coder niezależnie od VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Altru Coder, w tym klucze API dostawców i domyślny model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno małe, wydajne jądro we wszystkich produktach Altru Coder. Znajome doświadczenie niezależnie od sposobu pracy.",
  ...
  "diffViewer.source.session.tooltip":
    "Pliki zmienione przez Altru Coder w trakcie bieżącej sesji, na podstawie snapshotów na turę. Resetowane przy rozpoczęciu nowej sesji.",
