export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen aangeboden door Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Voer uw {{provider}} API-sleutel in om uw account te verbinden en {{provider}} modellen te gebruiken in Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om uw autorisatiecode op te halen waarmee u uw account kunt verbinden en {{provider}} modellen kunt gebruiken in Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om uw account te verbinden en {{provider}} modellen te gebruiken in Altru Coder.",
  ...
  "dialog.server.description": "Wissel met welke Altru Coder server deze app verbinding maakt.",
  ...
  "toast.update.description": "Een nieuwe versie van Altru Coder ({{version}}) is nu beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Meld deze fout alsjeblieft aan het Altru Coder team",
  ...
  "sidebar.gettingStarted.line1": "Altru Coder bevat gratis modellen, zodat je meteen kunt beginnen.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Altru Coder",
  "settings.general.row.appearance.title": "Uiterlijk",
  "settings.general.row.appearance.description": "Pas aan hoe Altru Coder eruitziet op je apparaat",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Altru Coder aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Altru Coder start",
  ...
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Altru Coder.",
  ...
  "settings.providers.betaNotice":
    "Momenteel kan alleen de Altru Coder Gateway-provider worden geconfigureerd in de instellingeninterface. Ondersteuning voor het configureren van andere providers komt binnenkort tijdens de bèta-periode. In de tussentijd kun je providers configureren met behulp van de CLI of het configuratiebestand. We zijn toegewijd om Altru Coder open te houden, geen lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Altru Coder-configuratiebestand",
  ...
  "settings.config.noWorkspace": "Open een werkruimtemap om het lokale Altru Coder-configuratiebestand te bewerken.",
  "settings.config.openFailed": "Kan {{scope}} Altru Coder-configuratiebestand niet openen: {{message}}",
  "settings.config.source.xdg": "XDG globale configuratie",
  "settings.config.source.homeAltruCoder": "Home .altru-coder-configuratie",
  "settings.config.source.homeAltrucoder": "Home .altrucoder-configuratie",
  "settings.config.source.homeOpencode": "Home .opencode-configuratie",
  "settings.config.source.envFile": "ALTRU_CODER_CONFIG omgevingsbestand",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "Inline omgevingsconfiguratie",
  "settings.config.source.projectAltruCoder": "Project .altru-coder-configuratie",
  "settings.config.source.projectRoot": "Project root configuratie",
  "settings.config.source.projectAltrucoder": "Verouderde .altrucoder-configuratie",
  ...
  "session.cloud.import.placeholder": "Sessie-ID, URL, of altru-coder import commando",
  ...
  "deviceAuth.title": "Meld je aan bij Altru Coder",
  ...
  "profile.action.login": "Inloggen met Altru Coder",
  ...
  "settings.aboutAltruCoder.title": "Over Altru Coder",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "Altru Coder is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutAltruCoder.status.connected": "Verbonden",
  "settings.aboutAltruCoder.status.connecting": "Verbinden...",
  "settings.aboutAltruCoder.status.disconnected": "Verbinding verbroken",
  "settings.aboutAltruCoder.status.error": "Fout",
  "settings.aboutAltruCoder.cliServer": "CLI Server",
  "settings.aboutAltruCoder.status.label": "Status:",
  "settings.aboutAltruCoder.port.label": "Poort:",
  "settings.aboutAltruCoder.versionInfo": "Versie-informatie",
  ...
  "settings.aboutAltruCoder.resetSettings.title": "Instellingen resetten",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Alle instellingen resetten",
  "settings.aboutAltruCoder.settingsTransfer.title": "Instellingen overdragen",
  ...
  "settings.aboutAltruCoder.exportSettings": "Exporteren",
  "settings.aboutAltruCoder.importSettings": "Importeren",
  "settings.aboutAltruCoder.importSettings.invalidJson":
    "Ongeldig JSON-bestand. Selecteer een geldig instellingenbestand.",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "Het bestand bevat geen geldige Altru Coder-instellingen.",
  ...
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Dit bestand is geëxporteerd vanuit een nieuwere versie van Altru Coder. Sommige instellingen worden mogelijk genegeerd.",
  ...
  "settings.aboutAltruCoder.telemetry.title": "Telemetrie",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Telemetrie-instellingen openen",
  ...
  "settings.language.description": 'Kies de taal voor de Altru Coder UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.experimental.remote.description":
    "Schakel Remote-bediening van sessies in via Altru Coder Cloud. Dit heeft ook invloed op CLI's op deze machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Laad CLAUDE.md instructies en vaardigheden uit je Claude Code configuratiemap in sessies. Schakel dit in als je wilt dat Altru Coder je Claude Code instructies en vaardigheden gebruikt. Herstart vereist.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Geen MCP-servers geconfigureerd. Voeg MCP-servers toe in altru-coder.jsonc of vraag de agent om ze toe te voegen.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Legacy Migratie",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van Altru Coder, inclusief provider API-sleutels en standaard model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Één kleine, efficiënte kern voor elk Altru Coder-product. Een vertrouwde ervaring, hoe je ook wilt werken.",
  ...
  "settings.indexing.altruCoderModel.title": "Altru Coder-model voorinstelling",
  "settings.indexing.altruCoderModel.description": "Kies een ondersteund Altru Coder-hosted embeddings model.",
  "settings.indexing.altruCoderSignIn.title": "Altru Coder-aanmelding vereist",
  "settings.indexing.altruCoderSignIn.description": "Log in op Altru Coder om hosted embeddings te gebruiken.",
  ...
  "diffViewer.source.session.tooltip":
    "Bestanden die door Altru Coder tijdens de huidige sessie zijn gewijzigd, gebaseerd op snapshots per beurt. Wordt gereset bij het starten van een nieuwe sessie.",
