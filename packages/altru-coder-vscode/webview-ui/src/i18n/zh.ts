...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Altru Coder 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Altru Coder 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Altru Coder 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Altru Coder 服务器。",
  ...
  "toast.update.description": "Altru Coder 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Altru Coder 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Altru Coder 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Altru Coder 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Altru Coder 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Altru Coder 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Altru Coder 启动时自动检查更新",
  ...
  "settings.indexing.altruCoderModel.title": "Altru Coder 模型预设",
  "settings.indexing.altruCoderModel.description": "选择受支持的 Altru Coder 托管嵌入模型。",
  "settings.indexing.altruCoderSignIn.title": "需要登录 Altru Coder",
  "settings.indexing.altruCoderSignIn.description": "登录 Altru Coder 以使用托管嵌入。",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 Altru Coder Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 Altru Coder 开放，无锁定。",
  ...
  "settings.config.title": "打开 {{scope}} Altru Coder 配置文件",
  "settings.config.placeholder": "配置文件按顺序合并；标记为已加载的文件目前会影响设置。",
  "settings.config.noWorkspace": "打开工作区文件夹以编辑本地 Altru Coder 配置文件。",
  "settings.config.openFailed": "无法打开 {{scope}} Altru Coder 配置文件：{{message}}",
  "settings.config.source.xdg": "XDG 全局配置",
  "settings.config.source.homeAltruCoder": "主目录 .altru-coder 配置",
  "settings.config.source.homeAltrucoder": "主目录 .altrucoder 配置",
  "settings.config.source.homeOpencode": "主目录 .opencode 配置",
  "settings.config.source.envFile": "ALTRU_CODER_CONFIG 环境变量文件",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "内联环境配置",
  "settings.config.source.projectAltruCoder": "项目 .altru-coder 配置",
  "settings.config.source.projectRoot": "项目根目录配置",
  "settings.config.source.projectAltrucoder": "旧版 .altrucoder 配置",
  ...
  "session.cloud.import.placeholder": "会话 ID、URL 或 altru-coder import 命令",
  ...
  "deviceAuth.title": "登录 Altru Coder",
  ...
  "profile.action.login": "使用 Altru Coder 登录",
  ...
  "settings.aboutAltruCoder.title": "关于 Altru Coder",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "Altru Coder 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutAltruCoder.status.connected": "已连接",
  "settings.aboutAltruCoder.status.connecting": "连接中...",
  "settings.aboutAltruCoder.status.disconnected": "已断开",
  "settings.aboutAltruCoder.status.error": "错误",
  "settings.aboutAltruCoder.cliServer": "CLI 服务器",
  "settings.aboutAltruCoder.status.label": "状态：",
  "settings.aboutAltruCoder.port.label": "端口：",
  "settings.aboutAltruCoder.versionInfo": "版本信息",
  "settings.aboutAltruCoder.version.label": "版本：",
  "settings.aboutAltruCoder.extensionName": "Altru Coder 扩展",
  "settings.aboutAltruCoder.community": "社区与支持",
  "settings.aboutAltruCoder.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutAltruCoder.feedback.or": "或",
  "settings.aboutAltruCoder.support.prefix": "如有账单或账户问题，请联系客户支持",
  "settings.aboutAltruCoder.resetSettings.title": "重置设置",
  "settings.aboutAltruCoder.resetSettings.description":
    "此操作仅将 VS Code 扩展专属设置重置为默认值。与 CLI 共享的设置（如模式和自动审批规则）存储在 CLI 配置中，不会被重置。",
  "settings.aboutAltruCoder.resetSettings.button": "重置所有设置",
  "settings.aboutAltruCoder.settingsTransfer.title": "设置迁移",
  "settings.aboutAltruCoder.settingsTransfer.description": "导出或导入设置，以便在 VS Code 实例之间传输。",
  "settings.aboutAltruCoder.exportSettings": "导出",
  "settings.aboutAltruCoder.importSettings": "导入",
  "settings.aboutAltruCoder.importSettings.invalidJson": "无效的 JSON 文件。请选择有效的设置文件。",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "文件不包含有效的 Altru Coder 设置。",
  "settings.aboutAltruCoder.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutAltruCoder.importSettings.newerVersion": "此文件由较新版本的 Altru Coder 导出。部分设置可能会被忽略。",
  "settings.aboutAltruCoder.importSettings.success": "设置已导入。请查看上方的更改，然后点击保存。",

  "settings.aboutAltruCoder.telemetry.title": "遥测",
  "settings.aboutAltruCoder.telemetry.description":
    '遥测由 VS Code 的内置遥测设置控制。若要将其禁用，请转到「设置」>「遥测」>「遥测级别」并将其设置为 "off"。重启 VS Code 以应用更改。',
  "settings.aboutAltruCoder.telemetry.openSettings": "打开遥测设置",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Altru Coder 界面的语言。',
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 Altru Coder 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未配置 MCP 服务器。在 altru-coder.jsonc 中添加 MCP 服务器，或让代理为您添加。",
  ...
  "settings.display.fontSize.description": "独立于 VS Code 调整 Altru Coder webview UI 的字体大小。",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "旧版迁移",
  "settings.aboutAltruCoder.legacyMigration.description":
    "从旧版 Altru Coder 安装迁移设置，包括提供商 API 密钥和默认模型。",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Altru Coder 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
  ...
  "diffViewer.source.session.tooltip": "Altru Coder 在当前会话中更改的文件，基于每轮快照。开始新会话时重置。",
