export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Altru Coderが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Altru Coderで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAltru Coderで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Altru Coderで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するAltru Coderサーバーを切り替えます。",
  ...
  "toast.update.description": "Altru Coderの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAltru Coderチームに報告してください: ",
  ...
  "sidebar.gettingStarted.line1": "Altru Coderには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Altru Coderの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのAltru Coderの表示をカスタマイズします",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Altru Coderのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Altru Coder の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Altru Coder は最新バージョンです。",
  ...
  "settings.providers.betaNotice":
    "現在、設定画面で設定できるのはAltru Coder Gatewayプロバイダーのみです。他のプロバイダーの設定については、ベータ期間中にまもなく対応予定です。それまでの間は、CLIまたは設定ファイルを使用してプロバイダーを設定できます。私たちはAltru Coderをオープンに保ち、ロックインのない状態を維持することをお約束します。",
  ...
  "settings.config.source.homeAltrucoder": "Homeの.altrucoder構成",
  "settings.config.source.homeOpencode": "Homeの.opencode構成",
  "settings.config.source.envFile": "ALTRU_CODER_CONFIG環境ファイル",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "インライン環境構成",
  "settings.config.source.projectAltruCoder": "プロジェクトの.altru-coder構成",
  "settings.config.source.projectRoot": "プロジェクトルート構成",
  "settings.config.source.projectAltrucoder": "旧.altrucoder構成",
  ...
  "session.cloud.import.placeholder": "セッションID、URL、またはaltru-coder importコマンド",
  ...
  "deviceAuth.title": "Altru Coderにサインイン",
  ...
  "profile.action.login": "Altru Coderでログイン",
  ...
  "settings.aboutAltruCoder.title": "Altru Coderについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "Altru CoderはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutAltruCoder.status.connected": "接続済み",
  "settings.aboutAltruCoder.status.connecting": "接続中...",
  "settings.aboutAltruCoder.status.disconnected": "切断",
  "settings.aboutAltruCoder.status.error": "エラー",
  "settings.aboutAltruCoder.cliServer": "CLIサーバー",
  "settings.aboutAltruCoder.status.label": "ステータス：",
  "settings.aboutAltruCoder.port.label": "ポート：",
  "settings.aboutAltruCoder.versionInfo": "バージョン情報",
  "settings.aboutAltruCoder.version.label": "バージョン：",
  "settings.aboutAltruCoder.extensionName": "Altru Coder拡張機能",
  "settings.aboutAltruCoder.community": "コミュニティとサポート",
  "settings.aboutAltruCoder.feedback.prefix": "ご質問やフィードバックがありましたら、お気軽にissueを作成してください",
  "settings.aboutAltruCoder.feedback.or": "または",
  "settings.aboutAltruCoder.support.prefix":
    "請求やアカウントに関するご質問は、カスタマーサポートまでお問い合わせください",
  "settings.aboutAltruCoder.resetSettings.title": "設定をリセット",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "すべての設定をリセット",
  "settings.aboutAltruCoder.settingsTransfer.title": "設定の移行",
  "settings.aboutAltruCoder.settingsTransfer.description":
    "VS Code インスタンス間で設定を転送するには、エクスポートまたはインポートしてください。",
  "settings.aboutAltruCoder.exportSettings": "エクスポート",
  "settings.aboutAltruCoder.importSettings": "インポート",
  ...
  "settings.aboutAltruCoder.telemetry.title": "テレメトリ",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "テレメトリ設定を開く",
  ...
  "settings.language.description": "Altru Coder UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.experimental.remote.description":
    "Altru Coder Cloud 経由でのセッションの Remote コントロールを有効にします。これはこのマシンの CLI にも影響します。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code の設定ディレクトリから CLAUDE.md のインストラクションとスキルをセッションに読み込みます。Altru Coder に Claude Code のインストラクションとスキルを使用させる場合は、これを有効にしてください。再起動が必要です。",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCPサーバーが設定されていません。altru-coder.jsoncでMCPサーバーを追加するか、エージェントに追加を依頼してください。",
  ...
  "settings.display.fontSize.description": "VS Code とは独立して Altru Coder webview UI のフォントサイズを調整します。",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "レガシー移行",
  "settings.aboutAltruCoder.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたAltru Coderから設定を移行します。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Altru Coderの新機能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "すべてのAltru Coder製品で共有される小さく効率的なコア。どのような作業スタイルでも馴染みのある体験を提供します。",
  ...
  "diffViewer.source.session.tooltip":
    "現在のセッション中に Altru Coder が変更したファイル。ターンごとのスナップショットに基づきます。新しいセッションを開始するとリセットされます。",
