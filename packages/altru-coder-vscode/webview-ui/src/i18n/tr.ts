export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Altru Coder tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Altru Coder'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Altru Coder'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Altru Coder sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Altru Coder'nun yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Altru Coder ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Altru Coder henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Altru Coder Masaüstü",
  ...
  "settings.general.row.language.description": "Altru Coder'nun görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Altru Coder'nun cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Altru Coder'nun temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Altru Coder başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Altru Coder'nun en son sürümünü kullanıyorsunuz.",
  ...
  "settings.providers.betaNotice":
    "Şu anda yalnızca Altru Coder Gateway sağlayıcısı ayarlar arayüzünde yapılandırılabilir. Diğer sağlayıcılar için destek beta döneminde yakında gelecek. Bu arada CLI veya yapılandırma dosyası ile sağlayıcıları yapılandırabilirsiniz. Altru Coder'yu açık tutmaya kararlıyız, kilitlenme yok.",
  ...
  "settings.config.source.homeAltrucoder": "Home .altrucoder yapılandırması",
  "settings.config.source.homeOpencode": "Home .opencode yapılandırması",
  "settings.config.source.envFile": "ALTRU_CODER_CONFIG ortam dosyası",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "Satır içi ortam yapılandırması",
  "settings.config.source.projectAltruCoder": "Proje .altru-coder yapılandırması",
  "settings.config.source.projectRoot": "Proje kök yapılandırması",
  "settings.config.source.projectAltrucoder": "Eski .altrucoder yapılandırması",
  ...
  "session.cloud.import.placeholder": "Oturum kimliği, URL veya altru-coder import komutu",
  ...
  "deviceAuth.title": "Altru Coder'a giriş yap",
  ...
  "profile.action.login": "Altru Coder ile giriş yap",
  ...
  "settings.aboutAltruCoder.title": "Altru Coder Hakkında",

  "session.messages.empty": "Aşağıya bir mesaj yazarak sohbete başlayın.",
  "session.messages.welcome":
    "Altru Coder bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.aboutAltruCoder.status.connected": "Bağlı",
  "settings.aboutAltruCoder.status.connecting": "Bağlanıyor...",
  "settings.aboutAltruCoder.status.disconnected": "Bağlantı Kesildi",
  "settings.aboutAltruCoder.status.error": "Hata",
  "settings.aboutAltruCoder.cliServer": "CLI Sunucusu",
  "settings.aboutAltruCoder.status.label": "Durum:",
  "settings.aboutAltruCoder.port.label": "Port:",
  "settings.aboutAltruCoder.versionInfo": "Sürüm Bilgisi",
  "settings.aboutAltruCoder.version.label": "Sürüm:",
  "settings.aboutAltruCoder.extensionName": "Altru Coder Uzantısı",
  "settings.aboutAltruCoder.community": "Topluluk ve Destek",
  ...
  "settings.aboutAltruCoder.feedback.or": "veya",
  "settings.aboutAltruCoder.support.prefix": "Faturalama veya hesap soruları için Müşteri Desteği ile iletişime geçin:",
  "settings.aboutAltruCoder.resetSettings.title": "Ayarları Sıfırla",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Tüm Ayarları Sıfırla",
  "settings.aboutAltruCoder.settingsTransfer.title": "Ayar Aktarımı",
  ...
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Bu dosya Altru Coder'nun daha yeni bir sürümünden dışa aktarılmış. Bazı ayarlar göz ardı edilebilir.",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Telemetri Ayarlarını Aç",
  ...
  "settings.language.description":
    '"Otomatik" VS Code görüntüleme dilinizi kullanır. Altru Coder arayüzü için dil seçin.',
  ...
  "settings.experimental.remote.description":
    "Altru Coder Cloud üzerinden oturumların Remote kontrolünü etkinleştirin. Bu, bu makinedeki CLI'leri de etkileyecektir.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code yapılandırma dizininizdeki CLAUDE.md talimatlarını ve becerilerini oturumlara yükleyin. Altru Coder'nun Claude Code talimatlarınızı ve becerilerinizi kullanmasını istiyorsanız bunu etkinleştirin. Yeniden başlatma gerektirir.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Yapılandırılmış MCP sunucusu yok. altru-coder.jsonc dosyasına MCP sunucuları ekleyin veya ajanın eklemesini isteyin.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Eski Sürüm Taşıma",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Sağlayıcı API anahtarları ve varsayılan model dahil olmak üzere Altru Coder'un önceki yüklemesinden ayarları taşıyın.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Altru Coder'daki Yenilikler",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Her Altru Coder ürününde küçük ve verimli bir çekirdek. Nasıl çalışmayı tercih ederseniz edin, tanıdık bir deneyim.",
  ...
  "settings.indexing.altruCoderModel.title": "Altru Coder model önayarı",
  "settings.indexing.altruCoderModel.description": "Desteklenen bir Altru Coder-hosted embeddings modeli seçin.",
  "settings.indexing.altruCoderSignIn.title": "Altru Coder oturumu açmak gerekiyor",
  "settings.indexing.altruCoderSignIn.description": "Hosted embeddings kullanmak için Altru Coder'da oturum açın.",
  ...
  "diffViewer.source.session.tooltip":
    "Geçerli oturum sırasında Altru Coder tarafından değiştirilen dosyalar, tur başı anlık görüntülere dayanır. Yeni bir oturum başlatıldığında sıfırlanır.",
