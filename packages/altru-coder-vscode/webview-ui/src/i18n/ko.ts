...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Altru Coder에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Altru Coder에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Altru Coder에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Altru Coder에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 Altru Coder 서버를 전환합니다.",
  ...
  "toast.update.description": "Altru Coder의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Altru Coder 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Altru Coder는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.general.row.language.description": "Altru Coder 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Altru Coder가 보이는 방식 사용자 지정",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Altru Coder 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Altru Coder를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Altru Coder를 사용 중입니다.",
  ...
  "settings.providers.betaNotice":
    "현재 설정 인터페이스에서는 Altru Coder Gateway 제공자만 설정할 수 있습니다. 다른 제공자 설정에 대한 지원은 베타 기간 동안 곧 제공될 예정입니다. 그동안에는 CLI 또는 설정 파일을 사용하여 제공자를 설정할 수 있습니다. 우리는 종속(lock-in) 없이 Altru Coder를 개방적으로 유지하기 위해 최선을 다하고 있습니다.",
  ...
  "settings.config.title": "{{scope}} Altru Coder 구성 파일 열기",
  "settings.config.placeholder":
    "구성 파일은 순서대로 병합됩니다. 로드됨으로 표시된 파일이 현재 설정에 영향을 미칩니다.",
  "settings.config.noWorkspace": "로컬 Altru Coder 구성 파일을 편집하려면 작업 영역 폴더를 엽니다.",
  "settings.config.openFailed": "{{scope}} Altru Coder 구성 파일을 열지 못했습니다: {{message}}",
  "settings.config.source.xdg": "XDG 글로벌 구성",
  "settings.config.source.homeAltruCoder": "Home .altru-coder 구성",
  "settings.config.source.homeAltrucoder": "Home .altrucoder 구성",
  "settings.config.source.homeOpencode": "Home .opencode 구성",
  "settings.config.source.envFile": "ALTRU_CODER_CONFIG 환경 파일",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "인라인 환경 구성",
  "settings.config.source.projectAltruCoder": "프로젝트 .altru-coder 구성",
  "settings.config.source.projectRoot": "프로젝트 루트 구성",
  "settings.config.source.projectAltrucoder": "레거시 .altrucoder 구성",
  ...
  "session.cloud.import.placeholder": "세션 ID, URL 또는 altru-coder import 명령어",
  ...
  "deviceAuth.title": "Altru Coder에 로그인",
  ...
  "profile.action.login": "Altru Coder로 로그인",
  ...
  "settings.aboutAltruCoder.title": "Altru Coder 정보",
  ...
  "settings.indexing.altruCoderModel.title": "Altru Coder 모델 프리셋",
  "settings.indexing.altruCoderModel.description": "지원되는 Altru Coder 호스팅 임베딩 모델을 선택하세요.",
  "settings.indexing.altruCoderSignIn.title": "Altru Coder 로그인이 필요합니다",
  "settings.indexing.altruCoderSignIn.description": "호스팅 임베딩을 사용하려면 Altru Coder에 로그인하세요.",
  ...
  "session.messages.welcome":
    "Altru Coder는 AI 코딩 어시스턴트입니다. 기능 구축, 버그 수정 또는 코드베이스 설명을 요청하세요.",
  ...
  "settings.aboutAltruCoder.status.connected": "연결됨",
  "settings.aboutAltruCoder.status.connecting": "연결 중...",
  "settings.aboutAltruCoder.status.disconnected": "연결 끊김",
  "settings.aboutAltruCoder.status.error": "오류",
  "settings.aboutAltruCoder.cliServer": "CLI 서버",
  "settings.aboutAltruCoder.status.label": "상태:",
  "settings.aboutAltruCoder.port.label": "포트:",
  "settings.aboutAltruCoder.versionInfo": "버전 정보",
  "settings.aboutAltruCoder.version.label": "버전:",
  "settings.aboutAltruCoder.extensionName": "Altru Coder 확장 프로그램",
  "settings.aboutAltruCoder.community": "커뮤니티 및 지원",
  "settings.aboutAltruCoder.feedback.prefix": "질문이나 피드백이 있으시면 다음에서 이슈를 열어주세요",
  "settings.aboutAltruCoder.feedback.or": "또는",
  "settings.aboutAltruCoder.support.prefix": "결제 또는 계정 관련 문의는 고객 지원팀에 문의하세요",
  "settings.aboutAltruCoder.resetSettings.title": "설정 초기화",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "모든 설정 초기화",
  "settings.aboutAltruCoder.settingsTransfer.title": "설정 이전",
  "settings.aboutAltruCoder.settingsTransfer.description":
    "VS Code 인스턴스 간에 설정을 전송하려면 내보내기 또는 가져오기하세요.",
  "settings.aboutAltruCoder.exportSettings": "내보내기",
  "settings.aboutAltruCoder.importSettings": "가져오기",
  "settings.aboutAltruCoder.importSettings.invalidJson":
    "유효하지 않은 JSON 파일입니다. 올바른 설정 파일을 선택해 주세요.",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "파일에 유효한 Altru Coder 설정이 포함되어 있지 않습니다.",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "원격 측정 설정 열기",
  ...
  "settings.language.description": 'Altru Coder UI의 언어를 선택하세요. "자동"은 VS Code 표시 언어를 사용합니다.',
  ...
  "settings.experimental.remote.description":
    "Altru Coder Cloud를 통한 세션의 Remote 제어를 활성화합니다. 이는 이 컴퓨터의 CLI에도 영향을 미칩니다.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code 설정 디렉터리에서 세션으로 CLAUDE.md 지침 및 스킬을 로드합니다. Altru Coder가 Claude Code 지침 및 스킬을 사용하게 하려면 활성화하세요. 다시 시작해야 합니다.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP 서버가 구성되지 않았습니다. altru-coder.jsonc에서 MCP 서버를 추가하거나 에이전트에게 추가를 요청하세요.",
  ...
  "settings.display.fontSize.description": "VS Code와 독립적으로 Altru Coder webview UI 글꼴 크기를 조정합니다.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "레거시 마이그레이션",
  "settings.aboutAltruCoder.legacyMigration.description":
    "공급자 API 키 및 기본 모델을 포함하여 이전 Altru Coder 설치에서 설정을 마이그레이션합니다.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Altru Coder의 새로운 기능",
  ...
  "migration.whatsNew.features.foundation.detail":
    "모든 Altru Coder 제품에 걸쳐 하나의 작고 효율적인 코어. 어떤 방식으로 작업하든 익숙한 경험을 제공합니다.",
  ...
  "diffViewer.source.session.tooltip":
    "현재 세션 동안 Altru Coder가 변경한 파일로, 턴별 스냅샷을 기반으로 합니다. 새 세션을 시작하면 초기화됩니다.",
