export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Altru Coder",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Altru Coder.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Altru Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Altru Coder.",
  ...
  "dialog.server.description": "Переключите сервер Altru Coder к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия Altru Coder ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Altru Coder",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Altru Coder пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Altru Coder включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Altru Coder",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Altru Coder выглядит на вашем устройстве",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Altru Coder.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Altru Coder",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Altru Coder.",
  ...
  "settings.providers.betaNotice":
    "В настоящее время в интерфейсе настроек можно настроить только провайдер Altru Coder Gateway. Поддержка настройки других провайдеров скоро появится в период бета-тестирования. А пока вы можете настраивать провайдеров с помощью CLI или конфигурационного файла. Мы стремимся сохранить Altru Coder открытым — без привязки к поставщикам.",
  ...
  "settings.config.title": "Открыть файл конфигурации Altru Coder ({{scope}})",
  ...
  "settings.config.noWorkspace":
    "Откройте папку рабочей области для редактирования локального файла конфигурации Altru Coder.",
  "settings.config.openFailed": "Не удалось открыть файл конфигурации Altru Coder ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальная конфигурация XDG",
  "settings.config.source.homeAltruCoder": "Конфигурация .altru-coder (Home)",
  "settings.config.source.homeAltrucoder": "Конфигурация .altrucoder (Home)",
  "settings.config.source.homeOpencode": "Конфигурация .opencode (Home)",
  "settings.config.source.envFile": "Файл среды ALTRU_CODER_CONFIG",
  "settings.config.source.envDir": "ALTRU_CODER_CONFIG_DIR",
  "settings.config.source.envContent": "Встроенная конфигурация среды",
  "settings.config.source.projectAltruCoder": "Конфигурация .altru-coder проекта",
  "settings.config.source.projectRoot": "Корневая конфигурация проекта",
  "settings.config.source.projectAltrucoder": "Устаревшая конфигурация .altrucoder",
  ...
  "session.cloud.import.placeholder": "ID сессии, URL или команда altru-coder import",
  ...
  "deviceAuth.title": "Войти в Altru Coder",
  ...
  "profile.action.login": "Войти через Altru Coder",
  ...
  "settings.aboutAltruCoder.title": "О Altru Coder",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "Altru Coder — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutAltruCoder.status.connected": "Подключено",
  "settings.aboutAltruCoder.status.connecting": "Подключение...",
  "settings.aboutAltruCoder.status.disconnected": "Отключено",
  "settings.aboutAltruCoder.status.error": "Ошибка",
  "settings.aboutAltruCoder.cliServer": "CLI-сервер",
  "settings.aboutAltruCoder.status.label": "Статус:",
  "settings.aboutAltruCoder.port.label": "Порт:",
  "settings.aboutAltruCoder.versionInfo": "Информация о версии",
  "settings.aboutAltruCoder.version.label": "Версия:",
  "settings.aboutAltruCoder.extensionName": "Расширение Altru Coder",
  "settings.aboutAltruCoder.community": "Сообщество и поддержка",
  "settings.aboutAltruCoder.feedback.prefix": "Если у вас есть вопросы или отзывы, создайте issue на",
  "settings.aboutAltruCoder.feedback.or": "или",
  "settings.aboutAltruCoder.support.prefix": "По вопросам оплаты или аккаунта обращайтесь в службу поддержки по адресу",
  "settings.aboutAltruCoder.resetSettings.title": "Сброс настроек",
  ...
  "settings.aboutAltruCoder.resetSettings.button": "Сбросить все настройки",
  "settings.aboutAltruCoder.settingsTransfer.title": "Перенос настроек",
  ...
  "settings.aboutAltruCoder.exportSettings": "Экспорт",
  "settings.aboutAltruCoder.importSettings": "Импорт",
  "settings.aboutAltruCoder.importSettings.invalidJson": "Недопустимый файл JSON. Выберите корректный файл настроек.",
  "settings.aboutAltruCoder.importSettings.invalidConfig": "Файл не содержит допустимых настроек Altru Coder.",
  "settings.aboutAltruCoder.importSettings.tooLarge": "Файл слишком большой. Файлы настроек должны быть менее 1 MB.",
  "settings.aboutAltruCoder.importSettings.newerVersion":
    "Этот файл был экспортирован из более новой версии Altru Coder. Некоторые настройки могут быть проигнорированы.",
  "settings.aboutAltruCoder.importSettings.success":
    "Настройки импортированы. Просмотрите изменения выше и нажмите «Сохранить».",

  "settings.aboutAltruCoder.telemetry.title": "Телеметрия",
  ...
  "settings.aboutAltruCoder.telemetry.openSettings": "Открыть настройки телеметрии",
  ...
  "settings.language.description": "Выберите язык интерфейса Altru Coder. «Авто» использует язык отображения VS Code.",
  ...
  "settings.experimental.remote.description":
    "Включите управление Remote сеансами через Altru Coder Cloud. Это также повлияет на CLI на этом компьютере.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Загружать инструкции CLAUDE.md и навыки из каталога конфигурации Claude Code в сессии. Включите эту опцию, если хотите, чтобы Altru Coder использовал ваши инструкции и навыки Claude Code. Требуется перезапуск.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверы не настроены. Добавьте MCP-серверы в altru-coder.jsonc или попросите агента добавить их.",
  ...
  "settings.display.fontSize.description": "Настройте размер шрифта webview UI для Altru Coder независимо от VS Code.",
  ...
  "settings.aboutAltruCoder.legacyMigration.title": "Миграция с устаревшей версии",
  "settings.aboutAltruCoder.legacyMigration.description":
    "Перенос настроек из предыдущей установки Altru Coder, включая API-ключи провайдеров и модель по умолчанию.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в Altru Coder",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Одно компактное и эффективное ядро для всех продуктов Altru Coder. Знакомый опыт независимо от выбранного способа работы.",
  ...
  "diffViewer.source.session.tooltip":
    "Файлы, изменённые Altru Coder в текущей сессии, на основе снимков по ходу. Сбрасывается при начале новой сессии.",
