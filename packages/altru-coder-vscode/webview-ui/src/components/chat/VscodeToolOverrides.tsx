 ...
 * without duplicating render logic.
 *
...
import { ToolRegistry } from "@altru-coder/altru-coder-ui/message-part"

/** Tools that should stay compact by default in the VS Code sidebar. */
...
export function registerVscodeToolOverrides() {
  for (const name of COMPACT_TOOLS) {
    ...
    ToolRegistry.register({
      name,
      render: (props) => <Dynamic component={upstream} {...props} defaultOpen={props.defaultOpen ?? false} />,
    })
    registered.add(name)
  }
}
