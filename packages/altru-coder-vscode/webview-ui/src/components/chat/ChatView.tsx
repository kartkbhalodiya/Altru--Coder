...
interface ChatViewProps {
  ...
  /** Hidden by default so the chat input stays clean while keeping action logic available. */
...
export const ChatView: Component<ChatViewProps> = (props) => {
  ...
  const showSessionActions = () => props.showSessionActions === true
    ...
    <div class="chat-view">
      ...
      <Show when={dock()}>
        <div class="chat-input">
          ...
          <Show when={showSessionActions() && !props.readonly && idle() && !blocked() && hasActions(hasMessages())}>
