 ...
 * Shows the empty welcome state before the first message.
 */
...
import { AltruCoderNotifications } from "./AltruCoderNotifications"
...
const AltruCoderLogo = (): JSX.Element => {
  ...
  return (
    <div class="altru-coder-logo">
      <img src={`${iconsBaseUri}/altru-logo.png`} alt="Altru Coder" />
    </div>
  )
}
        ...
        <div ref={autoScroll.contentRef} class={isEmpty() ? "message-list-content-empty" : "message-list-content"}>
          ...
          <Show when={isEmpty() && props.readonly}>
            <div class="message-list-empty">
              <p class="altru-coder-about-text">{language.t("session.messages.initializing")}</p>
            </div>
          </Show>
          <Show when={isEmpty() && !props.readonly}>
            <div class="message-list-empty">
              <AltruCoderLogo />
              <p class="altru-coder-about-text altru-coder-typing">
                <span>{language.t("session.messages.welcomeTyping")}</span>
              </p>
            </div>
          </Show>
