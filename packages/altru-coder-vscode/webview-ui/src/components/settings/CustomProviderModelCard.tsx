...
export function ModelCard(props: ModelCardProps) {
  return (
    <div
      class="custom-provider-model-card"
      style={{
        display: "flex",
        "flex-direction": "column",
        gap: "8px",
    ...
    >
      ...
      <div style={{ display: "flex", gap: "8px", "align-items": "flex-end", "flex-wrap": "wrap", "min-width": 0 }}>
      ...
      <Show when={props.m.reasoning}>
        <Show when={props.m.variants.length > 0}>
          <div style={{ display: "flex", "flex-direction": "column", gap: "0" }}>
            <label
              style={{ "font-size": "var(--altru-coder-font-size-11)", "font-weight": "500", color: "var(--text-weak-base)" }}
            >
