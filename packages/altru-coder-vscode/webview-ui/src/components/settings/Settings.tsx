...
import { Tabs } from "@altru-coder/altru-coder-ui/tabs"
...
import AboutAltruCoderTab from "./AboutAltruCoderTab"
...
const Settings: Component<SettingsProps> = (props) => {
  ...
  const open = (scope: "local" | "global") => {
    ...
    vscode.postMessage({
      ...
      labels: {
        ...
        sourceHomeAltruCoder: language.t("settings.config.source.homeAltruCoder"),
        sourceHomeAltrucoder: language.t("settings.config.source.homeAltrucoder"),
        ...
        sourceProjectAltruCoder: language.t("settings.config.source.projectAltruCoder"),
  ...
  return (
    <div class="settings-view" style={{ display: "flex", "flex-direction": "column", height: "100%", "min-height": 0 }}>
      {/* Header */}
      <div
      ...
      >
        <h2
          ...
          style={{ "font-size": "var(--altru-coder-font-size-16)", "font-weight": "600", margin: 0, flex: 1 }}
        >
      ...
      >
        <Tabs.List>
          <Show when={props.onBack}>
            {(back) => (
              <div class="settings-tabs-back-wrap">
                <IconButton
                  size="small"
                  variant="ghost"
                  icon="arrow-left"
          ...
          <Tabs.Trigger value="aboutAltruCoder">
            <Icon name="help" />
            <span class="label">{language.t("settings.aboutAltruCoder.title")}</span>
          </Tabs.Trigger>
        </Tabs.List>
        ...
        <Tabs.Content value="aboutAltruCoder">
          <h3>{language.t("settings.aboutAltruCoder.title")}</h3>
          <AboutAltruCoderTab
