 ...
 * Uses altru-coder-ui List component for keyboard navigation and accessibility.
 * Header/back button are owned by the parent HistoryView.
 */

import { Component, Show, createSignal, onMount, type JSX } from "solid-js"
import { List } from "@altru-coder/altru-coder-ui/list"
...
import { InlineInput } from "@altru-coder/altru-coder-ui/inline-input"
...
const SessionList: Component<SessionListProps> = (props) => {
  ...
  onMount(() => {
    console.log("[Altru Coder New] SessionList mounted, loading sessions")
