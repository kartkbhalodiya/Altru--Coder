import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@altru-coder/sdk/v2/client"
...
export interface AltruCoderEmbeddingModelsLoadedMessage {
  type: "altruEmbeddingModelsLoaded"
  catalog: AltruCoderEmbeddingModelCatalog
}
...
export type ExtensionMessage =
  ...
  | AltruCoderEmbeddingModelsLoadedMessage
