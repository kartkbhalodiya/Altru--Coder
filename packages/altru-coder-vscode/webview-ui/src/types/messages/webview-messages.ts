...
export interface RequestAltruCoderEmbeddingModelsMessage {
  type: "requestAltruCoderEmbeddingModels"
}
...
export interface UpdateConfigMessage {
  type: "updateConfig"
  /** Global config patch written to ~/.config/altru-coder/altru-coder.json. */
  config: Partial<Config>
  /** Project config patch written to the workspace's .altru-coder/altru-coder.json or existing project config. */
...
export type WebviewMessage =
  ...
  | RequestAltruCoderEmbeddingModelsMessage
  | UpdateConfigMessage
