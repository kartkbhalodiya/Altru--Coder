...
**Priority:** P0
**Issue:** [#6083](https://github.com/Altru-Coder/altrucoder/issues/6083)
...
- Check if both versions attempt to spawn `altru-coder serve` simultaneously causing port/race conflicts
