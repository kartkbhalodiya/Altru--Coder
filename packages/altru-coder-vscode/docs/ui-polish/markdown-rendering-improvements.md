...
**Priority:** P1
**Issue:** [#6088](https://github.com/Altru-Coder/altrucoder/issues/6088)

Headings h1-h6 render at the same visual size as body text. altru-coder-ui CSS only resets margins, no distinct font sizes/weights.
