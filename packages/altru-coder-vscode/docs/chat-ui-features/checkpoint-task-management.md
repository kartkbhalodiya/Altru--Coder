...
- Consider reusing altru-coder-ui's `MessageNav` component
- Evaluate whether CLI session undo/redo/revert maps to Altru Coder's checkpoint model or if extension needs its own git-based implementation
