...
- Diagram colors are derived from the active VS Code/Altru Coder CSS variables so light, dark, and high-contrast themes can render with matching backgrounds, text, borders, and link colors.
