...
```
REGISTRY=ghcr.io/altru-org TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/altru-org TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/altru-org/build/bun-node:24.04
```
