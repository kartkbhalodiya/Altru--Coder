/**
 * TUI-specific helper functions for Altru Coder Gateway integration
 *
...
import type { AltruCoderProfile, AltruCoderBalance, Organization } from "../types.js"
...
export function formatProfileInfo(
  ...
  const usageUrl = currentOrgId
    ? `https://app.altru-coder.ai/organizations/${currentOrgId}/usage-details`
