export const dict = {
  ...
  "provider.connect.altruCoderGateway.line1": "Altru Coder Gateway 为您提供一组精选的可靠优化模型，专为编码代理设计。",
  "provider.connect.altruCoderGateway.line2": "只需一个 API 密钥，您就可以使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.altruCoderGateway.visit.prefix": "访问 ",
  "provider.connect.altruCoderGateway.visit.link": "altru-coder.ai",
  "provider.connect.altruCoderGateway.visit.suffix": " 获取您的 API 密钥。",

  // Provider dialog translations
  "dialog.provider.group.recommended": "推荐",
  "dialog.provider.altru-coder.note": "访问 500+ AI 模型",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "关闭本项目的 Altru Coder 快照。你将失去对 Altru Coder 更改的撤销/重做，但 git 仍会追踪所有内容。",
