export const dict = {
  ...
  "provider.connect.altruCoderGateway.line1":
    "Altru Coder Gateway предоставляет доступ к подборке надёжных оптимизированных моделей для агентов кодирования.",
  "provider.connect.altruCoderGateway.line2":
    "С одним API-ключом вы получите доступ к моделям Claude, GPT, Gemini, GLM и другим.",
  "provider.connect.altruCoderGateway.visit.prefix": "Посетите ",
  "provider.connect.altruCoderGateway.visit.link": "altru-coder.ai",
  "provider.connect.altruCoderGateway.visit.suffix": ", чтобы получить ваш API-ключ.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Рекомендуемые",
  "dialog.provider.altru-coder.note": "Доступ к 500+ моделям ИИ",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Выключите снимки Altru Coder для этого проекта. Вы потеряете отмену/повтор изменений Altru Coder, но git по-прежнему отслеживает всё.",
