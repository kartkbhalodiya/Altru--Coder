export const dict = {
  ...
  "provider.connect.altruCoderGateway.line1":
    "O Altru Coder Gateway oferece acesso a um conjunto selecionado de modelos confiáveis e otimizados para agentes de codificação.",
  ...
  "provider.connect.altruCoderGateway.visit.prefix": "Visite ",
  "provider.connect.altruCoderGateway.visit.link": "altru-coder.ai",
  "provider.connect.altruCoderGateway.visit.suffix": " para obter sua chave de API.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Recomendados",
  "dialog.provider.altru-coder.note": "Acesso a mais de 500 modelos de IA",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Desligue os snapshots do Altru Coder para este projeto. Você perde desfazer/refazer das mudanças feitas pelo Altru Coder, mas o git continua rastreando tudo.",
