...
export const dict = {
  ...
  "provider.connect.altruCoderGateway.line1":
    "Altru Coder Gateway gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.altruCoderGateway.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.altruCoderGateway.visit.prefix": "Visit ",
  "provider.connect.altruCoderGateway.visit.link": "altru-coder.ai",
  "provider.connect.altruCoderGateway.visit.suffix": " to collect your API key.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Recommended",
  "dialog.provider.altru-coder.note": "Access 500+ AI models",
  ...
  // are still what the backend matches on (see packages/opencode/src/altrucoder/plan-followup.ts).
  ...
  // packages/opencode/src/altrucoder/snapshot/track.ts.
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Turn off Altru Coder's snapshots for this project. You will lose undo/redo of Altru Coder file changes, but git still tracks everything.",
