export const dict = {
  ...
  "provider.connect.altruCoderGateway.line1":
    "Altru Coder Gateway ให้คุณเข้าถึงชุดโมเดลที่คัดสรรมาอย่างดีและเชื่อถือได้สำหรับตัวแทนเขียนโค้ด",
  ...
  "provider.connect.altruCoderGateway.visit.prefix": "เยี่ยมชม ",
  "provider.connect.altruCoderGateway.visit.link": "altru-coder.ai",
  "provider.connect.altruCoderGateway.visit.suffix": " เพื่อรับ API key ของคุณ",

  // Provider dialog translations
  "dialog.provider.group.recommended": "แนะนำ",
  "dialog.provider.altru-coder.note": "เข้าถึงโมเดล AI มากกว่า 500 รายการ",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "ปิดสแน็ปช็อตของ Altru Coder สำหรับโปรเจกต์นี้ คุณจะสูญเสียการยกเลิก/ทำซ้ำสำหรับการเปลี่ยนแปลงของ Altru Coder แต่ git ยังคงติดตามทุกอย่าง",
