export const dict = {
  ...
  "provider.connect.altruCoderGateway.line1":
    "Altru Coder Gateway надає доступ до добірки надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.altruCoderGateway.visit.prefix": "Відвідайте ",
  "provider.connect.altruCoderGateway.visit.link": "altru-coder.ai",
  "provider.connect.altruCoderGateway.visit.suffix": " щоб отримати свій API-ключ.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Рекомендовані",
  "dialog.provider.altru-coder.note": "Доступ до 500+ моделей ШІ",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Вимкніть знімки Altru Coder для цього проєкту. Ви втратите скасування/повторення для змін Altru Coder, але git продовжить відстежувати все.",
