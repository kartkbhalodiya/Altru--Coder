export const dict = {
  ...
  "provider.connect.altruCoderGateway.line1": "Altru Coder Gateway 為您提供一組精選的可靠優化模型，專為編碼代理設計。",
  "provider.connect.altruCoderGateway.line2": "只需一個 API 金鑰，您就可以使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.altruCoderGateway.visit.prefix": "訪問 ",
  "provider.connect.altruCoderGateway.visit.link": "altru-coder.ai",
  "provider.connect.altruCoderGateway.visit.suffix": " 獲取您的 API 金鑰。",

  // Provider dialog translations
  "dialog.provider.group.recommended": "推薦",
  "dialog.provider.altru-coder.note": "存取 500+ AI 模型",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "關閉本專案的 Altru Coder 快照。你將失去對 Altru Coder 變更的撤銷/重做，但 git 仍會追蹤所有內容。",
