export const dict = {
  ...
  "provider.connect.altruCoderGateway.line1":
    "Altru Coder Gateway omogućava pristup pažljivo odabranom skupu pouzdanih modela optimizovanih za rad sa agentima za kodiranje.",
  ...
  "provider.connect.altruCoderGateway.visit.prefix": "Posjetite ",
  "provider.connect.altruCoderGateway.visit.link": "altru-coder.ai",
  "provider.connect.altruCoderGateway.visit.suffix": " da preuzmete svoj API ključ.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Preporučeno",
  "dialog.provider.altru-coder.note": "Pristup za 500+ AI modela",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'altru-coder'.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Isključi Altru Coder snapshotove za ovaj projekat. Izgubićete poništi/vrati za izmjene koje napravi Altru Coder, ali git i dalje prati sve.",
