export const dict = {
  ...
  "provider.connect.altruCoderGateway.line1":
    "Altru Coder Gateway te da acceso a un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación.",
  "provider.connect.altruCoderGateway.line2":
    "Con una sola clave API tendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.altruCoderGateway.visit.prefix": "Visita ",
  "provider.connect.altruCoderGateway.visit.link": "altru-coder.ai",
  "provider.connect.altruCoderGateway.visit.suffix": " para obtener tu clave API.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Recomendados",
  "dialog.provider.altru-coder.note": "Acceso a más de 500 modelos de IA",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Apaga las instantáneas de Altru Coder para este proyecto. Perderás deshacer/rehacer de los cambios de Altru Coder, pero git seguirá rastreando todo.",
