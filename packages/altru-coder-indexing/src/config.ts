...
export const IndexingConfig = z
  .object({
    ...
    "altru-coder": z
      ...
      .strict()
      .optional()
      .describe("Altru Coder-hosted embedding provider options"),
    openai: z
...
export function toIndexingConfigInput(cfg: IndexingConfig | undefined): IndexingConfigInput {
  ...
  return {
    ...
    altruApiKey: cfg?.["altru-coder"]?.apiKey,
    altruBaseUrl: cfg?.["altru-coder"]?.baseUrl,
    altruOrganizationId: cfg?.["altru-coder"]?.organizationId,
