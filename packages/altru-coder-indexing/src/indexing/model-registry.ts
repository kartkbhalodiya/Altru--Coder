 ...
 * metadata. Altru Coder-hosted embedding catalog metadata is fetched from Cloud so the
...
export function normalizeAltruCoderModelId(modelId: string | undefined): string | undefined {
  return modelId
}
