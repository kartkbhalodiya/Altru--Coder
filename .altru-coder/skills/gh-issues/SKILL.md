---
name: gh-issues
description: Use when creating, triaging, or commenting on GitHub issues for the Altru Coder VS Code extension or JetBrains plugin via `gh`. Covers issue templates, project board assignment, title conventions, and required `gh` scopes.
---
...
| Surface | Project | URL |
|---|---|---|
| VS Code extension | `VS Code Extension` | https://github.com/orgs/Altru-Coder/projects/25 |
| JetBrains plugin | `Jetbrains Plugin` | https://github.com/orgs/Altru-Coder/projects/39 |
