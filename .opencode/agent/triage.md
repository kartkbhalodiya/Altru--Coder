...
mode: primary
hidden: true
model: altru-coder/minimax/minimax-m2.5
color: "#44BA81"
tools:
  "*": false
  "github-triage": true
...
Use for issues related to the VS Code extension in `packages/altru-coder-vscode/`.

#### gateway

Use for issues related to the Altru Coder Gateway in `packages/altru-coder-gateway/`.
...
VSCode Extension (`packages/altru-coder-vscode/...`):

- markijbema

Altru Coder Gateway (`packages/altru-coder-gateway/...`):
